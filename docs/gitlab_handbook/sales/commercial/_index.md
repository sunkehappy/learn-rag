...
- [GitLab Direction](https://about.gitlab.com/direction/#vision-1) Includes GitLab's Vision, framework and planned features and their release dates within each of GitLab's [Paid Tiers](https://about.gitlab.com/direction/#paid-tiers).
...
We have found following steps beneficial to make the process of time off easy for Sales and keep business continuity.  This does not serve as a replacement to the company wide [Guide to Paid Time Off](/handbook/people-group/time-off-and-absence/time-off-types/) or add process for [Sick Time Policy](/handbook/people-group/time-off-and-absence/time-off-types/). This is the expanded approach to preparing yourself and the team for time off planned specific to the group.
