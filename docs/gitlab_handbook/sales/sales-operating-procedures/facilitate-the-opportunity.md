...
1. **Setup a free trial of GitLab** based on the following [Technical Evaluation Criteria](/handbook/marketing/prescriptive-buyer-journeys/).
1. **Create a solution design blueprint** from requirements gathering, tech discovery, and customer meta-records.
1. **Create a [Proof of Value](/handbook/solutions-architects/playbooks/pov)** when necessary which focuses on specific customer business outcomes that cannot be achieved through other technical and/or business interactions.
