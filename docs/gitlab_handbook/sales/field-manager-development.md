...
- [David Somers](https://gitlab.com/dcsomers) (Sr. Director, Field Enablement)
- Field Manager Advisors
  - [Dave Astor](https://gitlab.com/disastor) (Manager, Solutions Architects, US East)
  - [Robbie Byrne](https://gitlab.com/robbieb) (Area Sales Manager, EMEA)
  - [Ed Cepulis](https://gitlab.com/ecepulis) (Sr. Director, Channel Programs and Enablement)
  - [Michael Leutz](https://gitlab.com/mrleutz) (Manager, Customer Success Managers, EMEA)
  - [Helen Mason](https://gitlab.com/hmason) (Area Sales Manager (Mid-Market), EMEA)
  - [Jacob Potter](https://gitlab.com/jpotter1) (Area Sales Manager, Mid Market First Order)
