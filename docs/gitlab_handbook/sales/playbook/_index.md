...
| [Regional Marketing](/handbook/marketing/field-marketing/#regional-marketing-manager-support) and account-based marketing:| Include this team during strategic planning for your territory, accounts, and pipe generation. And when planning to run & host events or webinars, attend relevant third-party events. Learn what's scheduled: [GitLab event site](https://about.gitlab.com/events/) , [All marketing activities (internal)](https://docs.google.com/spreadsheets/d/1ni6gKeWhjtrNppMdYvPESsCRjDbfVdYjTNtUtcNBFGg/edit#gid=571560493). Nominate priority accounts for [Account-based marketing (ABM) support](/handbook/marketing/account-based-marketing/). Slack: #abmteam, #emea_marketing (EMEA), #regional-partner-marketing (Global)|
...
- View the territory planning template and worksheet in [our internal handbook](https://internal.gitlab.com/handbook/sales/territory-planning/). And view the [account planning template here](https://gitlab.highspot.com/items/67a29f97c51a768ce8564187?lfrm=srp.0).
...
During each stage in the detailed spreadsheet, you'll also see major strategic resources that can help you be successful during each milestone of a deal - from prospecting to transitioning to a the post-sales team. For operational resources, head to the general sales page up top. For commonly used sales ops and skills knowledge, head to the [Selling Skills Spot on Highspot](https://gitlab.highspot.com/spots/66edb0401552965a421ef8f6).
...
If you're looking for templates, guides, customer decks, and other editable sales content, head to the [Sales Deck Library of the Pipeline Acceleration Spot in Highspot](https://gitlab.highspot.com/items/650461a504701b188c124951?lfrm=srp.0). If you're looking for skills-based training, [LevelUp](https://university.gitlab.com/learn/dashboard?_gl=1*1ejz71x*_ga*MTEwMjkzNzM1MS4xNjI1NTI2MTE3*_ga_ENFH3X7M5Y*MTY3NDI1MjgyMS4zOS4xLjE2NzQyNTU4MjYuMC4wLjA.) is where you need to go.
...
- [Clari](https://internal.gitlab.com/handbook/sales/sales-forecasting/) is used to view and document forecasting and pipeline data.
