...
- **Additional Resources**
  - The below are resources you might want to review or bookmark for later.
    ...
    - [GitLab Pricing](https://about.gitlab.com/pricing/): Check out the pricing page to understand our pricing model.
...
- **Sales Roles (Material, - Handbook - 30 minutes)**
  ...
  - Read the [Strategic Account Executive (Enterprise) Role Description](/job-description-library/sales/enterprise-account-executive/)
  - Read the [Account Executive (Mid-Market) Role Description](/job-description-library/sales/account-executive/)
  - Read the [Customer Advocate (SMB) Role Description](/job-description-library/sales/smb-account-executive/)
  - Read the [Sales Development Representative Role Description](/job-description-library/marketing/sales-development-representative/)
- **Solutions Architects (Material - Handbook - 15 minutes)**
  ...
  - Read the [Solutions Architect Role Description](/job-description-library/sales/solutions-architect/)
  - Read about the [Proof of Value Deliverable](/handbook/solutions-architects/playbooks/pov)
...
- **Professional Services Engineers (Material - Handbook - 10 minutes)**
  ...
  - Read the [PSE Role job description](/job-description-library/sales/professional-services-engineer/)
