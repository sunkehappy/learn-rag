...
- Ensure deal structure aligns with booking policies and compliance requirements
- Build and validate complex quotes within SFDC/Zuora
- Review and process standard quotes for accuracy
- Audit quote approvals and workflow routing
- Support Private Offer creation in AWS and GCP

**Bookings**

- Review and approve opportunities in Stage 7 based on Quote data and Booking Requirements
- Validate or override Opportunity Booking metrics (ARR, Amount/TCV, Recurring Amount, ProServ Amount)
- Ensure booking information accurately reflects final deal terms and system updates
- Month-end close duties

**Field Sales Support**

- Provide pre- and post-sales system support related to quotes, contracts, opportunities, and bookings
- Collaborate with cross-functional teams (Billing & AR, Legal, Ecosystems, Fulfillment) to resolve quote or booking discrepancies

**Out of Scope**

- Standard Quote Creation: Sales is expected to be able to create standard Quotes in Zuora CPQ without Deal Desk assistance. Please refer to the [Field Quote Studio](https://gitlab.highspot.com/items/63c04679ce74a0ae63ca5e49?lfrm=srp.0) for more information on quoting in Zuora CPQ.
...
It is the responsibility of the Sales team to plan ahead and submit requests prior to regional holidays.

### Regional Structure

As of 2025-10-31, the Deal Desk team is structured as follows:
...
- **EMEA Office Hours:** Tuesday at 2:00 PM GMT
- **AMER Office Hours:** Wednesday at 12:00 PM EST

During the end of a Quarter, Office Hours will take place on Monday, Wednesday, and Friday, scheduled in both AMER and EMEA time zones. Calendar invites will be sent to Sales-All Distribution group. Priority will be given to opportunities closing within the quarter.
...
To calculate ARR, please review the [ARR in Practice](https://internal.gitlab.com/handbook/sales/annual-recurring-revenue-arr/) internal handbook page.
...
- Populate **"Initial Term"** in months. (i.e. for a two-year deal, enter "24"). Effective 2025-08-06, all multi-year deals (i.e. quotes with a term >12) will be structured as ramp quotes, and must use the "1 Year" SKU. Leverage the "Payment Schedule" quote field to request full prepayment or another non-standard payment schedule. You can learn more about these changes by visiting the [Ecosystems Program & Quoting Guide](https://gitlab.highspot.com/items/6887eb734da0b1c4190b6862?lfrm=shp.12#1) and/or watching the [Ecosystem, Amendment, and Multi-Year Quoting Demo + Overview Video](https://gitlab.highspot.com/items/68843276d73abc59374fb9ec?lfrm=shp.0).
  - Previous State: In the previous state, you would use the "1 Year" SKU for annual payments on multi-year deals, and the multi-year SKU (i.e. SaaS - Premium - 2 Year) for prepayment on multi-year deals.
  - New State as of 2025-08-06: Regardless of payment schedule, multi-year deals should leverage the "1 Year" SKU (i.e. SaaS - Premium - 1 Year"). Always dictate the payment schedule (i.e. prepayment vs. annual payments) using the Payment Schedule field.
...
1. Once you are ready to save the quote, click **Save** first, then click **Submit** at the top of the screen.
...
1. **Could we get notifications when the customer has successfully completed the payment capture link form?** You should see a notification on SFDC if you are the Opportunity Owner telling you that the payment information has been captured successfully.
...
- **Select "Sold To" and "Bill To" contacts.** Note that the "Sold To" contact will receive the License file via email. Note: Each contact record must have a complete address, if the address is not fully populated, you will need to update this before you can proceed with the quote.
...
- For **One-Tier Reseller or MSP deals,** populate the "Invoice Owner", "Invoice Owner Contact" and "Resale Partner" fields. For **Distributor deals,** populate the "Invoice Owner", "Invoice Owner Contact", "Resale Partner" and "Distributor" fields. For **Direct Deals** leave "Invoice Owner", "Invoice Owner Contact," "Resale Partner," and "Distributor" fields blank.
  - "Invoice Owner" and "Invoice Owner Contact" should reflect the account and contact of the party being quoted by GitLab. This means we should leverage the Resale Partner's Billing Account and Billing Account Contact for One-Tier Reseller and MSP deals, and the Distributor's Billing Account and Billing Account Contact for Distributor deals.
  ...
  - The "Resale Partner" field should be populated with the Partner Account of the Reseller or MSP transacting (please note a partner may have both a Customer and Partner Account Record, the Partner Account must be selected. Check the "Account Record Type" field on an account to identify whether it is Customer or Partner account).
  - For deals through distribution, the "Distributor" field should be populated with the Distributor Account of the Distributor transacting (for all Distributor Deals, you must also populate Resale Partner).
- Populate **"Initial Term"** in months. (i.e. for a two-year deal, enter "24"). Effective 2025-08-06, all multi-year deals (i.e. quotes with a term >12) will be structured as ramp quotes, and must use the "1 Year" SKU. Leverage the "Payment Schedule" quote field to request full prepayment or another non-standard payment schedule.
- If the customer or reseller is based in the EU, enter the "VAT ID" number. This is required to book the order.
...
D.  **To Add Products to your quote,** locate the search bar between "Subscription" and "Browse Products" at the bottom of the page, and search for the Product SKU you would like to sell. Note: As of 2025-08-25, if you are selling via Open or Select channel partner, you must select an Ecosystem-specific SKU (the SKU name will include "(Ecosystem)"). This includes AWS CPPO and GCP MCPO quotes, but does not include standard Hyperscaler Cloud partner (AWS/GCP) or OEM partner (IBM OEM) quotes. Once you have located the correct Product SKU, click the circular + button to add that product to the quote. Repeat this process to add additional Product SKUs. You can learn more about these changes by watching the [Ecosystem, Amendment, and Multi-Year Quoting Demo + Overview Video](https://gitlab.highspot.com/items/68843276d73abc59374fb9ec?lfrm=shp.0).

E.  For each Product SKU you have added to the quote, edit Quantity, Discount, and/or Effective Price as desired. **After you have correctly configured Product SKUs, you can click "Preview Metrics" to preview the quote total while still in draft mode. Once you are ready to save the quote, click Save first, then click Submit at the top of the screen.**

- For **Channel deals**, review the [GitLab Channel Partner Program Discounts and Incentive Guide](https://gitlab.highspot.com/items/672950b937a5d0282b99cb96?lfrm=srp.0#1) to confirm the correct ecosystem discounts. These Ecosystem Open and Select partner discounts will be applied to the SKU automatically by the system once you've selected the appropriate "(Ecosystem)" SKU. Ecosystem team approval will be required to reduce the Ecosystem rate/discount - if you would like to add a customer discount, do so on the top product line, in the editable "Discount" field. You can learn more about these changes by visiting the [Ecosystems Program & Quoting Guide](https://gitlab.highspot.com/items/6887eb734da0b1c4190b6862?lfrm=shp.12#1) or by watching the [Ecosystem, Amendment, and Multi-Year Quoting Demo + Overview Video](https://gitlab.highspot.com/items/68843276d73abc59374fb9ec?lfrm=shp.0).

F.  **Add Annual Payments** to a order form by:

- Checking "Annual Payments" checkbox on Quote Detail Page and selecting "Annual Payments" in the Payment Schedule field.
...
- **All Multi-Year quotes** must use the 1 - Year Product SKU. You will see an error message if you apply a term length greater than 12 and anything other than the 1 - Year SKU.

G. SuperSonics: Review the Zuora fields to determine whether any Cloud Licensing features apply to the subscription.
...
- Order Form Modifications: Please note that Sales reps may only generate PDF versions of the Order Form. If you require any changes to the standard Order Form language, please make the request by using the "Request Support" workflow on the Opportunity Object to create a case for Deal Desk.
...
#### **Quote Creation Changes Effective 2025-08-6 (Ecosystem, Amendment, and Multi-Year Quotes)**

- Effective 2025-08-06, we have launched a series of changes to the quote creation process that impact Ecosystem quotes, amendment quotes, and multi-year quotes. While the relevant updates have been included in the above instructions, please review the Ecosystems Program & Quoting Guide for additional detail. You can learn more about these changes by visiting the [Ecosystems Program & Quoting Guide](https://gitlab.highspot.com/items/6887eb734da0b1c4190b6862?lfrm=shp.12#1) or by watching the [Ecosystem, Amendment, and Multi-Year Quoting Demo + Overview Video](https://gitlab.highspot.com/items/68843276d73abc59374fb9ec?lfrm=shp.0).
...
- The **Start Date** cannot be set before the subscription start date.
  ...
  - The **Initial Term** is automatically updated to reflect the initial term of the original New Business or Renewal subscription which is being amended by this quote.
  - The **GitLab Entity** must be the same as it was on the initial deal you're amending.
  - For **One-Tier Reseller or MSP deals,** the system will auto-populate the "Invoice Owner", "Invoice Owner Contact" and "Resale Partner" fields. Review these fields for accuracy. For **Distrbutor deals,** the system will auto-populate the "Invoice Owner", "Invoice Owner Contact", "Resale Partner" and "Distributor" fields. Review these for accuracy. For **Direct Deals** leave "Invoice Owner", "Invoice Owner Contact," "Resale Partner," and "Distributor" fields blank.
    - "Invoice Owner" and "Invoice Owner Contact" should reflect the account and contact of the party being quoted by GitLab. This means we should leverage the Resale Partner's Billing Account and Billing Account Contact for One-Tier Reseller and MSP deals, and the Distributor's Billing Account and Billing Account Contact for Distributor deals.
...
- **To add or remove Product SKUs on the quote,** locate the search bar between "Subscription" and "Browse Products" at the bottom of the page, and search for the Product SKU you would like to add. Once you have located the correct Product SKU, click the circular + button to add that product to the quote. Repeat this process to add additional Product SKUs. You can also remove a Product SKU by clicking on the trash can icon under the SKU name.

Note: **Effective 2025-08-06, you must add a new charge to the quote to add additional users - you may no longer edit an existing (previous) charge to increase quantity. You may only add or remove charges. This process change applies regardless of pricing.** Learn more here: [Ecosystems Program & Quoting Guide](https://gitlab.highspot.com/items/6887eb734da0b1c4190b6862?lfrm=shp.12#1)
...
- **To add users to the existing subscription (regardless of pricing)**, the new user licenses should be added as a separate charge/product line.
- **True-Ups:** NOTE: The true-up SKU does not add users to the license - it's simply a retroactive one time charge. If you are conducting a quarterly or semi annual true-up for a customer with our former percentage-based fee schedule, do not use the true-up SKU unless the true-up is in conjunction with their renewal and the customer will be renewing for less users. Instead, you should add users using an appropriately priced subscription product SKU. If you are quoting true-up users, search for the applicable True-Up SKU and add it to the quote. Edit the quantity and effective price. Click "Save" then click "Submit."
...
- Create an "Amend Subscription" quote by following the steps in Section 2 (A) above.
  ...
  - Adjust the new product line - quantity, discount. Click "Save," then click "Submit."
...
Amendment quotes on multi-year terms (13 or more months) will default to the same billing schedule as the originating agreement (New Subscription Order Form or Renewal Order Form, whichever is most recent). This means:
...
- The **Start Date** cannot be edited. This will be the true renewal date.
  ...
  - Populate **"Renewal Term"** in months. (i.e. for a two-year renewal, enter "24"). Effective 2025-08-06, all multi-year deals (i.e. quotes with a term >12) will be structured as ramp quotes, and must use the "1 Year" SKU. Leverage the "Payment Schedule" quote field to request full prepayment or another non-standard payment schedule.
...
- **To add, remove, or edit Product SKUs on the quote,** locate the search bar between "Subscription" and "Browse Products" at the bottom of the page, and search for the Product SKU you would like to add. Note: As of 2025-08-25, if you are selling via Open or Select channel partner, you must select an Ecosystem-specific SKU (the SKU name will include "(Ecosystem)"). This includes AWS CPPO and GCP MCPO quotes, but does not include standard Hyperscaler Cloud partner (AWS/GCP) or OEM partner (IBM OEM) quotes. Once you have located the correct Product SKU, click the circular + button to add that product to the quote. Repeat this process to add additional Product SKUs. You can also remove a Product SKU by clicking on the trash can icon under the SKU name. You can learn more about these changes by visiting the [Ecosystems Program & Quoting Guide](https://gitlab.highspot.com/items/6887eb734da0b1c4190b6862?lfrm=shp.12#1) or by watching the [Ecosystem, Amendment, and Multi-Year Quoting Demo + Overview Video](https://gitlab.highspot.com/items/68843276d73abc59374fb9ec?lfrm=shp.0).

- For each Product SKU you have added to the quote, edit Quantity, Discount, and/or Effective Price as desired. **After you have correctly configured Product SKUs, you can click "Preview Metrics" to preview the quote total while still in draft mode. Once you are ready to save the quote, click "Save" then click "Submit" at the top of the screen.**

- **Renewal Scenarios**
  - For a flat renewal, simply leave the existing Product SKU (marked Original) as is, unless you are renewing an Ecosystem quote. If you are renewing an Ecosystem quote, ensure the appropriate "(Ecosystem)" SKU is selected. You will need to remove standard SKUs, given the process change effective 2025-08-06.
...
- Note: If a product has been amended multiple times during a subscription period, the product will display multiple lines with each quantity of the product shown.  In this instance, **only modify one line with the new quantity**. Do not modify multiple lines.  Additional [information can be found here](https://gitlab.com/groups/gitlab-com/business-technology/enterprise-apps/financeops/-/wikis/Zuora-CPQ-Legacy-UI:-Limitations).
  - For **Channel renewals**, review the [GitLab Channel Partner Program Discounts and Incentive Guide](https://gitlab.highspot.com/items/672950b937a5d0282b99cb96?lfrm=srp.0#1) to confirm the correct ecosystem discounts. These Ecosystem Open and Select partner discounts will be applied to the SKU automatically by the system once you've selected the appropriate "(Ecosystem)" SKU. Ecosystem team approval will be required to reduce the Ecosystem rate/discount - if you would like to add a customer discount, do so on the top product line, in the editable "Discount" field.
...
- **Add Annual Payments** to a order form by:
  - Selecting "Annual Payments" in the **Payment Schedule** field, which will automatically update the Annual Payments toggle field on the quote to populate language on the order form that commits the order in question to an annual billing/payment schedule.
...
- **SuperSonics**: Review the Zuora fields to determine whether any Cloud Licensing features apply to the subscription.
...
- Fill out the necessary information on the quote per the instruction under the **New Subscription Quote** section above.
  - **Note: The Start Date can be later than the original renewal date only if customer has lost access to the paid product. Otherwise no subscription gap is allowed.**
...
- Effective 2025-08-06, we have launched a series of changes to the quote creation process that impact Ecosystem quotes, amendment quotes, and multi-year quotes. While the relevant updates have been included in these quoting instructions, please review the Ecosystems Program & Quoting Guide for additional detail. You can learn more about these changes by visiting the [Ecosystems Program & Quoting Guide](https://gitlab.highspot.com/items/6887eb734da0b1c4190b6862?lfrm=shp.12#1) or by watching the [Ecosystem, Amendment, and Multi-Year Quoting Demo + Overview Video](https://gitlab.highspot.com/items/68843276d73abc59374fb9ec?lfrm=shp.0).

#### Quoting Ecosystem Deals

##### Standard Channel Partner/Reseller Quotes

When creating a reseller-direct (i.e., one-tier reseller) quote, the `Sold to Contact` and `Bill to Contact` are still linked to the end-customer account (**Sold to** will receive the license email). There are a few additional requirements specific to reseller-direct quotes:

- **Resale Partner** = Reseller's SFDC account (Note for AWS or GCP transactions, this Field should include AWS or GCP as the Marketplace hyperscaler. For CPPO or MCPO deals through AWS or GCP, the reseller is added to the MCPO,CPPO, or DSOR Partner Field)
...
- **SKU Selection** - When created a quote through an Open or Select channel partner, you must select an Ecosystem-specific SKU (the SKU name will include "(Ecosystem)"). These Ecosystem SKUs have two separate lines: (1) the product (just like you’re used to); and (2) the Ecosystem rate discount charge. The Ecosystem rate discount charge will auto-populate based on the partner(s) and SKUs selected - you no longer need to figure out what the appropriate discount is!
  - Note: AWS CPPO and GCP MCPO quotes are included in this category.
- **Discounting and Approvals** - While using the new "(Ecosystem)" SKUs, you can provide a customer discount by adding a discount to the top product line. This full discount percentage will be subject to standard discount approvals. On the second line, the Ecosystem rate discount charge will auto-populate dynamically based on the partner(s) and SKUs selected - you no longer need to figure out what the appropriate discount is! Ecosystem team approval will be required to reduce this value. You may not increase this value.
- **Reviewing the Ecosystem Discount** - If you would like to double check the Ecosystem discount, you may make a copy of [this calculator](https://docs.google.com/spreadsheets/d/1b5oH9LyoGZbAKGkocqx1O7OJdsjGDx3s22XcJLxR2l4/edit?gid=1383050192#gid=1383050192) and enter the specifics of your quote.  Please keep this calculator internal only. Partners may access their price files and calculator by logging into the partner portal under the Assets Library tab or by visiting [this link](https://partners.gitlab.com/px/digital-asset-management/admin/media-library?renderMode=Collection&id=838659).

Learn more by reviewing the [Ecosystems Program & Quoting Guide](https://gitlab.highspot.com/items/6887eb734da0b1c4190b6862?lfrm=shp.12#1).

##### Hyperscaler Cloud Partner (AWS or GCP) and OEM Partner (IBM OEM) Quotes

- AWS, GCP, and OEM Partner quotes are built similarly to reseller-direct quotes in that the Resale Partner must be populated with the Hyperscaler Cloud Partner's SFDC account and the Invoice Owner/Invoice Owner Contact reflect the Hyperscaler Cloud Partner's billing account/contact. However, these deals do NOT require use of the "(Ecosystem)" SKUs, and the quote template used should be the standard template.

Refer to the [Reseller and Distributor step-by-step quoting guide](https://gitlab.highspot.com/items/67c8781694b3e7f4cf88794a?lfrm=srp.0#1) for further information.

##### Distributor Quotes

Creating a distributor (i.e., two-tier distribution) quote is very similar to the process of creating a reseller-direct quote, where `Sold to Contact` and `Bill to Contact` are still linked to the end-customer account (**Sold to** will receive the license email). The only differences from reseller-direct quotes are with the following fields:
...
- **SKU Selection** - When created an MSP quote, you must select an Ecosystem-specific SKU (the SKU name will include "(Ecosystem)"). These Ecosystem SKUs have two separate lines: (1) the product (just like you’re used to); and (2) the Ecosystem rate discount charge. The Ecosystem rate discount charge will auto-populate based on the partner(s) and SKUs selected - you no longer need to figure out what the appropriate discount is!
- **Discounting and Approvals** - While using the new "(Ecosystem)" SKUs, you can provide a customer discount by adding a discount to the top product line. This full discount percentage will be subject to standard discount approvals. On the second line, the Ecosystem rate discount charge will auto-populate dynamically based on the partner(s) and SKUs selected - you no longer need to figure out what the appropriate discount is! Ecosystem team approval will be required to reduce this value. You may not increase this value.
- **Reviewing the Ecosystem Discount** - If you would like to double check the Ecosystem discount, you may make a copy of [this calculator](https://docs.google.com/spreadsheets/d/1b5oH9LyoGZbAKGkocqx1O7OJdsjGDx3s22XcJLxR2l4/edit?gid=1383050192#gid=1383050192) and enter the specifics of your quote.  Please keep this calculator internal only. Partners may access their price files and calculator by logging into the partner portal under the Assets Library tab or by visiting [this link](https://partners.gitlab.com/px/digital-asset-management/admin/media-library?renderMode=Collection&id=838659).
...
To process an MSP opportunity via GCP MCPO, please follow the steps found in the [MCPO Guide](https://docs.google.com/document/d/1S6bg1d6CobRVqqmJ-d9UT7ohZqGjgFb08v3-wjyiFbI/edit?tab=t.0#heading=h.tmgqqtdaciqf).
...
- If you are selling a standard PS SKU, this is a templated package with a set scope and number of hours associated to the deliverables that informs off-the-shelf pricing. This does not require any custom scoping or additional SOW terms. The SKU should be added to the Quote in Zuora and included on the Order Form.
...
- For Standard Services, a signed Order Form is sufficient to book the deal. Note: Some customers may also require the issuance of a PO.
- Effective August 06, 2025, if you are selling services through a Channel Partner, you must use the service SKU with “(Ecosystem)” in the SKU name (i.e., “GitLab CI/CD Training - Onsite (Ecosystem)”).
- For more information on Professional Services SKUs please see the [GitLab Services Catalog](https://about.gitlab.com/services/catalog/)

##### Before submitting a Standard Services Opportunity for Closure

- For standard professional services SKUs, only a signed Order Form is required.

##### Creating a Professional Services Quote for Scoped/Custom Education or Services

**General Quoting Instructions**

- Scoped/Custom Education or Professional Services are those that require consultation with the Professional Services team, and require a custom SOW to be drafted and signed by the customer. This includes any Professional Services or Education Services that are not fully prepaid, and any cases where a combination of standard SKU offerings and custom-scoped services are being sold together in a single opportunity.
...
- Create a new subscription quote under the Professional Services opportunity by following the steps above under "new Subscription Quote."
  - **If the SOW contains purely Professional Services**, select the applicable GitLab Custom Service SKU:
    - **Custom Service Package - Fixed Fee ($330 per hour)**: This SKU is to be used when we plan to invoice a customer upfront for a Fixed Fee price that has been scoped with a Services Engagement Manager, based on a set $330/hour bill rate. As a best practice, any negotiated and approved discounts on this SKU should be structured in a way that supports discounting the full List Price of the SOW to a maximum of two (2) decimal places.
    - **Custom Service Package - Hourly T&M**: This SKU is to be used when we plan to invoice a customer monthly for the hours consumed on a project that has been scoped with a Services Engagement Manager - Time & Materials. This is not the same as our Fixed Fee structure, which is when we invoice a customer for a fixed price up front based on predetermined scope & hours.
  ...
  - **If the SOW contains a mixture of Professional Services and Education Services**, two separate quotes should be created under the same opportunity.
    - Create one quote using the correct GitLab Custom Service SKU (Custom Service Package - Fixed Fee ($330 per hour) or Custom Service Package - Hourly T&M) and reflect the List Price and any approved Discounts for this portion of the Services in the SOW.
    - Create a second quote using the matching Training/Certification/Education Services SKU(s).
...
- Please set up any custom services SKUs on a Quote in SFDC **before** sending a Statement of Work for signature. This will help alleviate potential issues on the backend when incorrect SKUs are set up or discounts are negotiated in a manner that is difficult for us to include in Zuora CPQ. For example, Zuora CPQ discounts are limited to 2 decimal points at the Quote level. This means discounts should be included in the SOW that align with how our Quoting system operates.
- Discount approvals will be handled by the Engagement Manager via the scoping issue, and any discounts in rate should be handled separately via quote, as per the [Approval Matrix](https://docs.google.com/document/d/1-CH-uH_zr0qaVaV1QbmVZ1rF669DsaUeq9w-q1QiKPE/edit#heading=h.dccvx02huo2y).
- All Custom Service SKUs require approval from Revenue on the Quote to ensure alignment between the SKU & SOW requirements.
- The SAE/AE remains responsible for obtaining all required approvals. As well as any SKU or discount approvals, this also includes non-standard payment terms. Once approved, the Custom SOW will be sent to the customer for signature.
...
- Ensure that a supporting Quote object has been created with the correct SKU and the amount matching the SOW amount (as per above).
...
### PS Travel & Expense Process (Effective February 6th, 2026)

- As all standard PS SKUs now include a reference to our online [T&E policy](https://about.gitlab.com/professional-services/skus/travel-and-expense/) directly in the online service descriptions (example: https://about.gitlab.com/professional-services/skus/cicd-workshop/).
- T&E is no longer required on a PS quote in order to bill T&E - this SKU has been hidden as of today. GitLab will continue to bill customers in arrears based on actual expenses from the PS team's monthly/quarterly reports (this has always been our practice)
- All custom SOWs should include the T&E billing language - this is up to the PS engagement manager to manage when drafting the SOW.
- Exceptions: if a customer requires the T&E SKU on an Order Form for PO purposes when selling standard packaged SKUs (not a custom SOW that includes the T&E amount), please use the "Request Support" workflow on the Opportunity Object to create a case for Deal Desk. Deal Desk will edit the Order Form to include the following language: "For purposes of this Order Form, a Travel and Expense (T&E) budget of [$X,XXX.00] is included and should be reflected in the Customer's corresponding Purchase Order. Additional terms governing travel and expenses are available at: https://about.gitlab.com/professional-services/skus/travel-and-expense/"
- To avoid this manual lift in the future, Professional Services is working cross-functionally with the QTC teams to create a new Travel & Expense Budget SKU with the correct quoting and billing settings.
...
For more information on ARR calculation for Contract Resets, see [ARR in Practice](https://internal.gitlab.com/handbook/sales/annual-recurring-revenue-arr/).
...
- Effective 2025-08-06, all multi-year deals (i.e. quotes with a term >12) will be structured as ramp quotes, and must use the "1 Year" SKU. Leverage the "Payment Schedule" quote field to request full prepayment or another non-standard payment schedule.
  - Previous State: In the previous state, you would use the "1 Year" SKU for annual payments on multi-year deals, and the multi-year SKU (i.e. SaaS - Premium - 2 Year) for prepayment on multi-year deals.
  - New State as of 2025-08-06: Regardless of payment schedule, multi-year deals should leverage the "1 Year" SKU (i.e. SaaS - Premium - 1 Year"). Always dictate the payment schedule (i.e. prepayment vs. annual payments) using the Payment Schedule field.
  - Why make this change:
    - Multi-year order forms will now always show the year-by-year breakdown, even if the deal is flat and not technically ramping. No more need to contact Deal Desk to edit the order form to show annual costs!
    - If a multi-year quote is flat and not technically ramping, you will be able to turn it into a ramping quote via later amendment with no contract reset required.
  - You can learn more about these changes by watching the [Ecosystem, Amendment, and Multi-Year Quoting Demo + Overview Video](https://gitlab.highspot.com/items/68843276d73abc59374fb9ec?lfrm=shp.0).  

For more information on ARR calculation for Multi-Year Deals, see [ARR in Practice](https://internal.gitlab.com/handbook/sales/annual-recurring-revenue-arr/).
...
- Ramp deals are limited to multi-year deals, with 12 month ramp periods. See [ARR in Practice](https://internal.gitlab.com/handbook/sales/annual-recurring-revenue-arr/) for more information.
...
- Because all ramp quotes must use the "1 Year" SKU. Leverage the "Payment Schedule" quote field to request full prepayment or another non-standard payment schedule.
...
To finalize the quote, click "Preview Metrics" to review the total for each ramp interval, as well as the full quote subtotal. To save and load the saved quote, first click Save, then click "Submit." After clicking Submit, Quote Studio will redirect you to the saved Quote.
...
- Multi-year Ramp Deals are prepaid by default. For Annual Payments, you must select "Annual Payments" in the **Payment Schedule** field, which will automatically update the Annual Payments toggle field on the quote to populate language on the order form that commits the order in question to an annual billing/payment schedule.

**To supplement these steps, review the [Highspot Page](https://gitlab.highspot.com/items/63c04679ce74a0ae63ca5e49) or the [RISE Course](https://rise.articulate.com/share/HzJgdaWzK1C_SwlMSCwQchgV9PbpRNvi#/) to see each step live for a New Subscription quote.**

For more information on ARR calculation for Ramp Deals, see [ARR in Practice](https://internal.gitlab.com/handbook/sales/annual-recurring-revenue-arr/).
...
- **All Private Offer requests must be made by using the "Request Support" workflow on the Opportunity Object to create a case for Deal Desk.** All Private Offer requests must include the following information:
  ...
  - For MCPO/CPPO Add-On Opportunities on the Legacy Standard Product Catalog Only: Because these Quotes have yet to migrate to the new Ecosystem Product Catalog with a separate Partner Margin identified on the Quote, please confirm the Partner Margin in the Private Offer Case request. Failure to do so may delay processing.
