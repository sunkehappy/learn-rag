...
1. For more information see the [Trade Compliance](/handbook/legal/trade-compliance/) handbook page and the [Code of Business Conduct & Ethics](https://ir.gitlab.com/governance/governance-documents/default.aspx) page.
...
GitLab provides free licenses to qualifying entities through the [Developer Relations Programs](/handbook/marketing/developer-relations/programs/): [GitLab for Education Program](https://about.gitlab.com/solutions/education/) and [GitLab for Open Source Program](https://about.gitlab.com/solutions/open-source/), as well as through the [GitLab for Startups Program](https://about.gitlab.com/solutions/startups/). All applications to these programs are routed through the [Developer Relations Programs applications automated workflows](/handbook/marketing/developer-relations/programs/program-resources/#automated-application-workflow). **Only Developer Relations team members** should handle these applications and opportunities because the team verifies program requirements before issuing/renewing licenses and these opportunities are handled differently since the opportunities are free.

#### Inquiry and Application Process (Leads or Contacts)

1. If an existing contact or new lead is interested in applying to one of the programs, use the resources in the [Developer Relations Programs](/handbook/marketing/developer-relations/programs/#active-programs) to guide them apropriately. If the lead has specific questions, direct them to send an email to `education@gitlab.com`, `startups@gitlab.com`, or `opensource@gitlab.com`. Then reassign the lead to the appropriate program manager (DRI).
1. In the situation that you need direct assistance with the lead/contact, chatter the 'Community Program Owner' in Salesforce with a note about the requested action.

#### Assigning Opportunities and Renewal Opportunities

1. All opportunities related to a program should be owned by the Program Manager of the corresponding program as indicated in the [Developer Relations Programs](/handbook/marketing/developer-relations/programs/#active-programs) handbook.
1. If you need to assign an opportunity or a renewal opportunity please reach out to the #developer-relations-programs Slack channel.
...
**For Waived True-Ups that are less than 10 seats**

Sales can bypass the True-Up approval process and directly submit a ticket to the [Zendesk Form](https://gitlab-internal.zendesk.com/hc/en-us/requests/new?ticket_form_id=22783840298780) using the `L&R internal requests option` option followed by `Gitlab.com Subscription Related  > Reset max seats for QSR`. When specifying that the number of seats to be waived is less than or equal to 10, the form field `What is the link to the chatter in SFDC where this was approved?` will be automatically removed, allowing the ticket to be submitted without prior approval.

**For Waived True-Ups that are 10 or greater seats, executive approval is required**
...
Review the [Professional Services handbook page](/handbook/customer-success/professional-services-engineering/) for in-depth information on Professional Services and the [Deal Desk handbook page for the details of PS quote creation](/handbook/sales/field-operations/sales-operations/deal-desk/#quoting-professional-services).
...
**NOTE** - Orders will be processed as long as the Quote Start Date is within 30 calendar days from date of submission. If the Quote Start Date is more than 30 days in the future, Order Management will approve and update the close date to the earliest date that the opportunity can be booked. Only on or after that date will the Billing team review the opportunity for final booking. For more information, review the [Bookings Policy](/handbook/sales/field-operations/order-processing/#bookings-policy).
...
- <ins>New Business and Add-On opportunities</ins> will be Closed Won *no more than 30 days prior to the Quote Start Date* as reflected on the opportunity.
  - New Business and Add-On opportunities submitted for approval after the Quote Start Date will be Closed Won on the date of approval submission.
    - *New Business Example: A customer would like to purchase a new subscription starting on May 1, 2026. The deal is worked out early, and all necessary booking documents are received on March 1, 2026. Sales submits the opportunity for approval on March 2, 2026. The deal is then reviewed by Deal Desk, but the close date is updated to April 16, 2026 upon Deal Desk approval. The opportunity is held in stage 7-Closing until April 16, 2026, when Billing approves the opportunity and sends an invoice to the customer.*
  - Ramp Deals: All future-year ramp opportunities will be submitted for approval at the same time as the first-year ramp opportunity. Upon Deal Desk approval, all ramp opportunity close dates — including Year 1 — will be set to the start date of their respective ramp year minus 30 days. Opportunities are held in Stage 7-Closing until Billing approves and invoices the customer on the Year 1 close date. See: [ARR in Practice](https://internal.gitlab.com/handbook/sales/annual-recurring-revenue-arr/)
    - *Ramp Deal Example: A customer would like to purchase a new three-year ramped subscription starting on May 1, 2026. Three opportunities are built for this deal — one for Year 1 (2026-05-01 to 2027-04-30), one for Year 2 (2027-05-01 to 2028-04-30), and one for Year 3 (2028-05-01 to 2029-04-30). The deal is worked out early and all necessary booking documents are received on March 1, 2026. Sales submits all three opportunities for approval on March 2, 2026. Upon Deal Desk approval, the Year 1 close date is updated to April 1, 2026 (30 days before the May 1, 2026 start date). The Year 2 close date is updated to April 1, 2027 (30 days before the May 1, 2027 start date). The Year 3 close date is updated to April 1, 2028 (30 days before the May 1, 2028 start date). All three opportunities are held in Stage 7-Closing until April 1, 2026, when Billing approves the opportunities and sends an invoice to the customer.*

##### Renewal Opportunities

- <ins>Renewal opportunities</ins> will be Closed Won *no more than 30 days prior to the Quote Start Date* (i.e. the Renewal Date) as reflected on the opportunity.
  - Renewal opportunities submitted for approval after the Quote Start Date (i.e. Renewal Date) will be Closed Won on the date of approval submission.
    - *Renewal Example: A customer's subscription has a renewal date of May 1, 2026. The renewal is worked out early, and all necessary booking documents are received on March 1, 2026. Sales submits the opportunity for approval on March 2, 2026. The deal is then reviewed by Deal Desk, but the close date is updated to April 16, 2026 upon Deal Desk approval. The opportunity is held in stage 7-Closing until April 16, 2026, when Billing approves the opportunity and sends an invoice to the customer.*
  - Ramp Deals: All future-year ramp opportunities will be Closed Won on the same date as the first-year ramp opportunity, but the close date will be updated after closure to match the Quote Start Date. See: [ARR in Practice](https://internal.gitlab.com/handbook/sales/annual-recurring-revenue-arr/)
...
- If a renewal is achieved *more than 15 days after the Renewal Date, but less than 180 days after the Renewal Date*:
  - The renewal should be recorded on a newly created renewal opportunity. The renewal should be quoted using a [New Subscription quote](/handbook/sales/field-operations/sales-operations/deal-desk/#new-subscription-quote).
  - The original Closed Lost opportunity will remain as is. A second Closed Lost opportunity will be created and closed with the inverse values of the original, to effectively cancel the original Closed Lost opportunity. This new Closed Lost opportunity will have the same close date as the new Closed Won renewal opportunity.
...
- Any exceptions to the **Late Renewal Policy** must be **documented in SFDC Chatter and include the following details**:
  ...
  - **Approval from** Sales VP per the [Deal Approval Matrix](https://docs.google.com/document/d/1-CH-uH_zr0qaVaV1QbmVZ1rF669DsaUeq9w-q1QiKPE/edit?tab=t.0#bookmark=kix.ra5sw4kbvcct)
...
- Any exceptions to the **booking policy** must be **documented in SFDC Chatter and include the following details**:
...
- Note: Opportunities approved for invoicing outside of the booking policy will be booked and invoiced as approved, but the booking will then be moved so that the close date falls within the bookings policy. For clarity, quota credit and commission will align to the booking policy even if approvals are obtained to invoice the transaction earlier than 30 days prior to the Quote Start Date.
...
If the customer's license has expired, please open an Issue to request a license extension for the related license. A license extension will prevent the customer from losing functionality while the opportunity is pending approval due to a delayed PO.
...
**[CustomersDot Access and Use handbook page](/handbook/product/groups/fulfillment/#customersdot-admin-panel)**
