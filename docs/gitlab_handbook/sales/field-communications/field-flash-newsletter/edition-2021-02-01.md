...
As a part of this change, we have **updated and deployed a new Product Catalog that materially changes the quoting process**. For more information, please review the Quoting Guide: Starter/Bronze End of Availability + Tier Re-naming section in the Deal Desk Handbook and reach out to #sales-support for assistance.
