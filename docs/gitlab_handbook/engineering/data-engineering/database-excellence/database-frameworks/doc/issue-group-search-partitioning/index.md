...
We have [motivated database partitioning](../partitioning.md) by looking at a specific example: Group-based issue search.
...
Also see the [working page for Introducing PostgreSQL table partitioning to GitLab's database](/handbook/engineering/data-engineering/database-excellence/database-frameworks/doc/partitioning/)
