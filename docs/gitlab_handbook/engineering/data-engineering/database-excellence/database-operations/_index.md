...
|-------------|-------------|------------------------|---------------------------|
| Redis | There are several use cases such as caching, rate-limiting, sidekiq queueing. | [Tenant Scale](/handbook/engineering/infrastructure-platforms/tenant-scale/) | [Redis Architecture](/handbook/engineering/infrastructure-platforms/production/architecture/#redis-architecture) |
