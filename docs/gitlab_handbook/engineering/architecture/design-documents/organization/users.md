...
- As [Enterprise Users](https://docs.gitlab.com/ee/user/enterprise_user/index.html), managed by the
  ...
  block the User. In the context of Protocells, Organization members will
...
- As Non-Enterprise Users, managed by the default Organization. Non-Enterprise Users
  ...
  their User account. This will only be considered post Protocells.
...
1. Being invited by an Organization Owner to create an account.
...
For details on Organization visibility, see [Visibility](_index.md#visibility).
...
For Organizations in the context of Cells, Users will only be able to be
