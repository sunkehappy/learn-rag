...
- [008: Unified SD Scanner](decisions/008_unified_scanner)
- [009: Detecting Generic Secrets](decisions/009_generic_secrets)
...
#### High-level Design for Unified SD Scanner

A single Secret Detection scanner for all scan target types. The overall design of Secret Detection for various scan target types looks like the following illustration:

![High-level Design for unified SD Scanner](/images/engineering/architecture/design-documents/secret_detection/008_high_level_design.png "High-level Design for unified SD Scanner")

Read more details about unified SD Scanner [here](decisions/008_unified_scanner.md).
