...
1. Generate and Sign Attestation in Control Plane: Move attestation generation and signing operations to GitLab Rails for better security.
1. Attestation Publishing & Verification: Enable publishing and verification methods for attestations generated by GitLab.
...
- Enable public projects to achieve [SLSA Build Level 3](https://slsa.dev/spec/v1.1/levels#build-l3) compliance requirements while minimizing disruption to existing workflows.
...
- [SLSA: Supply-chain Levels for Software Artifacts](https://slsa.dev/spec/v1.1/), a framework for improving supply chain security.
...
- `Trusted Control Plane` is the GitLab Backend and includes Sidekiq, DB, and Object Storage
...
#### Phase 5: Attestation of OCI container images
...
- Address bugs and feedback from previous phases, specifically error reporting
  and file size limits.

#### Phase 6: Allow for attestation in private repositories, GitLab self-managed and dedicated

- Allow integration with private repositories, self-managed and dedicated
  through CA stored in PostgreSQL.
...
- [005: Perform SHA-256 calculation in PublishProvenanceService](decisions/005_perform_sha256_in_service.md) - Perform calculation of the SHA-256 hash of artifacts within PublishProvenanceService.
- [006: Signing with SBOM and Provenance in OCI registries](decisions/006_signing_with_sbom_and_provenance_in_oci.md) - Provenance attestation and SBOM signing for OCI images
- [007: Attestations for private repositories, dedicated and self-managed instances](decisions/007_attestations_private_dedicated_self_hosted.md) - Mechanisms through which software attestations can be achieved in situations where public Sigstore infrastructure cannot be used
