...
This page covers the general architecture of Cloud Connector in its most recent state.
Past and future incremental changes are documented as [ADRs](_index.md#decisions).
...
- **Backend service**: A GitLab-operated web service invoked by a GitLab instance to deliver functionality
  that's part of the Cloud Connector set of features. Our primary backend service is AI Gateway.
...
such as whether the functionality is considered fully launched or in beta stage. This information is particularly
