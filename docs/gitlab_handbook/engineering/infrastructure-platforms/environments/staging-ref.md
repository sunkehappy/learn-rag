...
- Cover testing needs of Engineering Department in a production-like environment
- Admin testing access
  - Current Staging (`gstg`) has customer data which is a blocker for giving more access to Engineering teams.
...
- [Audit event streaming](https://docs.gitlab.com/administration/compliance/audit_event_streaming/#google-cloud-logging-destinations) is enabled
...
1. Visit [`gitlab-toolbox`](https://console.cloud.google.com/kubernetes/deployment/us-east1/staging-ref-3k-hybrid-us/default/gitlab-toolbox/overview?project=gitlab-staging-ref) workload in the `gitlab-staging-ref` project
...
Staging Ref environment has some known limitations:

- Test data configuration ([epic#7020](https://gitlab.com/groups/gitlab-org/-/epics/7020))
- Shared Runners configuration ([issue#353284](https://gitlab.com/gitlab-org/gitlab/-/issues/353284))
- Kibana for Staging Ref ([issue#351816](https://gitlab.com/gitlab-org/gitlab/-/issues/351816))
- Incoming email setup ([issue#348970](https://gitlab.com/gitlab-org/gitlab/-/issues/348970))
- Unified URL on Staging Ref ([issue#370312](https://gitlab.com/gitlab-org/gitlab/-/issues/370312))
- Configure wildcard TLS support for staging-ref Pages ([issue#21421](https://gitlab.com/gitlab-com/gl-infra/delivery/-/issues/21421))

### Feedback

If you need some additional custom configuration for Staging Ref to be explored or you have other feedback and
ideas for improvements, please reach out to [`#staging-ref`](https://gitlab.slack.com/archives/C02LN0K1N3Y) Slack
channel or raise a [feature request](https://gitlab.com/gitlab-com/gl-infra/delivery/-/issues/new?description_template=staging-ref-feature-request).
