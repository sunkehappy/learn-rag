...
- **Default Location**: `gitlab-com/gl-infra/production-engineering`
...
1. Follow-up items are automatically created in `gitlab-com/gl-infra/production-engineering`
...
3. The Incident Lead reviews each issue and:
   ...
   - For Runway issues: Move to `gitlab-com/gl-infra/platform/runway/team`
