...
An integral part of any irregular situation occurring on GitLab SaaS is the [incident management process](/handbook/engineering/infrastructure-platforms/incident-management/_index.md).
