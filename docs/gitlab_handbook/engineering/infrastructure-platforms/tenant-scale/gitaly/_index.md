...
The team includes [Backend Engineers](/job-description-library/engineering/development/backend/#gitaly) and [SREs](/job-description-library/engineering/infrastructure/site-reliability-engineer/#gitaly) collaborating to deliver a reliable, scalable and fast data storage to our customers.
...
- During extended customer emergency calls where you've been paged by Support, if the issue has moved away from Gitaly and your expertise is no longer actively needed, take initiative to ask the Support Engineer if you can step back from active participation. You can continue to monitor passively and can always be re-engaged if Gitaly involvement becomes necessary again.
...
SLO tracking. They will be scheduled through either of the above paths or by the
EM.
