...
- Use GitLab's [incident management](../incident-management/) processes
...
- **Cells and Organizations**: Check the [Cells design documents](/handbook/engineering/architecture/design-documents/cells/) and [Organizations design documents](/handbook/engineering/architecture/design-documents/organization/) for cells-specific information
