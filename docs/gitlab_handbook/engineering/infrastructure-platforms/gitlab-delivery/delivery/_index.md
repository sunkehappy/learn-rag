...
Ideas for how we can incorporate GitLab Duo/AI in our workflows are being captured [here](/handbook/engineering/infrastructure-platforms/gitlab-delivery/delivery/ai-use-cases).
...
- Develop a Release Platform to enable future teams and modules to easily ship changes to their components.
...
- Scale GitLab releases to meet organization needs whilst maintaining or reducing release manager workload
...
- Fully automate the release processes used for Monthly and Patch releases for self-managed users to increase release velocity, and reduce Release Manager workload
...
Delivery Group contributes to [Engineering function performance indicators](https://internal.gitlab.com/handbook/company/performance-indicators/engineering/) through [Infrastructure department performance indicators].
The group's main performance indicator is [**M**ean **T**ime **T**o **P**roduction](https://internal.gitlab.com/handbook/company/performance-indicators/product/saas-platforms-section/#mean-time-to-production-mttp) (MTTP), which serves to show how quickly a change introduced through a Merge Request
...
### The primary customers of Deployments work are
...
1. In Incident.io, escalate to the Delivery - Leadership team.
...
Incidents impacting Delivery may optionally include an [impact label](#delivery-impact-labels).
