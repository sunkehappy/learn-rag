...
1. Deployments: Every day at 7:20 UTC, the nightly CE packages gets
   ...
   will be logged in [Sentry](https://new-sentry.gitlab.net/organizations/gitlab/discover/homepage/?environment=dev&field=title&field=event.type&field=project&field=user.display&field=timestamp&name=All+Events&query=&sort=-timestamp&statsPeriod=24h&yAxis=count%28%29). Use the dev environment filter on a project like gitlabcom or gitaly.
...
[dev-gitlab-org role](https://dev.gitlab.org/cookbooks/chef-repo/blob/fa6131d9d06299940a72c51cf60ea62c54fe3461/job-description-library/dev-gitlab-org.json).
