...
The DRI is not solely responsible for a resolution of any requests; they should
engage any subject matter expert (SME) and escalate to the engineering manager
and/or product manager as needed. In addition, there is no expectation that the
DRI can complete the same amount of `Deliverable` work during the week. For
escalations requiring specialized expertise, refer to
...
1. [Support customer requests](/handbook/engineering/infrastructure-platforms/gitlab-delivery/distribution/#engaging-distribution-for-expertise-in-support)
    * [Support help requests for Build and Operate](https://gitlab.com/gitlab-com/request-for-help/-/issues)
...
1. Redirect any [active incident](/handbook/engineering/infrastructure-platforms/incident-management/) and [deployment blocker](/handbook/engineering/deployments-and-releases/deployments/#deployment-blockers) request to the Distribution DRI during their normal office hours, or take the request if you are the first available team member
