...
* [Engineering Team Triage](/handbook/product-development/how-we-work/issue-triage/)
...
#### Use GitLab Duo agentic chat

[GitLab Duo Agentic Chat](https://docs.gitlab.com/user/gitlab_duo_chat/agentic_chat/) can help you investigate the pipeline failure and even retry jobs that failed intermittently:

1. Select the pipeline failure issue.
1. Click "GitLab Duo Chat" in the sidebar, and enable "Agentic Mode".
1. Use the following prompt to initiate the troubleshooting and retry the failed jobs:
