...
there are different [limits](/handbook/engineering/infrastructure-platforms/rate-limiting/#limits) applied at Cloudflare and within the Application.

**Note:** If you are troubleshooting rate limiting issues for GitLab Pages or Registry,
see [other rate limits](/handbook/engineering/infrastructure-platforms/rate-limiting/#other-rate-limits) for details on how these are configured.
...
This behaviour is better documented in the [Rate Limiting Headers](/handbook/engineering/infrastructure-platforms/rate-limiting/#headers) section of the handbook.
...
[RackAttack](/handbook/engineering/infrastructure-platforms/rate-limiting/#rackattack) and the
[ApplicationRateLimiter](/handbook/engineering/infrastructure-platforms/rate-limiting/#applicationratelimiter).
...
If a request is throttled by [RackAttack](/handbook/engineering/infrastructure-platforms/rate-limiting/#rackattack) it will contain `RateLimit-*` response headers.
