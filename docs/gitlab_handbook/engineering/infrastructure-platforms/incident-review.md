...
- Link and potentially create [corrective actions](/handbook/engineering/infrastructure-platforms/incident-management/#corrective-actions), [infradev](/handbook/engineering/workflow/#infradev) issues, or any other actions or outcomes from the incident
...
## Timeline that we expect for reviews to be completed
 ...
 It is expected that the incident review will be completed **within 5 working days of the incident resolution**.  A reminder will be sent out after 5 days if the incident review issue is still open. Customers should expect the public RCA to be available within **7 days** of the incident resolution for Severity 1 incidents.
