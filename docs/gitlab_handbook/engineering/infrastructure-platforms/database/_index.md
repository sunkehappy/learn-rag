...
For [GitLab.com we maintain availability](/handbook/engineering/infrastructure-platforms/production/) above 99.95%. For the PostgreSQL database,
...
Basically everything under <https://docs.gitlab.com/development/database>, but the following guides in particular are important:
