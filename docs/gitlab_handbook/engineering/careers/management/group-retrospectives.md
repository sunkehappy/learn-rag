...
retrospective is complete, the Engineering Manager has until the [Retrospective Summary](/handbook/engineering/careers/management/group-retrospectives/) (shortly after the [monthly release](/handbook/engineering/releases/)) to make relevant notes from the retrospective
