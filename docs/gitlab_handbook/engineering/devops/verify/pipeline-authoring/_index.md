...
- [Team Resources](/handbook/engineering/devops/verify/pipeline-authoring/team-resources/)
...
{{< team-by-manager-role role="Engineering Manager(.*)Pipeline Authoring" >}}
...
Please note that sync meeting schedules are flexible and can be moved to accommodate required participants. For an up-to-date schedule of all team meetings, please consult the [Group's Calendar](https://calendar.google.com/calendar/u/0/embed?src=c_n7totcsnoi7l2j0a2n9ps08g7s@group.calendar.google.com&ctz=UTC).
...
UX, Product Manager and Engineering Manager meet weekly to discuss cross-functional prioritization in addition to any other topics that require the quad to collaborate on.
...
{{% engineering/verify-team-communication slack-channel="g_pipeline-authoring" slack-url="https://gitlab.slack.com/archives/CPCJ8CCCX" group-label="group::pipeline authoring" group-issues-url="https://gitlab.com/groups/gitlab-org/-/issues?label_name%5B%5D=group%3A%3Apipeline+authoring&scope=all" gitlab-subgroup="pipeline-authoring-group" %}}
