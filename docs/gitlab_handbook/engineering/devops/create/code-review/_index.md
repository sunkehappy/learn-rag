...
- [Backend](/handbook/engineering/devops/create/code-review/backend/)
- [Frontend](/handbook/engineering/devops/create/code-review/frontend/)
...
This is a chance for all members of the Code Review Group to meet to discuss current priorities, blockers, planning.
...
The Code Review group is responsible for responding to [Requests for Help (RFH)](https://gitlab.com/gitlab-com/request-for-help) opened by the Support team.
These requests are typically to help resolve issues customers are facing.

If non-trivial Support requests reach us via Slack, kindly direct the reporter to open an RFH for our group ([template link](https://gitlab.com/gitlab-com/request-for-help/-/issues/new?issuable_template=SupportRequestTemplate-CodeReview)), for better transparency and efficency in tracking and resolving this type of work.

The RFH workflow is as follows:

1. Follow the common guidance on responsiveness and labelling documented in the [RFH project](https://gitlab.com/gitlab-com/request-for-help).
1. When an RFH issue is created, the frontend and backend EMs are automatically mentioned. The EMs must triage the issue promptly. The PM may also support with triaging these. Engineers who believe they can be of help can volunteer and assign themselves proactively.
1. To triage an issue:
   1. Ask clarifying questions to the issue author.
   1. Identify if there is any relevant open or closed issue in `gitlab-org/gitlab`.
   1. Assign the RFH issue to someone on the team, based on domain expertise and/or availability.
1. EMs regularly check the status of open RFH issues via the [RFH Lifecycle board](https://gitlab.com/gitlab-com/request-for-help/-/boards/9606231?label_name[]=Help%20group%3A%3Acode%20review) or [EM dashboard](https://gitlab.com/gitlab-com/create-stage/code-review-be/-/wikis/EM-dashboard#open-requests-for-help).
1. RFH issue assignees should surface blockers as soon as any arises.
1. If an RFH uncovers a common question or a gap in documentation, consider updating relevant handbook pages or documentation to prevent similar future inquiries.
...
- [Page views](https://10az.online.tableau.com/#/site/gitlab/workbooks/3464818/views)
