...
{{< engineering/stable-counterparts role="(Product Manager|Backend Engineer|Technical Writer|Senior Security Engineer).*(Create:Source Code|Create \(Source)|Dev\:Create" >}}
...
| 2025 | [Refactor commit list](https://gitlab.com/groups/gitlab-org/-/work_items/17482) | Refactor commit list into Vue.js app and improve search experience | — |

### Archived Project Table

| Start Date | End Date |Project  | Description | Tech Lead |
| ------ | ------ | ------ |  ------ | ------ |
| 2024-10 | 2026-01 | [File tree browser](https://gitlab.com/groups/gitlab-org/-/work_items/17781) | Implement a tree view in the repository and blob pages to make browsing and reading files easier | — |
| 2024-10 | 2025-02 | [Directory and File Page Improvements](https://gitlab.com/groups/gitlab-org/-/epics/12557) | A project to improve user experience of header area for directory and file pages | — |
