...
The Plan Frontend Team internship is the result of [The Engineering Internship Pilot Program](/handbook/hiring/) that started at the end of 2019. The ultimate goal of this program is to transform an entry-level candidate in to an Individual Contributor who could meet the requirements for a [Junior Engineer](/job-description-library/engineering/development/frontend/associate/).
...
- [Frontend Engineering Manager](/job-description-library/engineering/development/management/engineering-manager/) - Manager
- [Frontend Engineer](/job-description-library/engineering/development/frontend/) - Mentor
- Intern - Participant
...
- Review Plan pages in handbook
  - [Frontend Plan Team](/handbook/engineering/devops/plan/project-management/)
