...
- [Plan:Project Management Team](/handbook/engineering/devops/plan/project-management/)
- [Plan:Product Planning Team](/handbook/engineering/devops/plan/product-planning/)
- [Plan:Knowledge Team](/handbook/engineering/devops/plan/knowledge/)
...
Engineering Managers are strongly encouraged to conduct a simple [Root Cause Analysis](/handbook/engineering/workflow/root-cause-analysis/#what-is-a-root-cause-analysis) (RCA) when a regression takes place in a feature owned by their group, in order to:
...
We use the methods and tools in the [UX Research handbook](/handbook/product/ux/experience-research/).
...
The DRI for organizing Team Day may pursue a budget for expenses under existing budgets; such as the [team building](https://internal.gitlab.com/handbook/finance/expenses/#team-building) budget. If successful it should be made clear to team-members well in advance:
...
1. [Work Items API Performance](/handbook/engineering/devops/plan/working-groups/work-items-api-performance/)

#### Archived Stage Working Groups

1. [Epic Work Items Migration](/handbook/engineering/devops/plan/working-groups/epic-work-items-migration/)
