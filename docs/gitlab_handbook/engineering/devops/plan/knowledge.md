...
DRIs should keep issues up to date with [workflow labels](/handbook/engineering/devops/plan/knowledge/#use-of-labels) and [health status](/handbook/engineering/devops/plan/#keeping-health-status-accurate) on an ongoing basis rather than waiting for this meeting.
...
| Team | Domain overlap |
| ---  | ---    |
| [Pipeline Authoring](/handbook/engineering/devops/verify/pipeline-authoring/) | GitLab Pages [.gitlab-ci.yml syntax](https://docs.gitlab.com/ee/ci/yaml/) |
