...
See [internal handbook page](https://internal.gitlab.com/handbook/engineering/core-development/cd/deploy/environments)
...
- We also use a [special project](https://gitlab.com/gitlab-org/ci-cd/deploy-stage/environments-group/info/-/issues) for [Ops Section Async Updates](/handbook/engineering/devops/).
...
everyone is encouraged to set the deadline based on the date of the last severity label update and [the SLA for the given severity](/handbook/product-development/how-we-work/issue-triage/#severity-slos).
...
1. GitLab Issue triage procedure: we have a handbook section we can follow
   [here](/handbook/product-development/how-we-work/issue-triage/#priority)
...
- Reprioritazation will have a dedicated section in the milestone planning
  issue.
- Outdated bugs are closed in accordance with [the existing handbook practice](/handbook/product-development/how-we-work/issue-triage/#outdated-issues)

###### Best practices

- Read the issue triage [handbook page](/handbook/product-development/how-we-work/issue-triage/)
...
The Environments group uses [GitLab QA](https://gitlab.com/gitlab-org/gitlab-qa) for End-to-End testing. We have [guidelines](/handbook/engineering/devops/runner/environments/quality) for how our team is leveraging these tests.
...
We participate in the [OPS showcase initiative](/handbook/engineering/devops/), to facilitate the selection of topics, the creation of the issues and content we have a Showcase DRI which will:
...
instructions as well as our [handbook entry](/handbook/engineering/devops/runner/environments/autodevops/)
...
- [Enabling premium features for development purposes](/handbook/engineering/workflow/developer-onboarding/#working-on-gitlab-ee-developer-licenses)
