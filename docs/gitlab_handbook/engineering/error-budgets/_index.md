...
1. Infrastructure teams (Teams represented on the [infrastructure team page](/handbook/engineering/infrastructure-platforms/))
...
|------------------|---------------------|---------------------|---------------------|
| Runtime: Organizations | 99.79% | To allow the group to focus on long-term scalability work (Protocells/Organizations) as well as coordinate changes requiring introduction in the next API version. Described in [this MR](https://gitlab.com/gitlab-com/www-gitlab-com/-/merge_requests/108039) | 2026-04-30 (or if total traffic share exceeds 5%) |
