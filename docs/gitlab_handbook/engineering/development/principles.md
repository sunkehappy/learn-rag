...
Engineers, Product Managers, and Designers have the most direct influence over the reliability of the code through either planning, implementation, monitoring (e.g. [Kibana](/handbook/support/workflows/kibana/), [Sentry](/handbook/support/workflows/sentry/), Grafana and other [GitLab.com monitoring tools](/handbook/engineering/monitoring/#monitoring)), or prioritization of the work. Product and Engineering management monitors (e.g. [Error Budgets](/handbook/engineering/error-budgets/)) and measures the reliability of features and makes recommendations if necessary. Our focus on [learning and development](/handbook/people-group/learning-and-development/) will also ensure that teams have the tools and training required to build reliable software. The [Infrastructure Platforms](/handbook/engineering/infrastructure-platforms/), [Application Security](/handbook/security/product-security/security-platforms-architecture/application-security/#application-security-mission), [Database](/handbook/engineering/data-engineering/database-excellence/database-frameworks/) and [Developer Experience](/handbook/engineering/infrastructure-platforms/developer-experience) teams are the Subject Matter Experts supporting product development teams.
...
Please see the [Product Management section](/handbook/product/product-processes/cross-functional-prioritization/) that governs how they prioritize work, and also should guide our technical decision making.
...
1. People are at [increased risk of burnout](/handbook/people-group/time-off-and-absence/time-off-types/).
...
Follow the [dogfooding process described in the Product Handbook](/handbook/product/product-processes/dogfooding-for-r-d/) when considering building a tool outside of GitLab.
...
- [the importance of velocity](/handbook/engineering/development/principles/#velocity)
