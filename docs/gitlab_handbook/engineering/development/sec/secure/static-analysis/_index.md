...
Weights represent projected days of end to end execution time. This allows for straightforward capacity planning and epic-level estimates by summing weights across issues.

##### Possible Values

Weights use fibonacci-inspired values mapped to days. If uncertainty exists due to complexity, account for it in the weight or break the work into smaller issues.

| Weight | Days | Reference issues |
| ------ | ---- | ---------------- |
| 0.5 | Half day | |
| 1 | 1 day | [Update Bandit analyzer to v1.6.2](https://gitlab.com/gitlab-org/gitlab/-/issues/12926) |
| 2 | 2 days | [Security Dashboard should show dismissal details on issues](https://gitlab.com/gitlab-org/gitlab/-/issues/9715) |
| 3 | 3 days | [Dependency Scanning Fails: "engine 'node' is incompatible with this module"](https://gitlab.com/gitlab-org/gitlab/-/issues/12471), [Dependency List contains duplicates (npm project)](https://gitlab.com/gitlab-org/gitlab/-/issues/12162), [Make vulnerability-details receive a vulnerability as a prop](https://gitlab.com/gitlab-org/gitlab/-/issues/14006) |
| 5 | 5 days | [Engineering Discovery: reconsider Gemnasium client/server architecture](https://gitlab.com/gitlab-org/gitlab/issues/12930), [Support setup.py in Dependency Scanning](https://gitlab.com/gitlab-org/gitlab/issues/11244) |
| 8 | 8 days | [SAST for Apex](https://gitlab.com/gitlab-org/gitlab/-/issues/10680), [Add License information to the Dependency List - add license info backend](https://gitlab.com/gitlab-org/gitlab/issues/13084) |
| 13 | 13 days | [WAF statistics reporting](https://gitlab.com/gitlab-org/gitlab/-/issues/14707), [Add support for REST API scans to DAST](https://gitlab.com/gitlab-org/gitlab/-/issues/10928) |
| 21 | 21 days | |
| Larger | Epic in disguise | |

Items may take longer than the initial weight. We do not inflate weights as [velocity](/handbook/engineering/development/principles/#velocity) is more important than predictability.
...
- Given the issue's weight, are we reasonably confident there is enough time left in the milestone for the engineer to deliver the issue?
  - We currently assume that an issue with weight 13 can be delivered in a single milestone.
...
security-sp-label-missing and security-triage-psirt will be added and this issue will be listed in the
[AppSec Triage Dashboard](https://triage-dashboard-2c1ad6.gitlab.io/). Then, the appsec stable counterpart for the group or Appsec team triage person
