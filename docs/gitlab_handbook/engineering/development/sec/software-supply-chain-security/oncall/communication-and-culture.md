...
**Bad:** "John deployed broken authentication code; he should have tested it"

**Better:** "The deployment process didn't catch this authentication issue. How can we improve testing or add pre-deployment validation?"
...
- ✅ "I found the authentication token expiration issue in the session handler, it started after the 4 PM deployment"
- ❌ "Things look bad"
...
- When making changes: "Rolling back authentication service version 2.1.3"
...
- ✅ "I've investigated for 20 minutes, looked at authentication logs, session metrics, and recent deployments. This appears to be a database connection issue. Escalating to the database team."
...
Since SSCS covers three domains (Authentication, Authorization, Pipeline Security), clear communication is critical:

### When Issues Span Domains

- Clearly identify which domain(s) are affected
- Loop in relevant team members from other domains
- Coordinate investigation to avoid duplicate work
- Share findings that might impact other domains

### Example Cross-Domain Scenario

"Authentication service is failing, which is causing authorization checks to timeout. I'm investigating the authentication side. @AuthorizationEngineer, can you monitor authorization service health while I work on this?"
...
- Build relationships across Authentication, Authorization, and Pipeline Security teams
...
- It's beyond your domain expertise
- It's too urgent for your pace
- You need help making a decision
- The issue affects multiple SSCS domains

### How to Escalate

In Slack and/or Incident.io:

- **Why:** "This is an authorization policy issue, I need authorization team expertise"
- **What you've tried:** "I checked authentication logs, session metrics, and recent deployments. Authentication is working correctly."
- **What's needed:** "Need someone to check authorization policy evaluation for this user role"
...
- ✅ "The deployment process didn't catch this authentication issue"
- ✅ "We didn't have monitoring for this authorization condition"
- ✅ "The runbook didn't have a step for this pipeline security scenario"
...
- Burnout is common
- Silos between Authentication, Authorization, and Pipeline Security teams
...
- [Handoffs and Continuity](/handbook/engineering/development/sec/software-supply-chain-security/oncall/handoff-and-continuity) — Apply blameless culture to handoffs
- [Your First Shift](/handbook/engineering/development/sec/software-supply-chain-security/oncall/your-first-shift) — Use these principles when you get paged
- [Measuring Success](/handbook/engineering/development/sec/software-supply-chain-security/oncall/measuring-success) — See how escalation communication impacts metrics
