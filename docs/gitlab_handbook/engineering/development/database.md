...
Also see [Database Team](/handbook/engineering/data-engineering/database-excellence/database-frameworks/) in Enablement.
...
1. [Backend Engineer, Database](/job-description-library/engineering/backend-engineer/) - in Development
2. [Database Reliability Engineer](/job-description-library/engineering/infrastructure/database-reliability-engineer/) - in Infrastructure
...
* It does not come with operational responsibility for GitLab.com and its database infrastructure. This responsibility belongs to the [Database Reliability Engineer](/job-description-library/engineering/infrastructure/database-reliability-engineer/).
...
If you're interested in participating in database reviews, please start by reviewing [the Database maintainer process](/handbook/engineering/workflow/code-review/#project-maintainer-process-for-gitlab-database) which contains all the resources for a reviewer.
