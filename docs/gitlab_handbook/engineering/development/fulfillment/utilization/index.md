...
It is important to [take time off](/handbook/people-group/time-off-and-absence/time-off-types/) so that you can rest, reset, avoid burnout, take care of loved ones, etc. You are encouraged to take time for yourself or your family following our operating principle of [Family and Friends First, work second](/handbook/values/#family-and-friends-first-work-second). Guidance is to communicate your PTO intention with your manager with [twice the number of days](/handbook/people-group/time-off-and-absence/time-off-types/) that you are taking off.

When going out of office, please be sure to [clearly communicate](/handbook/people-group/time-off-and-absence/time-off-types/) your availability with other people. The following steps are required when submitting a PTO notification.
...
- The Engineering Manager will prioritize `type::maintenance` and `type::bug` issues
...
If any issue requires any additional `~frontend`, `~backend`, `~UX`, or `~documentation` reviews, they are assigned to the respective individual(s) to collaborate on the issue where they can validate assumptions and/or provide missing detail necessary to provide an estimate.

If issues require input around various type of developer tooling or testing strategy, the [Developer Experience](/handbook/engineering/infrastructure-platforms/developer-experience/) team should be involved by creating of an [RFH](/handbook/engineering/infrastructure-platforms/developer-experience/#request-for-help-process).
...
You can find centralized engineering metrics at [this page](/handbook/product/groups/product-analysis/engineering/dashboards/).
