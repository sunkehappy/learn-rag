...
### Collaboration with Growth Team on Trials

The Provision team collaborates with the Growth team on trials work. Growth owns the trial entry points — the trial-initiating surfaces in GitLab and the thin CustomersDot trial entry endpoint and basic controller — while Fulfillment/Monetization owns the deeper trial codebase (provisioning, entitlement, billing, lifecycle, and shared services), as well as all CustomersDot operational support and on-call. For detailed ownership lines and collaboration guidelines, see the [Trials Ownership and Collaboration Framework](/handbook/engineering/development/growth/trials-ownership/). When Growth engineers need to contribute to CustomersDot for trials work, they should follow the decision framework documented there. For questions or collaboration requests, reach out in [#s_fulfillment](https://gitlab.slack.com/channels/s_fulfillment) or [#s_growth](https://gitlab.slack.com/channels/s_growth) Slack channels.
...
- [Trials Ownership and Collaboration Framework](/handbook/engineering/development/growth/trials-ownership/) - Conceptual ownership model and decision framework for trials work across Growth and Fulfillment/Monetization
