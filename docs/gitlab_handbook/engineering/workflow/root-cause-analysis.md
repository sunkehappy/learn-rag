...
Unplanned upgrade stop has a [special template for conducting Root Cause Analysis](https://gitlab.com/gitlab-org/gitlab/-/blob/master/.gitlab/issue_templates/rca_upgrade_stop.md). Please refer to [Unplanned upgrade stop](/handbook/engineering/workflow/unplanned-upgrade-stop/) page to learn more.

For a more in-depth overview of an established RCA process, please review [this handbook page](/handbook/customer-success/professional-services-engineering/workflows/internal/root-cause-analysis/).
...
The public RCA should be available seven business days after the incident is resolved. This applies only to Severity 1 incidents.
