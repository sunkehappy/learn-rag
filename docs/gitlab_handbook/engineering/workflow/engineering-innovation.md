...
- **Public by Default:** In alignment with GitLab's [Public by Default](/handbook/values/#public-by-default) value, innovations should be public from the start if possible. This promotes:
  - Enhanced trust and transparency with our community
  - Potential community collaboration opportunities

- **Review Confidentiality Guidelines:** Before making your innovation public, review the [Confidentiality Levels](/handbook/communication/confidentiality-levels/#not-public) guidelines to determine if your innovation contains any sensitive information that should not be public, such as:
...
1. **Get Internal Feedback:**
    ...
    - Get POC feedback from your Manager and Director+ in the Feedback issue created at [step 3](#step-3-start-work-on-the-poc-and-create-the-associated-issues):
      ...
      - If your innovation involves other product areas, lean into our [short toes](/handbook/values/#short-toes) value by involving the correct teams early on.
...
4. **If Confidential, Transition The Epic to Public:**
    ...
    - In line with GitLab's [Public by Default](/handbook/values/#public-by-default) value, work with the corresponding Product and UX team to make your innovation public as soon as possible once you've validated its potential. If your innovation contains potentially patentable information, work with your manager and the Legal Team to see if it meets [patent requirements](/handbook/legal/patent-program/#conditions-of-participation).

    - Ensure the transition aligns with GitLab's Company Strategy and [Values](/handbook/values/), and collaborate with Product and UX when publicly communicating the innovation.
...
- **GitLab Engineering Handbook:** Refer to the [GitLab Engineering Handbook](/handbook/engineering/) for further context on engineering best practices and standards.

- **GitLab Values:** Understand more about our core principles in the [GitLab Values](/handbook/values/) page.

- **Architecture Design Workflow:** Architectural innovation usually follows our [Architecture Design Workflow](/handbook/engineering/architecture/workflow/)
