...
You can also help community contributors get their merge requests ready, by becoming a [Merge Request Coach](/job-description-library/expert/merge-request-coach/).
...
#### Pre-requisites for Maintainership
...
1. Announce this change in the applicable channels listed under [Slack section of the engineering communications handbook](/handbook/engineering/workflow/engineering-comms/#slack) and `#backend_maintainers`/`#frontend_maintainers` and `#backend`/`#frontend`.
...
- Familiarize with our [advanced search migration review process](https://docs.gitlab.com/ee/development/search/advanced_search_migration_review.html).
- Understand how [advanced search migration helpers](https://docs.gitlab.com/development/search/advanced_search_migration_styleguide/#migration-helpers) work and review usage in existing migrations.
- Understand our [advanced search migration style guide](https://docs.gitlab.com/ee/development/search/advanced_search_migration_styleguide.html) and review usage in [existing migrations](https://gitlab.com/gitlab-org/gitlab/-/tree/master/ee/elastic/migrate).
- Join the `#g_global_search` Slack channel.
- Optional: Reach out to an existing maintainer to help you become a maintainer.
...
- All team members should consult the [engineering development roles](/job-description-library/engineering/development/) and become a reviewer or maintainer.
...
[communicated](/handbook/people-group/time-off-and-absence/time-off-types/)
