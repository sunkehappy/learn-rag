...
Per the stated [Roles & Responsibilities](#roles-and-responsibilities), changes to this page must be approved or merged by a code owner. All contributions are welcome and encouraged.
{{% /panel %}}
...
In addition to the company-wide tips in [Communicating Your Time Off](/handbook/people-group/time-off-and-absence/time-off-types/), take a look at these tips to increase your ability to disconnect from work, truly make the most of your time off, and make it easier to return to work:
