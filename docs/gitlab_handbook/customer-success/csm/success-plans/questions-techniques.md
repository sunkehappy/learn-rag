...
[Orit Golowinski](https://gitlab.com/ogolowinski),  Release Stage Senior Product Manager,  has shared some open-ended questions that would be useful in another similar scenario illustrated above.
