...
3\. **[Pooled CSE Model:](/handbook/customer-success/csm/segment/cse/cse-operating-rhythm/)**
...
- [Email Content - GitLab Internal Only](https://docs.google.com/document/d/1Db6y_i2gPQrPnJkJpAAbfFKQtw4c5VgSFJcHKDG-4hk/edit)

5\. **CSM to CSE+ Account Transition Process**

- Standardized process for transitioning accounts from dedicated CSM to CSE+ pooled support.

- Ensures consistent handovers with comprehensive documentation and approval gates.

- CSM-led customer communication emphasizing AE as primary contact and on-demand CSE support.

- Maintains customer success continuity during engagement model changes.

- [CSM to CSE+ Account Transition Process](/handbook/customer-success/csm/segment/cse/csm-to-cse-handover/)
...
For an additional overview of our CSE team-specific responsibilities, please reference our Job Family: [CSE Responsibilities & Requirements](/job-description-library/sales/customer-success-engineer/)
