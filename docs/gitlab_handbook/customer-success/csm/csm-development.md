...
The content is divided into three key categories of competencies. [LevelUp](https://levelup.edcast.com/home) is GitLab's Learning Experience Platform for certifications, learning paths and more! If you have ideas about a course you'd like to develop, get in touch in the #learninganddevelopment channel, and the L&D team can help get you set up.
...
#### CSM Intership and Mentorship

- [CSM Internship for learning](/handbook/customer-success/csm/csm-internship/)
- [CSMA Mentorship Program](/handbook/customer-success/csm/csm-mentorship/)
...
- Self Certifications are available on [GitLab University](https://university.gitlab.com/pages/certifications). Each exam has a corresponding free, self-paced course that covers the needed knowledge and skills:
...
- The [CSM Job Family page](/job-description-library/sales/customer-success-management/) is kept updated with the roles and responsibilities of each level within the CSM job family
