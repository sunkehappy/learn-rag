...
On a weekly basis, the [CSM Manager](/job-description-library/sales/customer-success-management/#manager-customer-success-managers) and [Manager of Renewals](/job-description-library/sales/renewal-manager/#manager-renewals) discuss and update details for upcoming renewals.
...
Direct reports to the [VP of Customer Success Management](/job-description-library/sales/customer-success-leadership/#vice-president-of-customer-success) provide updates and discuss action for at-risk customers with upcoming renewals. Focus is on the following:
