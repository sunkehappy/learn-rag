...
Regional holidays and Family and Friends days are included in Mavenlink on each members calendar, followed by the  [time off process](/handbook/people-group/time-off-and-absence/time-off-types/).  Since the days are included in the calendar there is no need to submit the time in the Mavenlink PTO feature or the users time sheet.  When logging into the time sheet, the required work week is shown on the time sheet entry.
...
GitLab's company policy to submit time off is through Workday, and followed by this [handbook process](/handbook/people-group/time-off-and-absence/time-off-types/).
