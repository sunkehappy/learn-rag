...
1. There are additional options that you can configure or leave at their default setting.
    ...
    - **Milestone**: Epics can be assigned to milestones to ensure comprehensive planning.
...
1. Once you have reviewed the metadata, select **Create epic**.
...
1. Type `&2` in the field provided, and select **Investment Tracking** from the list of epics.
...
1. In the **Automation start date** input, use the calendar to enter today's date.
