---
title: "GitLab Agile Portfolio Management - Hands-On Lab: Structuring your Organization"
...
1. In the list of groups and project, click the linked name for the **Frontend** subgroup. You might have to scroll down or use pagination to find it.

1. Within the **Frontend** subgroup, you can see all of the projects and subgroups that exist as part of this group. Spend a few moments exploring some of these subgroups and projects.
...
1. Click the **Create project** tile.
...
1. Notice that the **Visibility Level** is set to private.
...
1. Ensure that the **Initialize repository with a README** checkbox is checked (this is checked by default).
...
1. Type in your email address into the **Username, name or email address** box, and click on the selection box that appears with that email address in it.
...
1. Switch to the **Pending Invitations** tab to see the user invited as a _Direct Member_.
