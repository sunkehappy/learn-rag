...
- [Solutions Architect role description](/job-description-library/sales/solutions-architect/)
...
- [Customer Success Manager role description](/job-description-library/sales/customer-success-management/)
...
- If a [POV](/handbook/solutions-architects/playbooks/pov) is pending or active, update the POV record in Salesforce as required
