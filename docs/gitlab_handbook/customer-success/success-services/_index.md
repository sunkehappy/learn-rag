...
GitLab's Success Tiers are paid service offerings that provide customers with dedicated technical expertise, structured enablement programs, and enhanced support. Each tier is designed to match different levels of customer need, from on-demand pooled resources to a fully designated team.
...
| Tier | Assigned Resource | Accelerators | Training Discount | Certification Vouchers |
|------|-------------------|:------------:|:-----------------:|:----------------------:|
| **On-Demand** | Pooled [CSE](/handbook/customer-success/csm/segment/cse/) | — | — | — |
| **Essentials** | Designated [CSM](/handbook/customer-success/csm/) | — | 5% | 20 |
| **Advanced** | Designated [CSA](/handbook/customer-success/csm/segment/csa/) | 2/year | 10% | 40 |
| **Signature** | Designated [CSA](/handbook/customer-success/csm/segment/csa/) + [ASE](/handbook/support/enhanced-support-offerings/offering-assigned-support-engineer/) | 4/year | 20% | 60 |

- **On-Demand** is available to all GitLab customers. CSEs deliver pooled webinars, hands-on labs, and office hours.
- **Essentials** provides a named CSM who owns your success plan, cadence calls, and renewal strategy.
- **Advanced** provides a named CSA with deeper technical expertise and structured Accelerator programs.
- **Signature** adds an Assigned Support Engineer (ASE) alongside the CSA for the highest level of white-glove support.

To get started with a paid Success Tier, visit [about.gitlab.com/services/](https://about.gitlab.com/services/).

## What Is an Accelerator?

An Accelerator is a 12-week structured enablement program delivered by your CSA, aligned to your mutual success plan. Each Accelerator follows a four-phase lifecycle: **Discovery → Design → Deliver → Measure**. Accelerators are included with the Advanced (2/year) and Signature (4/year) tiers.

For a full list of available Accelerator programs, see the [Accelerator Catalog](/handbook/customer-success/success-services/accelerator-catalog/).

## Customer-Facing Roles

| Role | Tier | Description |
|------|------|-------------|
| [Customer Success Engineer (CSE)](/handbook/customer-success/csm/segment/cse/) | On-Demand | Technical product experts delivering pooled, on-demand enablement to all customers |
| [Customer Success Manager (CSM)](/handbook/customer-success/csm/) | Essentials | Designated advisor driving adoption, success planning, and renewal strategy |
| [Customer Success Architect (CSA)](/handbook/customer-success/csm/segment/csa/) | Advanced / Signature | Highest-rated technical experts delivering architecture guidance and Accelerator programs |
| [Assigned Support Engineer (ASE)](/handbook/support/enhanced-support-offerings/offering-assigned-support-engineer/) | Signature | Dedicated support engineer providing proactive monitoring and accelerated incident resolution |

For a side-by-side comparison of all CS and SA roles, see the [CS & SA Roles Overview](/handbook/customer-success/roles-overview/).

## Success Tiers

### Overview

Our Success Tiers drive adoption and value realization of GitLab products whilst providing customers with Best Practices and a higher tier of White Glove support. We achieve this by bundling an [Assigned Support Engineer (ASE)](/handbook/support/enhanced-support-offerings/offering-assigned-support-engineer/), [Customer Success Architect (CSA)](/job-description-library/sales/customer-success-architect/)/[Customer Success Manager (CSM)](/handbook/customer-success/csm/#what-is-a-customer-success-manager-csm-at-gitlab) and Education services into a single SKU as an annual renewable service.
...
- **Escalations**: {{< member-by-gitlab "kgeorgeson" >}}
...
GitLab University Panorama is a dedicated, managed learning portal included with the **Signature Success Tier**. Customers who have purchased GitLab University Enterprise separately also qualify. It provides SSO integration, custom content hosting, and customer-specific reporting — giving your team a centralized hub for GitLab training and certifications.

**Key talking points for onboarding**

During the onboarding conversation, discuss:

- **Learning priorities**: What are their top 3 focus areas? (e.g., CI/CD, AI/Duo, Security)
- **Authentication**: Do they prefer SSO (requires IT involvement) or a simpler registration code?
- **Certifications**: How many certification vouchers did they purchase?
- **Custom content**: Do they want to host internal training materials alongside GitLab courses?
- **Reporting**: Who should have admin access to view usage dashboards?

Once you've gathered customer preferences, follow the [GitLab University Panorama request workflow](/handbook/customer-success/success-services/glu-panorama/) to submit the formal request. Setup typically takes 5 business days.
