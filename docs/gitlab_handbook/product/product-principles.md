...
Our [simplicity](#user-experience) and [SaaS/Self-Managed Parity](/handbook/product/product-principles/#design-for-self-managed-for-feature-parity-between-deployments) principles require that we adhere to our established knowledge architecture. Our established architecture is [Organization](https://gitlab.com/groups/gitlab-org/-/epics/4257#proposal), [Group](https://docs.gitlab.com/user/group/) and [Project](https://docs.gitlab.com/user/project/).
...
Product Managers at GitLab are frequently confronted with the choice of whether to add new configurations or not.
...
Additionally, you can familiarize yourself with [GitLab's Pajamas design system principles](https://design.gitlab.com/get-started/principles/).
...
that we wanted to try in every release, and
...
us do that. Also see [the importance of velocity](/handbook/engineering/development/principles/#velocity)
...
- **Consider the right buyer for pricing**
  ...
  - When an integration is driven by an organizational requirement (such as having all teams in the company use Jira), Buyer Based Tiering likely indicates that the integration is for _multiple team_ (Premium) or _strategic organizational_ (Ultimate) use.
...
1. Developers don't have to sacrifice [velocity in favor of predictability](/handbook/engineering/development/principles/#velocity), since they don't have to worry about breaking the plugin API.
