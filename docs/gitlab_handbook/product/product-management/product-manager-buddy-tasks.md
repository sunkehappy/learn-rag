...
1. [ ] - Suggest handbook pages they may find useful
    ...
    - Helpful for research
        - [How/When to start a research project](/handbook/product/ux/experience-research/)
        - [How to recruit for a UX Project](/handbook/product/ux/experience-research/recruiting-participants/)
        - Dovetail
...
1. [ ] - The flow of a milestone
    ...
    - [Release posts](https://docs.gitlab.com/development/documentation/release_notes/)
    ...
    - Moving issues that do not finish in the milestone
        - This is an [https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/developer-experience/triage-operations/#milestone-reschedule] to move issues that do not finish in a milestone but it's good to review issues that were not closed in a milestone as it does not move confidential issues.
    - Retrospectives
