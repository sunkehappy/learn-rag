...
- [KPIs and Metrics](/handbook/product/product-management/learning-and-development/#-kpis-metrics-and-okrs)
...
| [PM](/job-description-library/product/product-manager/#product-manager)| [Senior PM](/job-description-library/product/product-manager/#senior-product-manager) | [Staff PM](/job-description-library/product/product-manager/#staff-product-manager) | [Principal PM](/job-description-library/product/product-manager/#principal-product-manager) |
| ------ | ------ | ------ |------ |
...
Below, you'll find the CDF framework and potential discussion topics for [Pricing Product Managers](/job-description-library/product/pricing/).
...
| [Pricing Analyst](/job-description-library/product/pricing/#pricing-analyst)| [Senior Pricing Analyst](/job-description-library/product/pricing/#senior-pricing-analyst)| [Principal Pricing Manager](/job-description-library/product/pricing/#principal-pricing-manager) |
| -------- |-- | -- |
...
Typical scope and reporting structure is documented in the [Product Management Leadership job family](/job-description-library/product/product-management-leadership/).
...
Responsibilities outlined in the [Group Product Manager Job Family page](/job-description-library/product/product-management-leadership/#group-product-manager-gpm).
...
_Example outcomes: Represent GitLab externally in industry talks, podcasts, or conferences. Creates content for product vision. Coaches teammates on employing effective thought leadership mechanisms. Actively engages analysts for generating market priorities._
...
_Example outcomes: Lives CREDIT values. Coaches others on CREDIT Values. OKR execution and completion by the team. Stage and Section Say/Do ratios or MR rates are attaining targets._
...
When evaluating a product manager's potential, in addition to the [generic information](/handbook/people-group/talent-assessment/#what-is-growth) outlined, we also want to evaluate potential based on the unique and outsized impact PMs can have. We acknowledge that the evaluation will remain more qualitative than quantitative, but rather than shy away from making an evaluation, we will lean in using the information below.
...
| **Levels**                      | PM | Senior PM | Principal PM | Senior Principal PM |
| ------------------------------- | ------------ | ------ | --------- | ---------------- |
