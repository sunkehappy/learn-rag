...
1. Set the start date to be the Saturday prior to the previous releases [release date](/handbook/engineering/releases/monthly-releases/#monthly-release-schedule)
