...
* [UX research in AI space](/handbook/product/ux/experience-research/research-in-the-ai-space/): Helps team members evaluate the usefullness and usability of AI features.
...
* The UX Research team maintains a [usability evaluation and scoring process](/handbook/product/ux/experience-research/research-in-the-ai-space/#ai-user-experience-survey-pilot) to ensure ease of use.
* For fast, qualitative feedback on AI response quality, as well as to get an idea of what kinds of prompts users write, you can run a [UX Chat Bash](/handbook/product/ux/experience-research/ux-bash/).
...
* [Model Vendor Selection Guidelines](/handbook/product/ai/model-vendor-selection-guidelines/): The framework we use to evaluate and select the vendors who develop and host the models powering GitLab Duo.
...
* [AI teams](/handbook/engineering/ai/#ai-engineering-teams)
