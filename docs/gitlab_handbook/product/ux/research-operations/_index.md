---
title: "Research Operations (ReOps) at GitLab"
description: "We empower Research DRIs with the resources needed for efficient and high-quality research, enabling team members to focus on generating insights that drive exceptional user experiences and product innovation."
---

## What is Research Operations?

Research Operations (often referred to as ReOps) is a discipline within Experience Research focused on managing and optimizing the processes, tools, and infrastructure that support research activities conducted by the Experience Research team. The primary goal of Research Operations is to enable Researchers to conduct their work more efficiently and effectively by providing the necessary support and resources.

Here are some key aspects of Research Operations in GitLab:
...
The ReOps team drives all of the above aspects. And often, Research DRIs can lead the ReOps aspects of their own projects, with the ReOps Specialist's supervision.
...
## How many studies can a Research Operations Specialist support?

The short answer is approximately 5-10 at any given time. The long answer is that it depends on the type of study and the target population. When each study only requires 5-8 participants who are relatively abundant in our database and community, the number of studies recruited per milestone could be ~10. This is also contingent upon the Product Designer and Product Manager submitting their complete requests early enough to allow specialists to juggle multiple recruiting efforts at once. When there are surveys that require 50+ respondents, or studies addressing new user groups or features, the number of studies recruited per milestone may be closer to 5. Those studies require sustained effort and creativity.

Never hesitate to bring up a recruitment request - the Research Operations Specialist  will work with you to schedule the recruiting effort. Feel free to reach out to @Caitlin on Slack.

## How does the Research Operations Specialist  plan ahead?

When the number of requests exceeds 10, the specialist is at over capacity.  When this occurs, there are too many projects to successfully manage at once, and the following side effects are experienced internally and externally to GitLab:

* Timelines slip
* Outbound communications from the Research Operations Specialist are reduced, resulting in the feeling of going dark
* Inbound communications to the Research Operations Specialist are increased, from people wanting to know statuses and help with next steps
...
The specialist is responsible for driving and maintaining the research coordination quarterly planning exercise, the monthly check-ins, and keeping the Google Sheet up to date and accurate.

### 2) A back-up plan

To keep research projects on track, at least 2 other UX Researchers are [trained to work as Research Operations Specialist](/handbook/product/ux/research-operations/research-specialist-fill-in/) when Research Operations Specialist are unavailable or if they are at over capacity and need additional assistance.

The Research Operations Specialist is responsible for:
...
* Recrutiting intake process (ex: how to respond to all parties, Service Level Agreement (SLA), expectations of a specialist, etc)
...
Even with accurate planning, over-capacity can still occur.  When this happens, specialists have several actions they can take:

* **Inform the team - Be transparent.**  Let the #experience_research channel know, along with managers, that Research Operations Specialist is over capacity at the moment along with an estimated timeframe on when they expect things to get back to normal. This automatically sets expectations for existing and new requests.  Lastly, follow-up with a post when capacity returns to normal to let the channel know.
...
* **Ask for help** - Research Operations Specialists need to ask their trained UX Research Team back-ups for help. Research Operations Specialists will need to delegate the right duties to the UX Researchers to result in the biggest impact.
...
* **Encourage self-service** - Research Operations Specialists can point people to self-serve resources with a link to instructions in the handbook (ex: using Respondent and User Interviews to find participants, etc).

## When Research Operations Specialists are unavailable

Since Research Operations Specialists have unique duties that are critical to the success of research at GitLab, when they are unavailable, recruitment efforts slow down.  This results in a series of problems for all parties.

To address this, two UX Researchers are available to act as back-up when specialists are unavailable.  Back-ups complete any in-progress tasks, accept new requests, and keep existing requests on track.

Prior to the specialist becoming unavailable, they create an issue to provide their assigned back-up(s) with a clearly detailed list of:
...
* Flag exactly what needs to be done by the back-up Research Operations Specialist

It's the responsibility of the specialist to make sure their back-up understands their duties and responsibilities.
