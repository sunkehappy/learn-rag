...
We should not depend entirely on data to make decisions, but it should be an essential input to decision making. To learn more about quantitative data/research, see the [Using Data to Find Insights](/handbook/product/ux/experience-research/quantitative-data/) handbook page.

{{< youtube "J-USG9BKH-g" >}}

## Aligning hypothesis to impact

Part of the design process is to have a [strong hypothesis](/handbook/product/ux/experience-research/defining-goals-objectives-and-hypotheses/) to guide our work.
...
- [Using Data to Find Insights](/handbook/product/ux/experience-research/quantitative-data/)
