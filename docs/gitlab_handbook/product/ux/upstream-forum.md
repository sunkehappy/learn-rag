...
description: >-
  The Upstream Forum is a recurring meeting for UX team members to share and discuss their work.
---

## About Upstream Forum
...
Forums are scheduled every two weeks. They are 60 minutes long to allow up to three team members to share for 15 minutes, plus 5 minutes of discussion time with the attendees. A fourth speaker spot is available to allow for flexibility in scheduling, but ideally most Upstream Forums should only have three speakers.
...
- Each forum is hosted by a Product Design Manager.
  - Due to time zone restrictions for managers, the APAC Upstream Forum is hosted by another Product Designer, Technical Writer or UX researcher.
...
- It is the responsibility of the host to know when they are scheduled to host and the responsibility of the speaker to know when they are scheduled to share. To help, a Slack reminder has been set up in the `#product-design-managers` channel to review the schedule.

If a speaker can't share on their assigned date, it's their responsibility to make a trade. To make a trade:

- Announce in the `#upstream-studios` channel that you'd like to trade.
- After you identify a trade, make an MR to update the schedule.
- Ask your Product Design Manager to review and merge.

**Live presentation is required**. Please do not record your topic in advance. The value of Upstream Forums comes from real-time discussion, the ability for attendees to ask questions and engage directly with you about your work, and the opportunity to share your work live with team members. Since we work remotely, these forums are one of the few occasions for this kind of direct interaction.

{{% include "includes/product/upstream-forum-schedule.md" %}}

<a href="https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/assets/includes/product/upstream-forum-schedule.md" class="btn btn-primary">Update schedule</a>
...
- **Informal**:
    ...
    The Upstream Forum is to share and discuss your work informally, not fancy storytelling.
...
- Prior to the Upstream Forum, add your specific topic to the meeting agenda.
...
- [Make the participant experience an enjoyable one](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-tips/#make-the-participant-experience-an-enjoyable-one): avoid moving around too fast (for example, when showing a Figma prototype), or back and forth between views because you forgot to say one thing at the previous one.
- [When sharing your screen](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-tips/#how-to-share-a-presentation-in-zoom), consider going fullscreen so that the audience can see the details.
...
- [Provide links](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-tips/#provide-links-rather-than-sharing-while-you-present-or-edit) in the agenda doc that are relevant to your story, such as, issues, epics, Figma files, FigJam boards, and recordings.
...
Product Design Managers take turns hosting the Upstream Forum.

### Recording the sessions

To limit the amount of post-Upstream Forum editing, please start and stop (not pause) the recording after each topic. This will ensure that each topic saves as an individual clip, which is much faster to edit than a 1-hour clip. Choose "record to computer" each time you record.
...
1. Name the videos with "Upstream Forum" + the title of the topic.
...
1. Add the videos to the [Upstream Forum playlist](https://www.youtube.com/playlist?list=PL05JrBw4t0Kq89nFXtkVviaIfYQPptwJz), and the [UX Team playlist](https://www.youtube.com/playlist?list=PL05JrBw4t0KqkW0oPW3n0HqVgKcONVnO5).
...
1. Share the YouTube links in `#upstream-studios` and `#product` Slack channels with a brief description of each topic.
...
### Updating the schedule and preparing for next sessions

After each session, the [DesignOps Upstream Forum automation](https://gitlab.com/gitlab-com/designops/-/tree/main/automations/upstream-forum) automatically:

1. Removes the completed session from the [schedule](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/assets/includes/product/upstream-forum-schedule.md) via an MR
1. Creates an [Upstream Forum tracking issue](https://gitlab.com/gitlab-org/gitlab-design/-/issues?label_name=UX+Forum) in `gitlab-org/gitlab-design` for the next scheduled session, pre-filled with the host and speaker handles from the schedule

When editing the schedule, include GitLab handles in parentheses after each name — e.g., `Name (@handle)` — so the automation can @-mention the correct people.
