...
At GitLab, we track [actionable insights](/handbook/product/ux/experience-research/research-insights/) derived from UX research studies. These can be in the form of `Exploration needed` or `Product change`.
