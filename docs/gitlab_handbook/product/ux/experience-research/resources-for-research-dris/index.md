...
- They then discuss with the UXR to assess and determine if research is necessary (more on [how UXR prioritize our work](/handbook/product/ux/experience-research/research-prioritization)).
...
- If cancellation or rescheduling is needed from our side:
  - Communicate early, explain the reasons and offer compensation if appropriate, for example [when we didn't give enough notice](/handbook/product/ux/research-operations/participation-gratuities).
...
- A research project may be put in the backlog due to the team's capacity constraints. For more information on how we make that decision, see [how UXR prioritize our work](/handbook/product/ux/experience-research/research-prioritization).
