...
The above illustration shows a simplified version of GitLab's usage data stack, based on [this document.](/handbook/enterprise-data/platform/)

### Getting Access

Complete an [access request to use Tableau](/handbook/enterprise-data/platform/tableau/). Some UX Researchers have Explorer roles, and some have Viewer roles - if you want to see the differences in capabilities between the two roles, [check this handbook page](/handbook/enterprise-data/platform/tableau/).
