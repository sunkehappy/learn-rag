...
- **Ranking** - Allows respondents to rank a list of items, typically by preference.
  ...
  - Things to watch for: offering too many items to rank (very common) which can impact how much time it takes respondents to rank items, making sure respondents understand each item clearly (can be accomplished by [piloting the survey first](/handbook/product/ux/experience-research/surveys/piloting-your-survey/).
