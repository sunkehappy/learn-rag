...
1. Quantitative survey questions
     ...
     - You [analyze quantitative surveys](/handbook/product/ux/experience-research/quantitative-data/) by counting the number of people who selected each option presented and then use [descriptive statistics](https://www.qualtrics.com/experience-management/research/descriptive-research/).
...
When [determining which research method to use](/handbook/product/ux/experience-research/choosing-a-research-methodology/), you should start with your research questions and envision how those can be answered, given the available research methods.
...
If you're unsure if a survey is right for your needs, it's suggested that you get [crisp on your research questions](/handbook/product/ux/experience-research/defining-goals-objectives-and-hypotheses/#step-2---start-populating-questions-we-need-answers-to) to understand what kind of data is needed to answer those questions. That exercise will often make it easier to reveal the best research method to use.
...
1. [Pilot your survey](/handbook/product/ux/experience-research/surveys/piloting-your-survey/)
1. [Create a recruitment request issue to distribute your survey](/handbook/product/ux/experience-research/recruiting-participants/#open-a-recruitment-request-issue)
1. [Analyze the data](/handbook/product/ux/experience-research/quantitative-data/)
