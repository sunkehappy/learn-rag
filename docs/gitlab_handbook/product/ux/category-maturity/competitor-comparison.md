...
- **Step 2 - Follow Legal guidelines**
  - Since we're reviewing competitors, it's important that you review and follow the [Guidelines for use of third-party services for competitor benchmarking](https://internal.gitlab.com/handbook/legal-and-corporate-affairs/legal-and-compliance/legal-product-ip/third-party-benchmarking-guidelines) (only available to team members) and the [Guidelines on public discussion of competitor product features](/handbook/legal/competitor-discussion-guidelines/).
