...
1. **Contributions are a priority**: Maintainer candidates should demonstrate consistent, meaningful contributions to the design system. This means actively participating in the design system's development through MR submissions, code reviews, and collaborative problem-solving. Candidates should show they can balance their design system contributions with other responsibilities, treating design system work as an important part of their role rather than an occasional task. Quality and consistency of contributions matter more than quantity. Maintainers need to show they can reliably deliver thoughtful work that moves the design system forward.
1. **Reviews**: Candidates should consistently make it through reviewer review without significant required changes.
