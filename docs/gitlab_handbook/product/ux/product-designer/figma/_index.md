...
View guidance in Pajamas for more on using Figma [Components](https://design.gitlab.com/get-started/uik-components), [Libraries](https://design.gitlab.com/get-started/uik-libraries), and [Annotations](https://design.gitlab.com/get-started/uik-annotation), or for [sharing Figma artifacts](https://design.gitlab.com/get-started/uik-sharing).
