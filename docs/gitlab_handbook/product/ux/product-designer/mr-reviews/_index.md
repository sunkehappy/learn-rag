...
MR review requests are the [top priority for Product Designers](/handbook/product/ux/product-designer/capacity-management/#priorities). Respond according to our [review-response Service-Level Objective](/handbook/engineering/workflow/code-review/#review-response-slo).
...
Some MRs require additional setup:
...
- **Value Stream Analytics**: [Setup and seed data instructions](https://gitlab.com/-/snippets/2169951/raw/main/blocks.md). [Request a developer license](/handbook/engineering/workflow/developer-onboarding/#working-on-gitlab-ee-developer-licenses) as many VSA features require an EE license.
...
- **Provide constructive feedback**:
  ...
  - If there are concerns, consider:
    ...
    - Seeking a second opinion from a [planning team member](/handbook/product-development/how-we-work/roles-and-responsibilities/#its-a-team-effort), design manager, or other designers.
...
- Create follow-up issues for any outstanding UX concerns that deviate from the Minimal Valuable Change (MVC), labeling them as `Deferred UX` (details on [UX labels](/handbook/product/ux/operations/#ux-labels)).
