...
This guide helps you **design AI solutions** thoughtfully to ensure that the technology enhances the user experience and meets strategic objectives.

For how you should **use AI in your design work**, see [AI usage](/handbook/upstream-studios/how-we-work/ai-usage/).
...
- [UX research in the AI space](../experience-research/research-in-the-ai-space/): Documentation on conducting UX research in the AI domain.
