...
| --------  | ------------- |
| [Fulfillment Direction](/handbook/product/groups/fulfillment/direction/fulfillment_section/) | Fulfillment vision and what we are working on next. |
...
## GitLab Trials: availability and provisioning

### Self-serve trials

| Base plan | Add on | Deployment and license type | Duration | Restrictions | Extensions | provisioning workflow |
| ---------- | -------- | --------------- | -------- | ------------ | ---------- | --------- |
| Premium or ultimate (including Duo Core) | None | SM (online cloud licensing) | Not offered today | NA | NA | NA |
| Ultimate (excluding Duo Core)| None | SM (legacy license) | 30 days | Free, Premium customers, 100 users | Not possible, requires a new $0 quote | User fills the form and marketo issues the legacy license that is generated from CDot |
| Premium | Duo Pro | SM (online cloud licensing) | 60 days | Premium customers only, 100 users | Not possible, requires a new $0 quote | User fills form with Subscription ID and we add Duo Pro access based on existing cloud license |
| Premium | Duo Enterprise | SM (online cloud licensing) | Not offered today | NA | NA | NA |
| Ultimate | Duo Pro | SM (online cloud licensing) | Not offered today | NA | NA | NA |
| Ultimate | Duo Enterprise | SM (online cloud licensing) | 60 days | Active subscription required, 100 users | Not possible, requires a new $0 quote | User fills form with Subscription ID and we add Duo Enterprise access based on existing cloud license |
| Premium (including Duo Core)| NA | .Com | Not offered today | NA | NA | NA |
| Ultimate (including Duo Core) | NA | .Com | 30 days | Free, Premium and Ultimate customers | Possible via Support team Internal request | NA |
| Premium | Duo Enterprise | .Com | Not offered today | NA | NA | NA |
| Ultimate | Duo Enterprise | .Com | 30 days for free namespaces and 60 days for Premium and Ultimate customers | Free EE, Premium and Ultimate customers | Possible via Support team Internal request | User can start trial from namespace or marketing landing page |
| Ultimate | Duo Enterprise | Dedicated | Not offered publicly but existing Self-managed forms support a self serve trial | Ultimate dedicated commercial customers, Not possible for Dedicated PubSec customers | Not possible, requires a new $0 quote | NA |

**Eligibility criteria for Self serve trials:**

- Self-serve trials are restricted to one trial per customer
- For most self serve-trials .Com restriction is based on namespace and for Self-managed the restriction is based on Subscription number (Exclusion is Ultimate only trial with a legacy license)
- Duration varies between 30 or 60 days with limited seat count during the trial period
- Dedicated customers can self-serve trial for Ultimate with Duo Enterprise if they were to use the existing trial form for Self-managed customers (we don't restrict dedicated commercial customers)

### Sales-assisted trials

- These are the non-standard trials that require extended duration or additional seat count for the customer to complete evaluation.
- Sales-assisted trials are also offered for customers that want to try a product/plan that is not available in the self-serve flows for customers (examples: offline or air-gapped customers (SM) wanting to try self-hosted capabilities, Duo with Amazon Q, Dedicated etc).
- Most of the sales-assisted trials require a $0 quote and approvals from Deal desk and Revenue teams

| Trial | Deployment type | Assistance type | Duration | Trial creation | Restrictions |
| ------------------- | --------------- | --------------- | -------- | ------------------ | ------------ |
| Premium (excluding Duo Core) | SM (legacy license) | Sales and Support team (Requires internal request for Support team to create legacy license) | 30 days | No $0 quote required | Free EE, Premium and Ultimate customers, 100 users |
| Ultimate (excluding Duo Core) | SM (legacy license) | Sales and Support team (Requires internal request for Support team to create legacy license) | 30 days | No $0 quote required | Free EE, Premium customers, 100 users |
| Premium with Duo Pro | SM (online cloud licensing) | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Premium with Duo Enterprise | SM (online cloud licensing) | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Ultimate with Duo Pro | SM (online cloud licensing) | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Ultimate with Duo Enterprise | SM (online cloud licensing) | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Premium with Duo Enterprise | SM (offline cloud licensing) | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Ultimate with Duo Enterprise | SM (offline cloud licensing) | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Premium (including Duo Core) | .Com | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Ultimate (including Duo Core) | .Com | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Premium with Duo Pro | .Com | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Ultimate with Duo Pro | .Com | Sales team | Customizable end date | Yes with $0 quote | Free EE, Premium and Ultimate customers |
| Ultimate with Duo Enterprise | .Com | Sales team | Customizable end date | Yes with $0 order | Free EE, Premium and Ultimate customers |
| Ultimate with Duo with Amazon Q | SM (online cloud license) | Sales team | 30 days and Requires Leadership approval | Yes with $0 quote | NA |
| Ultimate with Duo with Amazon Q | Dedicated | Sales team | 30 days and Requires Leadership approval | Yes with $0 quote | NA |
...
*On 2025-08-14, GitLab removed external references to the 14-day grace period from Docs, website, renewal banners and emails. However, the grace period still exists in our applications and systems. [Read about it here](https://gitlab.com/groups/gitlab-org/-/epics/18050).*

Sales Rep can generate a temporary extension in SFDC for one of the approved reasons. Extension can be generated 1-15 days before subscription end date or 1-13 days after subscription end date, with a default expiration date of 21 days after subscription end date (followed by the [grace period of 14 days for SaaS extensions only](https://docs.gitlab.com/subscriptions/self_managed/#subscription-expiry)).
...
List of features managed by the [subscription management group](/handbook/product/groups/fulfillment/direction/subscription_management/) within the [Fulfillment section](/handbook/product/groups/fulfillment/direction/fulfillment_section/).
...
1. Subscriptions for Education or OSS (Strategy Programs) or Startups Program.
...
- [Preparing for renewal](https://docs.gitlab.com/subscriptions/manage_subscription/#review-your-account)
- [Renewing a subscription](https://docs.gitlab.com/subscriptions/manage_subscription/#renew-subscription)
- [Automatic subscription renewal](https://docs.gitlab.com/subscriptions/manage_subscription/#renew-automatically)
- [Auto-renewals FAQ](https://about.gitlab.com/pricing/faq-improved-billing-and-subscription-management/#auto-renewals)
- [Developer Relations Programs renewal workflow](/handbook/marketing/developer-relations/programs/program-resources/#renewal)
...
- [Generating coupon codes for strategy programs renewals](https://gitlab.com/gitlab-org/customers-gitlab-com/-/blob/main/doc/community_programs/coupons.md#coupons)
...
- [Seat usage](https://docs.gitlab.com/subscriptions/manage_users_and_seats/#billable-users)
...
In addition to [documented elibiligy cases](https://docs.gitlab.com/subscriptions/quarterly_reconciliation/#eligibility), we exclude from QSRs any subscription where the Account has any of the following settings in Zuora:
...
Other details available in [QSR invoicing and payment docs](https://docs.gitlab.com/subscriptions/quarterly_reconciliation/#invoicing-and-payment).
...
Adding a new billing account membership between a customer and a billing account results in the customer becoming a [subscription management contact](/handbook/support/license-and-renewals/workflows/customersdot/associating_purchases).
...
1. Open a new [Fulfillment Meta bug intake issue](https://gitlab.com/gitlab-org/fulfillment-meta/-/issues/new) (select the bug_intake template) outlining what is known about the bug.
   1. Tag [Fulfillment Product Management](/handbook/engineering/development/fulfillment/) by mentioning the `@fulfillment-group/leadership/fulfillment-pm` group.
...
By nature of our [direction](/handbook/product/groups/fulfillment/direction/fulfillment_section/), Fulfillment works mostly on highly cross-functional projects where either or both of the following are true:
...
Team members in our Sales and Customer Success groups should escalate first via the [Top ARR Drivers meeting](/handbook/product/product-processes/) for cross-team leadership visibility and prioritization. Simply add your item to the list of asks (link in the meeting agenda) for discussion.
