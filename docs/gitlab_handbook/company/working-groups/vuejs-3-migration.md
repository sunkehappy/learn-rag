...
| Functional Lead    | Illya Klymov        | Senior Frontend Engineer, Security Risk Management:Compliance        |
...
| Functional Lead    | Artur Fedorov       | Senior Frontend Engineer, Security Risk Management:Security Policies |
...
| Member             | Alexander Turinske  | Staff Frontend Engineer, Security Risk Management:Security Policies  |
| Member             | Marina Mosti        | Senior Frontend Engineer, Switchboard                                |
| Member             | Nathan Dubord       | Senior Frontend Engineer, about.gitlab.com                           |
| Member             | Vanessa Otto        | Senior Frontend Engineer, AI-Powered:Workflow Catalog                |
