...
Values should match the documented [Data Classification Levels](/handbook/security/policies_and_standards/data-classification-standard/#data-classification-levels) with all lowercase value (for cloud provider tag and label consistency).
