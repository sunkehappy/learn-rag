...
1. Commitment to taking [time off](/handbook/people-group/time-off-and-absence/time-off-types/) every month, and truly unplugging from your laptop or work projects when you're off
...
1. Increased [flexibility](https://web.archive.org/web/20200606214525/https://shedoesdatathings.com/post/1-year-at-gitlab/) in your [daily life](/handbook/company/culture/all-remote/) (for [kids](https://about.gitlab.com/blog/2019/07/25/balancing-career-and-baby/), parents, friends, groceries, sports, deliveries).
...
1. You can [choose your working hours](/handbook/company/culture/all-remote/) based on when you're [most productive](asynchronous/).
...
In a remote setting, where [in-person interactions](/handbook/company/culture/all-remote/) are less common, it's easier to fall victim to [isolation](drawbacks/). This is particularly true for those who are not well acclimated to remote work, or have [just started their first remote role](getting-started/).
...
The aforementioned reality makes it all the more important for any company hiring remote workers to place a great deal of focus on [documenting processes](/handbook/total-rewards/benefits/modern-health/#mental-wellness-support) for team members who face these difficulties. Along with offering professional assistance (see [GitLab Modern Health](/handbook/total-rewards/benefits/modern-health/) as an example), be sure to showcase documented resources of where to turn during [onboarding](/handbook/company/culture/all-remote/), and reinforce this in ongoing [learning and development](/handbook/company/culture/all-remote/) sessions.
...
Leadership can create a more humane atmosphere by leaning on a tool (or tools) that enable asynchronous workflows, thereby [reducing meetings](meetings/) and creating more time for focused, deep work. [GitLab uses GitLab](/handbook/company/culture/all-remote/) to accomplish this.
...
1. [Encourage team members to communicate with their manager when they recognize burnout](/handbook/people-group/time-off-and-absence/time-off-types/)
1. [Encourage team members to notice signs of burnout in their peers and direct reports](/handbook/people-group/time-off-and-absence/time-off-types/)
1. [Added tips to avoid burnout](/handbook/people-group/time-off-and-absence/time-off-types/)
...
Be liberal in scheduling these blocks. They are [two-way doors](/handbook/values/#make-two-way-door-decisions), and can always be removed or reduced. This exercise serves as a forcing function to be proactive about scheduling time to [rest and recharge](/handbook/people-group/time-off-and-absence/time-off-types/) *before* you need it. It also provides a great visual pause for others. E.g. If someone wants to schedule you for a webinar in six weeks, but notices a `Potential PTO Block` on your calendar, it will prompt them to ask you if you intend to convert it to a definitive PTO block. This prevents your schedule from perpetually filling up before you have a chance to formalize a break.

### Make a PTO to-do list

If you find yourself anxious about missing out, or overlooking a *work-related to-do list*, consider replacing that to-do list with a **PTO To-Do List** for the duration of your [paid time off](/handbook/people-group/time-off-and-absence/time-off-types/). This may include items such as practice yoga, schedule coffee with a family member or friend, go for a walk/hike/cycle, sleep X hours per night, nap X hours per day, read X chapters in a new book, etc.
