...
If you're transitioning from an office environment where supplies magically appeared or were stocked in a closet for your use, now you are responsible for acquiring them. Check out our [complete list of office supplies](https://internal.gitlab.com/handbook/finance/expenses/#equipment).
...
- GitLab Developer Advocate Michael F. [details his current setup](https://dnsmichi.com/all-remote-workspace/) with helpful tips on lighting, apps and settings, and how to personalize your workspace.
...
Whether an organization is [fully remote, remote-first, or hybrid](stages/), it's up to company leaders to enable an equitable and inclusive employee experience. Just as you'd invest in a team's workspace in a physical office, enabling team members to create healthy and productive spaces is a core part of building remote infrastructure. An optimized workspace leads to [team member happiness, wellness, and engagement](/handbook/company/culture/all-remote/), and it also leads to better overall results for your organization.
