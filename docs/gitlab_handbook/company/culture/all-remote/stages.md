...
For more, see GitLab's [guide to transitioning a company to remote work](/handbook/company/culture/all-remote/).
...
However, job seekers should [inquire](/handbook/hiring/) to what degree remote workers are supported in such environments. There is a marked difference between *allowing* remote and *supporting* remote. Some employers believe that remote employees are bypassing a commute, therefore no additional support is warranted.
...
There are many flavors of [hybrid-remote](/handbook/company/culture/all-remote/). The key attribute of a hybrid-remote arrangement is that *some* employees — but not all — are allowed to work remotely 100% of the time. These organizations have at least one physical office, and on any given day, a significant portion of the team physically commutes to that location.
...
However, hybrid-remote is a [tempting compromise that masks many downsides](/handbook/company/culture/all-remote/). In a hybrid-remote organization, leaders are forced to manage two fundamentally distinct ways of working. There is administrative burden to manage a default-onsite experience and a default-offsite experience, and some employees may choose to oscillate between the two.
...
This approach may lead to stronger remote muscle being built, and [remote-first workflows](/handbook/company/culture/all-remote/) used on remote days could become the default even on colocated days. The entire team is subject to a [forcing function](/handbook/company/culture/all-remote/): on some workdays, office equipment and workflows just aren't an option.
...
Remote-first organizations optimize their workplaces for remote. They create documentation, policies, and [workflows](/handbook/company/culture/all-remote/) that work when assuming that 100% of the organization is remote, even if some continue to occasionally visit a company-owned office.
