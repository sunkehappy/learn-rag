...
1. **[Get together](/handbook/company/culture/all-remote/):** An all-remote work environment does not mean an always-remote work environment. It's important for team members to interact with each other in person, even if only annually. Consider hosting an [in-person retreat](/handbook/company/culture/all-remote/) for team members for this purpose.
