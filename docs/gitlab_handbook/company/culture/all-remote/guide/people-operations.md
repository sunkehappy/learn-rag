...
1. [Hiring](/handbook/company/culture/all-remote/)
...
1. **Self-learning and self-enabled environment:** Whenever a new hire brings up a valid process point that leads to a previously undocumented answer, the default mindset should be to answer and document right away. This requires a mindset of [self-service](/handbook/company/culture/all-remote/), self-searching, and self-learning. It also requires diligence and empathy. This is a critical part of reinforcing a bias for [asynchronous](../asynchronous/) and a culture where [every meeting is questioned](../meetings/#6-use-the-right-tools).
