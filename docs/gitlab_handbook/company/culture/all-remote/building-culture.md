...
### 5. Encourage participation within a diverse space
  ...
  Both formal and informal communication [in-person interactions](/handbook/company/culture/all-remote/) matters in an all-remote [culture](/handbook/company/culture/). Here's our list of more than 20 different ways to encourage a happy, healthy [informal work culture](informal-communication/).
...
A team member's first experience with company culture is unavoidable. The [onboarding experience](/handbook/company/culture/all-remote/) serves as the first post-interview encounter with culture, and it is essential to infuse the [importance of values](/handbook/company/culture/all-remote/) into that experience.
...
If your company gets all team members together on a regular basis, consider resurfacing values or providing opportunities for groups to live out those values through community service. Just as certain trainings are recommended or required each year as part of a company's ongoing [learning and development](/handbook/company/culture/all-remote/) efforts, reminding team members of values is vital to sustaining a strong culture.
...
From family time to travel plans, there are [many examples and stories](/handbook/company/culture/all-remote/) of how remote work has enhanced the lives of GitLab team members.
...
Where feasible, consider closing the office and operating as a 100% remote company. This eliminates the possibility of any remote employee being seen, intentionally or unintentionally, as [deprioritized](/handbook/company/culture/all-remote/) within the organization.
