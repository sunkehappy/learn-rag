...
| `Compass`                           | Please contact IT via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com. |
...
- For IT related queries, Okta, issues with hardware, software, system access requests and user permissions please contact IT via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
...
Feature channels are the primary collaboration surface for every active feature team. Design shares work-in-progress regularly, and scope changes are logged here, keeping engineering, product, and design aligned in one place.

**Examples**

- **[`#f_external-agents`](https://gitlab.enterprise.slack.com/archives/C0B4V7TJPG9)**: Collaboration space for the for the external agents feature team.

#### Group Channels (g_)

Group channels (prefixed with a `g_`) correspond to a [DevOps Stage group](/handbook/product/categories/#hierarchy) and other [engineering departments and teams](/handbook/engineering/#engineering-departments) and serve as a primary way for developers across the team to communicate about engineering specific topics, such as implementation decisions or technical debt discussions.

**Example**

- **[`#g_create_source-code`](https://gitlab.slack.com/archives/g_create_source-code)**: Engineering discussion space for the [Source Code development group](/handbook/product/categories/#source-code-group).
- **[`#g_geo`](https://gitlab.slack.com/archives/g_geo)**: Engineering discussion space for the [Geo development group](/handbook/engineering/infrastructure-platforms/tenant-scale/geo/).
- **[`#g_agent-execution`](https://gitlab.enterprise.slack.com/archives/C0B93QM1C0Y)**:  Engineering discussion space for the agent execution development group.

#### Stage Channels (s_)

Stage channels (prefixed with `s_`) correspond to stages within sub-departments, they are for cross-team discussion in a specific product area — questions, signals, partner inputs, field questions. Anyone relevant to that area should be in the channel.
...
#### Design Channels (design_)

Design channels are for designers working within the same area, sharing work, getting peer input, and inviting other designers to collaborate. One per team grouping.

**Examples**

- **[`#design_ai-clients`](https://gitlab.slack.com/archives/#design_ai-clients)**.

#### Feedback Channels (feedback_)

Channels where all internal questions, comments and general feedback for a specific feature area can be routed. These channels can contain Slack workflows that require the submitter to add some simple information that will help anyone responding. We set this expectation to use these channels with teams and over time we will all build that muscle.

#### Temp Channels (temp_)

Channels for efforts that require temporary collaboration across teams to solve a specific problem. Should be archived after serving their purpose.

**Examples**

- **[`#temp_interactive-duo-developer`](https://gitlab.enterprise.slack.com/archives/C0B7WAZCKCM)**.
...
| [`#loc_midlands_uk`](https://gitlab.enterprise.slack.com/archives/C08RF4SJMU1) | Birmingham, Nottingham, Worcester, Stoke, Dudley. Anywhere _in the middle_ of England. |
