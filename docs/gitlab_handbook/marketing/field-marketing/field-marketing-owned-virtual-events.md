---
title: "Regional Marketing Owned Virtual Events"
description: "Step-by-step instructions for Regional Marketers on how to set up various owned virtual events."
---
...
1. Before the Lunch and Learn session, the participants receive an e-voucher (example value $25), uber eat gift card, Just Eat or similar depending on availability in their area. The FMC will coordinate the advanced purchase of these vouchers.

## Webcasts and Workshops Hosted on the Regional Marketing Zoom License
...
For more details about Zoom closed captioning, please reference [this Zoom article](https://support.zoom.com/hc/en/article?id=zm_kb&sysparm_article=KB0062490) or submit any questions the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
...
- `{{my.utm}}` - UTM to track traffic to the proper campaign in reporting dashboards (append integrated campaign utm or program name, if webcast is not part of an integrated campaign, to the utm campaign token)
  - If this is a joint campaign with a partner, make sure the partner includes `utm_partnerid=`.
...
- The FMC will update the epic details and sub-issue due dates (and issue titles), as well as make the necessary changes to any upcoming asset send dates.
- If there are any emails scheduled to send, the FMC will ping MOps specially in those issues to have them unschedule the sends and update email send dates.
...
- Marketo: Add `[CANCELED]` to the program name. Deactivate any [activated smart campaigns](/handbook/marketing/marketing-operations/campaigns-and-programs/#step-4-activate-marketo-smart-campaigns).
  ...
  - If there are program members (registrations), follow the instructions to [close the landing page](/handbook/marketing/field-marketing/#closing-a-marketo-lp). Next, click on the program and view the Summary. Click where it says "Event Partner" and change it to `None`. This will disconnect it from the sync with Zoom.
...
- If sales-nominated emails were set up, please ping MOps to turn off the sales-nominated email sends.
...
## How to Execute a Virtual Workshop

### Past Workshops

A current list of past workshops can be found [**here**](https://drive.google.com/drive/folders/1L_kd6QudSWcvAKDM-h6oPvvC6LiNj_ER).
...
1. FMM to work with their FMC through the [Plan to WIP process[(/handbook/marketing/field-marketing/#moving-from-plan-to-wip)].
...
- Please follow detailed instructions in the Workshop/Webcast section of the Asana project.

#### Virtual Workshop Recordings gdrive

- Per the instructions in the Asana project, the FMC will upload the workshop recording to the [Virtual Workshop Recordings gdrive](https://drive.google.com/drive/u/0/folders/1JRy7d-_9iPhOd9KaDyHFVVIjY9twYR3U) for future internal team reference.
