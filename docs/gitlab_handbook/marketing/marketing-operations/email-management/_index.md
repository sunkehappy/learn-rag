...
Each form will have the appropriate opt-in language specified. However, to check you may [visit here](https://docs.google.com/document/d/1UEfWo26DP7nRPrWRWo7O7oSrNp_rRuVqyN_vC7SwXME/edit?usp=sharing).
...
We also have additional filters that should be used on emails. These are built into the list templates, but please confirm the correct exclusions are on operational emails. Details can be found in the [internal handbook](https://internal.gitlab.com/handbook/marketing/marketing-ops-and-analytics/marketing-operations/marketo/).
