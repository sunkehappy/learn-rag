...
Due to the limited number of full-user seats we have available to us, we will be "pausing" users that have not logged in in over a month. To re-activate, you simply need to login. After you are paused for another month, you will be downgraded to "read only" and will need to request access via Lumos to re-gain your license.
...
Details about integration can be found in the [internal handbook](https://internal.gitlab.com/handbook/marketing/marketing-ops-and-analytics/marketing-operations/gitlab-asana-integration/).
