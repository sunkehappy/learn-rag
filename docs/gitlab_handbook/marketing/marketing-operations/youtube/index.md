...
1. Please remember to [follow the guidelines on starting a recorded video](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-recording).
...
1. To improve accessibility, [enable live transcription](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-additional-config/#enable-captions-and-live-transcription).
...
1. Follow the instructions for [starting a recorded video](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-recording).
...
1. Please read through the [Don't share secrets](#dont-share-secrets) section before uploading any video to GitLab Unfiltered, to avoid token leak incidents.
...
1. Please follow the process for [starting the recorded video](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-recording).
