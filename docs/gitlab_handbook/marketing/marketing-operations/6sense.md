...
### 6sense Provisioning to BDR

We only provision 6sense access to BDRs. If AE or SDR request access, please deny and reply with:
>I denied your request for a 6sense license, as we aren't provisioning access to AE, however you can still access 6sense via Salesforce through the account iFrame and 6sense Dashboard in the App Launcher.

When BDRs request for access, we apply, then reply with:

> You need to log into Okta and select the 6sense tile to activate your 6sense user seat which can take up to 24 hours.
>
> Once you've obtain access to 6sense to get start, following the instructions below.
>
> 1. Go to Salesforce
> 2. In the app launcher, search for 6sense Dashboards
> 3. Select 6sense Dashboards - this will take you to the personal dashboard to review 6sense Qualified Accounts (6QA) with high intent
> 4. Add the necessary filters to customize the dashboard by inputting region, employee range, and segments.
>
> Visit our dedicated [Highspot](https://gitlab.highspot.com/items/664b5bdfd0db5a6c4a965b21) page to find comprehensive resources, including:
>
> 1. Quick-reference one-pagers
> 2. Video tutorials showing how to identify high-intent purchasing accounts3. Best practices for leveraging intent data in your sales approach

Once the BDR activates their 6sense in Okta, they will be added to 6sense with ABM "View Only", you'll need to remove ABM access, and provide SI "SI Lite" Access.
