...
* GTM = `x` (never changes)
* Partner Name - `utm_partnerid` is a dropdown to show all Partner names. Select the partner you are working with, and the utm_partnerid will automatically be populated in the final destination URL.

Note that we leverage the [Salesforce Connector](https://docs.google.com/spreadsheets/d/12jm8q13e3-JNDbJ5-DBJbSAGprLamrilWIBka875gDI/edit?gid=545684823#gid=545684823) to push all the Partner Names along with it's Partner IDs into the UTM generator. This is how we can ensure all Partner information is updated with real-time data from Salesforce.
...
* UTM Medium = `banner`
* UTM Source = `6sense`
* [See utm_campaign](/handbook/marketing/utm-strategy/#the-new-utm_campaign-structure) for accepted options.
