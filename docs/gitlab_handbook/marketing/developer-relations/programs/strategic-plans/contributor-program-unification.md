...
| Code Contributors<br>Hackathon, MVP, 1st MR Merged code contributors | Support & grow the number of code contributors as described in our company strategy in order for our dual-flywheel to go faster. | Swag | <https://handbook.gitlab.com/handbook/marketing/developer-relations/engineering/> |
| ~~Leading Organizations~~ | *Discontinued.* Formerly recognized and incentivized organizations among our most active contributors. Replaced by the [Co-Create program](/handbook/marketing/developer-relations/programs/cocreate). | | |
