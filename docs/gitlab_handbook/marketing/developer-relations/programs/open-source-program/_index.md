---
title: "GitLab for Open Source Program"
...
GitLab's open source program is part of the [Developer Relations team](/handbook/marketing/developer-relations/). It consists of:
...
* DRI: [@ihuerga](https://gitlab.com/ihuerga)
...
See the [Developer Relations Programs operational guidelines](/handbook/marketing/developer-relations/programs/operational-guidelines/) for more detail.
...
The GitLab for Open Source team processes applications according to the [Developer Relations Programs application workflow](/handbook/marketing/developer-relations/programs/program-resources/#automated-application-workflow).
For additional information on program-specific workflows, see the [Open Source Program Workflows](/handbook/marketing/developer-relations/programs/open-source-program/oss-program-workflows/) page.
...
If a different person wishes to initiate the renewal, the existing owner needs to [transfer ownership of the Customers Portal account](https://docs.gitlab.com/subscriptions/billing_account/#transfer-subscription-ownership).
...
* Post questions in the [GitLab for Open Source](https://forum.gitlab.com/c/community/gitlab-for-open-source/) category of the [GitLab Forum](https://forum.gitlab.com),
  or ask in [Discord](https://discord.gg/gitlab) where community members and GitLab team members can review and discuss them.
...
Members of the [Developer Relations Programs team](/handbook/marketing/developer-relations/programs/) use GitLab Service Desk to manage program members' support requests.
...
* An automated first-response is sent, with instructions on how to proceed and self-service resource for common scenarios.
...
The GitLab for Open Source Program team monitors the health and vitality of the program by tracking overall program membership and members' annual renewal rates. We do this via the following Tableau dashboard:

* [Community Dashboard](https://10az.online.tableau.com/#/site/gitlab/views/CommunityDashboard/CommunityDashboard)

The dashboard reports the `Number of Licenses` the program is currently administering, the number of `Enrolled Institutions` associated with the program, and the `Number of Seats`.

GitLab team members with SAFE access to Tableau can view these reports for additional details.
