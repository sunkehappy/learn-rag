...
**This program is currently on hold. The objective of growing number of contributions is one of the main unchanged objectives, but the capacity to change any of the strategic decisions, to better understand who & why people contribute are awaiting further capacity allocations with the Developer Relations Programs team.**
...
The [Developer Relations Engineering team](/handbook/marketing/developer-relations/engineering/) implements targeted outreach strategies to existing GitLab users, customers, learners, and partners to funnel top contributors into the program on the [Contributors platform](https://contributors.gitlab.com/).
...
* Training customer contributors through Co-Create
  ...
  * [Co-Create handbook overview](/handbook/marketing/developer-relations/programs/cocreate/)
