...
- Only the infrastructure team should be posting updates on [@GitLabStatus](https://twitter.com/GitLabStatus). There is a [defined process](/handbook/engineering/infrastructure-platforms/incident-management/) for this describing who should do this, how and what channels should be alerted.
...
Community Operations uses Zendesk to pull in all mentions of GitLab on Twitter. When resolving Twitter tickets in Zendesk you should:
