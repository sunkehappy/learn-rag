...
- Use [GitLab Duo Agent Platform](https://docs.gitlab.com/user/duo_agent_platform/), [Claude](/handbook/tools-and-tips/ai/claude/) or [Glean](/handbook/eta/ai/tools/glean/) to research questions.
  - Always [review AI-generated output](/handbook/communication/#communicating-when-using-generative-ai-tools) for accuracy and [SAFE requirements](/handbook/legal/safe-framework/) before posting publicly.
...
The forum keeps all topics open, allowing users to join a conversation at a later point. The [accepted solution action](#marking-accepted-solutions) helps signal questions that are resolved.

When new questions in existing topics could benefit from a new topic with more details in a [pre-filled template](#category-topic-templates), encourage users to do so using the [`/new-topic` URL endpoint](https://meta.discourse.org/t/creating-a-link-to-start-a-new-topic-with-pre-filled-information/28074). Example: `GitLab CI/CD` category prefilled: https://forum.gitlab.com/new-topic?category=gitlab-ci-cd
...
- [Themes](https://forum.gitlab.com/admin/config/customize/themes)
  - Default theme: [Top Navbar](https://forum.gitlab.com/admin/customize/themes/2), menu navigation
  - [Theme Components](https://forum.gitlab.com/admin/config/customize/components): OneTrust banner, Mermaid charts
- [Colors](https://forum.gitlab.com/admin/config/colors)
  - Default color: [gitlab](https://forum.gitlab.com/admin/customize/colors/1)
- [User Fields](https://forum.gitlab.com/admin/config/user-fields)
  - Asked during user registration: `GitLab Username`
...
[Discourse Mermaid](https://meta.discourse.org/t/discourse-mermaid/218242?tl=en) is added as a [remote theme component](https://forum.gitlab.com/admin/customize/themes/10) with custom settings. This allows users to write code blocks with Mermaid chart rendering support, providing the same UX as with GitLab flavored Markdown. Examples are added to the [formatting FAQ topic](https://forum.gitlab.com/t/community-first-steps-code-config-log-block-formatting-in-topics-and-replies/72138#p-116262-mermaid-charts-10).

#### API

Used by integrations, such as the [GitLab Blog Bot](/handbook/marketing/developer-relations/workflows-tools/workato/#gitlab-blog-forum-bot).
