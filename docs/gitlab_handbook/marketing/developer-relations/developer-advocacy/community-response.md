...
* **Hacker News**:
  ...
  * Posts that reach the front page and contain the keyword "GitLab" are shared in the [#developer-advocacy](https://gitlab.slack.com/archives/CMELFQS4B) Slack channel with additional tags for @dev-advocates and @sytses
