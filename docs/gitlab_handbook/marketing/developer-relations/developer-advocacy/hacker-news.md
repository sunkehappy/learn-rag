...
GitLab mentions on Hacker News are tracked on the [#hn-mentions](https://gitlab.slack.com/messages/hn-mentions) Slack channel. Posts about GitLab that land on the front page of Hacker News generate a notification that is shared in [#developer-advocacy](https://gitlab.slack.com/messages/developer-advocacy). More details in the [automation documentation](/handbook/marketing/developer-relations/developer-advocacy/hacker-news/#automation).
...
1. If a notification that a release post has reached the Hacker News Front Page is posted to the #developer-advocacy Slack channel by the "Hacker News Front Page" bot, a Developer Advocacy team member should quickly repost the message to the #product and #release-post channels to alert our Product Managers.
...
More information on [Release Posts](https://docs.gitlab.com/development/documentation/release_notes/) is available in the docs.

## Responding on Hacker News

When new posts or comments about GitLab are added to Hacker News, team members can find alerts about these posts in the [#hn-mentions](https://gitlab.slack.com/messages/hn-mentions) Slack channel. You are welcome to share these with other team members and members of the wider GitLab community who may want to engage in the discussion. Please join the [#developer-advocacy](https://gitlab.slack.com/messages/developer-advocacy) Slack channel for questions, response coordination for front page posts, guidance on responding, etc.
...
1. Posts that reach the front page should be shared in Slack channels relative to the topic of the post for greater visibility among team members who may wish to respond. For example, a remote work blog should be shared in the [#remote](https://gitlab.slack.com/messages/remote) channel and a post related to trackers on our marketing site should be shared in [#marketing](https://gitlab.slack.com/messages/marketing). Whenever posts are shared outside of [#developer-advocacy](https://gitlab.slack.com/messages/developer-advocacy), the Slack comment should be cross-linked in the alert thread in `#developer-advocacy` for visibility and to create a single source of truth.
...
- Front page notifications are posted into the [#developer-advocacy](https://gitlab.slack.com/messages/developer-advocacy) Slack channel.
