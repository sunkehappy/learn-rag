...
Call-for-Papers (CFPs) workflows are organized in the [CFP handbook](/handbook/marketing/developer-relations/developer-advocacy/cfps/).
...
| `DA-Type::Experiment` | Issues for experimental and R&D work, including prototypes, proof-of-concepts, demos, and exploratory initiatives |
...
These labels are used to track workflow of the [CFP submissions](/handbook/marketing/developer-relations/developer-advocacy/cfps/).
