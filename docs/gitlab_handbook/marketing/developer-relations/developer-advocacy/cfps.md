...
All issues with the `CFP` label appear on the dedicated [CFP Issue board](https://gitlab.com/groups/gitlab-com/-/boards/9701731?label_name%5B%5D=developer-advocacy&label_name%5B%5D=CFP) which provides an overview of open, submitted and accepted CFPs.
