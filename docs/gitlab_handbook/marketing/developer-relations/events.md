...
and [community office hours](/handbook/marketing/developer-relations/engineering/community-contributors-workflows/#community-office-hours).
We also support in-person contributor days and [community-organized meetups](https://www.meetup.com/gitlab-virtual-meetups/). Many of these activities
...
### Why Developer Relations needs event reports

Event reports are essential for the Developer Relations team's strategic success:

- **Data-Driven Decisions**: Measure ROI and performance to optimize future event investments and justify budget allocation
- **Product Intelligence**: Capture developer and customer feedback, pain points, and feature requests that directly inform product roadmap decisions
- **Cross-Team Value**: Provide qualified leads to sales, market insights to marketing, and community intelligence to leadership
- **Continuous Improvement**: Document what works, preserve institutional knowledge, and replicate successful strategies across events

### How to create event reports

Event reports are created using Google Slides and should be completed **within 2 weeks of event completion**. They are organized in the Developer Relations team shared Google Drive in `events > devrel-event-reports`. This folder is shared with all team members.

#### Creating the Report

1. **Locate the template** for event reports in the top-level folder: `TEMPLATE: DevRel & Strategy event report: [EVENTNAME YEAR]`
2. **Make a copy** of the template slide deck and rename it following the convention: `DevRel & Strategy Event Report: [EVENT NAME YEAR]`
3. **Complete the report sections** with comprehensive event data:
   - **Event results**: Attendance numbers, engagement metrics, booth traffic, demo requests
   - **Customer learnings**: Key insights from developer conversations and feedback
   - **Product feedback**: Feature requests, pain points, and improvement suggestions
   - **Field insights**: Market trends, competitive intelligence, and community sentiment
   - **Lead quality**: Qualified prospects and follow-up opportunities

   *Note: The template provides optional sections since audiences and focus vary by event. You can modify the structure freely, but ensure the event overview and executive summary remain on the first slides.*

#### Distribution & Follow-up

1. **Link to event tracking**: Add the completed report to the corresponding event epic or issue in the main [event strategy epics for each fiscal year](https://gitlab.com/groups/gitlab-com/marketing/developer-relations/-/epics?label_name%5B%5D=DevRel-Events).
   - **No existing issue?** Create one retrospectively using the [Developer Advocacy workflow](/handbook/marketing/developer-relations/developer-advocacy/workflow/#issue-types):
     - Use [event template](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/new?description_template=events) for general events
     - Use [CFP template](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/new?description_template=cfp-meta) for speaking engagements and call-for-papers submissions

2. **Optional: Create a read-out recording** of the event report and upload the recording to the same GDrive folder for stakeholders who prefer audio/visual summaries.

3. **Share results in Slack**: Post an update in `#developer-relations` or `#whats-happening-at-gitlab` with:
   - Key metrics (attendance, leads generated, demos given)
   - Top 2-3 insights or learnings
   - Link to the full report

4. **Add to weekly updates**: Include the event report in the DevRel & Strategy end-of-week updates document for leadership visibility.

#### Need Help?

For questions, template access issues, or contributions to this process, contact @dnsmichi as DRI.
...
The Developer Advocate team is responsible for providing demo booth assets
for the booth staff to leverage when showcasing GitLab features to customers. The assets consist of:

- Interactive Walkthroughs
- GitLab.com Demo Projects

**Note**: If you feel more comfortable with leveraging your own demos/deck over the ones we provide,
that is completely okay. We provide and maintain these assets for your consumption.

#### Interactive Walkthroughs

Interactive walkthroughs, also known as product tours, are designed to showcase key features and workflows. Access the demos in the [Developer Advocacy content library](/handbook/marketing/developer-relations/developer-advocacy/content/#centralized-demo-hub).

If you're attending an event as a booth staffer, please make sure you're familiar with the product tours. Questions may arise about different areas of the product, and these demos provide a quick and effective way to showcase specific features.

Visitors often request to share demos they saw at the booth with their team. To facilitate this, they can scan the QR code available in the demo hub to easily access the link and share it later.

**Tip:** Use `Ctrl + P` to toggle dialogs for a smoother demonstration flow. Navigate using arrow keys (→/←) instead of relying on interactive popups.
...
**Prerequisite:** Before attending an event as booth staff, please ensure you're familiar with the [Demo hub](/handbook/marketing/developer-relations/developer-advocacy/content/#centralized-demo-hub). This knowledge enables you to quickly demonstrate and talk about different GitLab workflows in response to visitor questions.

### How to deliver a demo using GitLab.com project

Sometimes, an event attendee wishes to see GitLab in action and flow beyond the guided flows in the walkthrough demos. The following steps provide insight into how live demos can be delivered successfully and how they can highlight the value GitLab could provide their organization.
