...
description: Process for DevRel Engineering to select GitLab Notable Contributors
---
...
1. Select one or more [eligible Notable Contributors](/handbook/marketing/developer-relations/engineering/notable-contributor-process/#notable-contributor-eligibility) from the nomination issue.
   - Selections should be chosen based on contribution and community impact, nomination comments and emoji votes.
   - Selections should be completed at least 10 calendar days before the [release date](/handbook/engineering/releases/monthly-releases/#monthly-release-schedule).
...
- The write-up should be fairly brief. It appears at the top of the release post in a prominent position. Try to keep it to fewer than 150 words.
