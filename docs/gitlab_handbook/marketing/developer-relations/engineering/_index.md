---
title: "Developer Relations Engineering Team"
description: "Developer Relations Engineering Team"
---
...
| **Slack Channel** | [`#developer-relations-engineering`](https://gitlab.slack.com/archives/C09NBNCJFQV) |
| **Team Boards** | N/A |
...
|  | |
|-----|-----|
| **Workflows** | [Developer Relations Engineering Contributor Workflows](/handbook/marketing/developer-relations/engineering/community-contributors-workflows) |
| **Metrics** | [Contributor metrics & dashboards](/handbook/marketing/developer-relations/engineering/metrics) |
| **A Contributor's User Journey** | [User Journey](/handbook/marketing/developer-relations/engineering/user-journey) |
| **Community pairing sessions** | [Community pairing sessions](/handbook/marketing/developer-relations/engineering/community-pairing-sessions) |
...
| **Showcase Your Contributions** | [Showcase Your Contributions](/handbook/marketing/developer-relations/engineering/showcase-your-contributions) |
| **Observability alert triage** | [How to investigate and close a contributor platform alert](/handbook/marketing/developer-relations/engineering/observability-alert-triage) |
...
cross-functional initiative that is led by the [Developer Relations Engineering team](/handbook/marketing/developer-relations/engineering/), in combination with Product & Engineer. More GitLab specific instructions can be found in our [cocreate handbook page](/handbook/marketing/developer-relations/programs/cocreate/).

## Team Responsibilities

- Improve GitLab's Contribution Efficiency and [merge request coaching](/job-description-library/expert/merge-request-coach/) process.
- Contribute as a [merge request coach](/job-description-library/expert/merge-request-coach/) in one or more specialties by providing guidance to community contributors on technical and non-technical aspects.
...
- Select and recognize a [GitLab Notable Contributor](/handbook/marketing/developer-relations/engineering/notable-contributor-process) for each release post
...
- [Triage community merge requests](/handbook/engineering/infrastructure-platforms/developer-experience/merge-request-triage/#partial-triage-gitlab-org) from the daily merge request coach report
...
- `workflow::complete`: Issues that are resolved after implementation. These should be highlighted in reports back to the team and Developer Relations department before being closed.
...
## Developer Relations Engineering Retrospective
...
Developer Relations Engineering DRI is responsible for creating an issue in the team tracker
...
Developer Relations Engineering DRI is responsible for digesting the feedback and selecting one, after votes, issue to take into the new quarter.

## Developer Relations Engineering stand-up

The purpose of this stand-up is to collaborate between team members of Developer Relations Engineering. This is a team-specific
...
## Developer Relations Engineering reading list
