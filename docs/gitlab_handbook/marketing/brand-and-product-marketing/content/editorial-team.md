...
- agents and flows
  - When talking about agents and flows generically, use lowercase.
    - Example: GitLab Duo Agent Platform agents and flows do xyz...
  - When talking about the proper names of agents and flows, use title case.
    - Example: The Fix Failed Pipelines Flow does xyz...
- Agile
...
- Confirm that people featured in the post are referencing using their [correct pronouns](/handbook/people-group/orientation-identity/#how-do-i-know-which-pronouns-to-use)? You can do a quick check on the individual's [team page profile](https://gitlab.com/close-modal) and Slack profile.
...
- If you have a DIB question about the blog post, don't just guess. Reach out to the DIB team or tag the leads of the appropriate [team member resource group (TMRG)](/handbook/company/culture/inclusion/tmrg-tmag/) in the blog issue or merge request.
