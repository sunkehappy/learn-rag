...
GitLab’s Customer Advocacy (CA) team elevates customer stories and voices at scale across case studies, videos, blogs, logo and name reference agreements, speaking engagements, press, analyst and investor relations, advisory programs and beyond.
...
At this time, CA supports customer speaker sourcing for Corporate Events based on a 60 day SLA.

#### Regional Marketing

Regional Marketing event speaker sourcing is supported by the Regional Marketers directly. However, CA needs visibility and proactive alignment for all ways we are activating customers in market in order to protect our customer’s experience and align our key customers to the most strategic opportunities.

- FMM partners with their sales counterpart to develop a specific event and identify when a customer speaker is needed
- FMM and sales create a copy of the [Customer Speaker Brief template](https://docs.google.com/document/d/1AcWpc0pVjeV29GxL_d9uVWdQyyHjgSp8r9Oe13TFL94/edit?tab=t.0) to identify the ideal customer profile for the event, based on goals and audience demographics, and also compile a list of speaker options.
- Ideal customer speaker profile parameters include:
  - Account segment
  - Account region
  - Account vertical
  - Account plan and add ons
  - Account use cases
  - Speaker title / level
  - Speaker expertise
- FMM creates the GitLab epic/issues through the [Plan to WIP process](/handbook/marketing/field-marketing/#process-for-moving-events-from-plan-to-wip) and completes the `Staffing_Support` issue, following the instructions for determining a customer speaker (which involves adding a CA label to the issue and tagging Nicole Smith)
- Nicole Smith will review (or assign someone) to ensure we do not have larger, strategic advocacy plans for that advocate, and/or haven’t over-activated that advocate. The CA POC can also provide feedback and help with suggestions, if needed.
- Once confirmed, the FMM will continue to source the speaker
