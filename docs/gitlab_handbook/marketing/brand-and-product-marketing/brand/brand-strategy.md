...
#### Vendor reference evaluation criteria

Before starting the approval process, please ensure that the vendor meets all the criteria outlined in [this issue template](https://gitlab.com/gitlab-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?description_template=vendor-reference-request).

If you have any questions about the evaluation criteria, reach out to us in the #brand Slack channel.
...
1. Before opening an issue, please ensure the vendor has met all the criteria listed in the issue template.
