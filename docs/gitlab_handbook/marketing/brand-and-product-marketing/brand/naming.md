...
To kick off the project, please open an issue using [this template](https://gitlab.com/gitlab-com/marketing/brand-product-marketing/brand-strategy/-/issues/new?description_template=naming).

- Fill out each section of the issue and the naming brief Google Doc thoroughly. This will become the single source of truth for the project.
- Gather input from all stakeholders prior to submitting the brief to ensure everyone is aligned and there are no gaps.
- Once the brief is complete, share it with the Brand & Creative team in the issue to kick off the naming process.
...
We’re here to help! Reach out to the Brand & Creative team in the #brand channel on Slack or in the issue associated with your project.
