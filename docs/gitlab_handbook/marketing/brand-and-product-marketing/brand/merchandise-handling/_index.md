...
**NOTE: If you're part of the CRO organization, please visit [this handbook page](/handbook/marketing/brand-and-product-marketing/brand/merchandise-handling/cro-swag) to find out how to order swag. Only follow the process below if you're on a team outside of the CRO org.**
...
If you’re buying something on behalf of GitLab, see the [“how to order swag” section](/handbook/marketing/brand-and-product-marketing/brand/merchandise-handling/#how-to-order-swag).
...
Purchasing or sending swag on behalf of GitLab? Follow the steps below.
...
1. The first step is to get internal approval for the order. Open an issue using our [swag order issue template](https://gitlab.com/gitlab-com/marketing/brand-product-marketing/brand-product-marketing/brand-strategy/-/work_items/new?description_template=swag-order). Follow all instructions in the issue template.
...
1. If you’re ordering or sending a physical item from the swag shop, you’ll receive a store credit from Brilliant. **You will use this credit to self-serve and complete your order from the swag shop.** Don’t forget to use our team member free shipping code (you can find it in the #swag Slack channel)!
...
Please contact your manager or Finance Business Partner. If you have already opened an issue for the order, it's best to tag them there.
...
|    Brand & Product Marketing, Sales Development, Developer Relations & Strategy    |    Luke Holcomb `@lukeholcomb`    |
...
|    Security    |    Megan Madan `@meganmadan`    |
|    G&A (CFO)    |   Megan Madan `@meganmadan`    |
|    G&A (ETA)    |   Megan Madan `@meganmadan`    |
...
| Anniversary swag | People Operations team: `@gl-people-ops-team` |
| New parent swag | Absence Management team: `@lyndemeiers` |
| CRO org swag program | CRO EBA team: `@kgillgb` |
