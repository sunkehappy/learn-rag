...
#### Sourcing creative assets

Follow the steps below, in order, to source creative assets for your self-service needs.

1. **Use existing Brand-approved content:** Browse [curated resources](https://design.gitlab.com/resources) for photography, illustrations, icons, graphics, and more. Content in Brand’s libraries can be used without prior approval from Brand.
1. **Search for content on Adobe Stock:** Review the [photography guidelines](https://design.gitlab.com/brand-design/photography) and then choose something suitable from [Adobe Stock](https://stock.adobe.com/). [Contact the Brand team](/handbook/marketing/brand-and-product-marketing/design/#stock-photography) to review and download your asset.
1. **Request a net new asset:** Submit an [issue request](/handbook/marketing/brand-and-product-marketing/design/#how-to-submit-a-request) for the Brand team to create custom visual content.
1. **Generate content using AI:** All AI-generated content must be reviewed and approved by Brand before use and adhere to our [Legal parameters](/handbook/legal/ip-public-materials-guidelines/#ai-generated-images). Ensure images follow the photography and brand guidelines. [Contact the Brand team](/handbook/marketing/brand-and-product-marketing/design/#stock-photography) to request approval.

Please note that any high-visibility, business-critical, or external-facing work must be routed through the Brand Creative team for development. These types of assets should not be self-served and must be created or directly supported by our internal designers; please submit a creative request using one of our [issue templates](/handbook/marketing/brand-and-product-marketing/design/#how-to-submit-a-request).

#### Stock photography

Our team has gathered approved, ready-to-use stock images in our [photo library](https://drive.google.com/drive/folders/1VHErs-KSNX1FIIVgXJR3OmIzwU7M4E1M?usp=sharing).

If you need images beyond what are in that library, the Brand Design team has a license to download unlimited images from [Adobe Stock](https://stock.adobe.com/) (Note: Standard media only; Premium and Editorial content is not included in our license).

Review our [photography guidelines](https://design.gitlab.com/brand-design/photography) before searching for new images. For approval, download, or questions, [contact our team](/handbook/marketing/brand-and-product-marketing/design/#contacting-the-team) in Slack or the relevant issue.

Generally speaking, images of real people, objects, and landscapes are easier for viewers to recognize and relate to. If using AI-generated images, please adhere to the [photography guidelines](https://design.gitlab.com/brand-design/photography/) and [Legal parameters](/handbook/legal/ip-public-materials-guidelines/#ai-generated-images).
...
Canva enables team members to self-service design needs and create on-brand assets quickly by leveraging branded design templates. Canva also supports internal brand approvals for team-member submitted designs directly in the platform. Canva is ideal for digital ads and promotional assets, rather than content-heavy or print collateral. For materials that need content frequently updated, alternate versions for A/B testing, or are quick-turn requests that use our core branding, please refer to the steps below and our template library in Canva.

For larger projects requiring print work, detailed concepting, or custom design beyond our core branding, please [submit a design request](/handbook/marketing/brand-and-product-marketing/design/#brand-design-and-video-issue-templates) instead. This is applicable for the following:

- `GitLab-hosted events:` Events that we host or sponsor that require greater quality
- `Multi-location events:` Events occurring in multiple cities that require visual consistency
- `Custom or event-specific branding:` Assets that use a specific look and feel beyond what is provided in the available Canva templates
...
- **Full-functionality:** working within our account gives you access to all of Canva's Pro features and our branded templates.
- **Visibility:** having all our assets organized in one account offers greater transparency and streamlines design iteration.
- **Workflow:** collaborating is made easy with quick access to our brand assets, templates, and Brand team approvals.
...
### Canva Brand review process

All self-service assets require brand review before use. If you are working from an existing Canva template, you will see the option to request [design approval](https://www.canva.com/help/get-approval/) at the top right of the file; this will automatically submit the design to our Brand team for review. If you do not see this option, please open a [Brand Review issue](/handbook/marketing/brand-and-product-marketing/design/#1-brand-review-requests) and link your Canva file.

See our [Service Level Agreement (SLA)](/handbook/marketing/brand-and-product-marketing/design/#service-level-agreement-sla-for-requests) for review turnaround times. For expedited requests, please reach out in the `#brand` channel on Slack with a link to the issue or file.
...
#### Using Terminal for the Brand Design Repository
...
### Maintaining the Brand Guidelines on design.gitlab.com (Pajamas)

The Brand Design team maintains the Brand Guidelines on [design.gitlab.com](https://design.gitlab.com/brand-introduction) ([Pajamas](https://design.gitlab.com/)). For our team's purposes, we can make updates to the guidelines using [Web IDE](https://docs.gitlab.com/ee/user/project/web_ide/), with the exception of amending commits.

To get started, follow the workflow outlined below and check out our [demo](https://youtu.be/d8vUeHCkbnk) with the Product team. To make changes locally or to amend commits, follow these [instructions for Terminal](https://docs.google.com/document/d/1u7iNFnbD4Nj4aeLRFpmnzHewgKBjCwdyjvTuOND0rfA/edit?tab=t.qjs7a6jmfyjx).
...
#### Pajamas content structure in Web IDE

Our Brand Guideline pages are located in the `Contents` folder. Make your changes in the corresponding `.md` text file. Here are our related contents:

1. `brand-design:` This folder contains pages related to our design foundations.
1. `brand-logo:` This folder contains pages related to our logo guidelines.
1. `brand-messaging:` This folder contains pages related to our messaging and brand identity.
1. `brand-introduction.md`, `resources.md`, and `style-guides.md`: These are additional top-level pages on the site related to our Brand Guidelines.
...
Choose the right file format and optimize it accordingly:
...
1. Upload all files to the `brand` folder (`static` > `img` > `brand`).
1. Videos can be embedded either from Vimeo or YouTube.

Add media using `figures`, which connect the visual with a caption. Here is the breakdown of the `figures` format:
...
1. Use the merge request description to add more detail that would be helpful for the reviewer, including the related issue or documentation for the change.
1. Assign the merge request to yourself.
1. Assign at least one other person from our team as the `Reviewer`. Ideally this is someone who has already been made aware of the changes needed.
1. Add the label that reflects the type of commit you made; for our purposes, it will almost always be the `type:feature:` label.
