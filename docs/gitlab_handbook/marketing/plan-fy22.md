...
All FY22 Marketing budgets are loaded into Allocadia. Please refer to the [Allocadia handbook page](/handbook/enterprise-data/marketing-analytics/allocadia/) for more details on the tool.
...
## GTM Motion Core Teams {#core-teams}
...
The Marketing Team OKRs should align to the initiatives in Project Compass.
