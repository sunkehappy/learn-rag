...
| Frontend Engineer | [Eliezer Toribio Camacho](https://gitlab.com/eliezert)|
...
[FY26Q3 Digital Experience Quarterly Plan & OKRs](https://gitlab.com/groups/gitlab-com/marketing/digital-experience/-/epics/478)
...
Engineers are expected to complete 12 or more weight points per iteration which is equivalent to 6 days of engineering. This expectation leaves room for merge request reviews and job requirements described in the  [Frontend Engineer](/job-description-library/marketing/frontend-engineer-marketing/) and [Fullstack Engineer](/job-description-library/marketing/fullstack-engineer-marketing/) job family descriptions. For senior engineers, the expectation is 15+ points.
...
Similar to [the engineering department](/handbook/engineering/infrastructure-platforms/change-management/#production-change-lock-pcl), we sometimes temporarily halt production changes to [About.gitlab.com](https://gitlab.com/gitlab-com/marketing/digital-experience/about-gitlab-com) repository when team availability is reduced, or we expect atypical user behavior (such as during high-visibility public events).
...
2. Create an issue using [this template](https://gitlab.com/gitlab-com/marketing/digital-experience/about-gitlab-com/-/issues/new?type=ISSUE)
