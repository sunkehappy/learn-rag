...
[Open an issue to the marketing site repository](https://gitlab.com/gitlab-com/marketing/digital-experience/about-gitlab-com/-/issues/new?type=ISSUE) and add the `dex-category::accessibility` label.
