...
- From this version onward, we **will no longer support the nav project in the www-repo anymore.** This means that www-gitlab-com **must stay pinned to major version 4**. You will need to move your page over to [about.gitlab.com by opening an issue](https://gitlab.com/gitlab-com/marketing/digital-experience/about-gitlab-com/-/issues/new?type=ISSUE) if having the most up-to-date navigation is a concern for your content.
