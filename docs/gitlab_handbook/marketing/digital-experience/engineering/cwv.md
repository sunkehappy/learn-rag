...
1. **Contact Point:**
    ...
    * If you implement changes that could influence CWV metrics, contact [Hanif](https://gitlab.com/hsmith-watson) within the merge request (MR).
    * Clearly describe the nature of the change and why it might affect CWV.

2. **Before and After Testing:**

    * [Hanif](https://gitlab.com/hsmith-watson) will create a set of before and after tests to evaluate the impact of the changes on CWV.
