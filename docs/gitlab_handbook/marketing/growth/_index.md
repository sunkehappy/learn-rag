...
The Growth::Acquisition team focuses on increasing Valuable Signups across GitLab.com and Self-Managed instances. Internally, a valuable signup is a performance indicator representing teams more likely to convert to paid plans. Based on historical analysis of GitLab.com signups, teams with at least one member using a business email domain account for the vast majority of paid conversions. This metric helps us focus acquisition strategies on the users and teams with the greatest potential revenue impact.

**Team Scope:** The team owns all experiences leading to new valuable signup creation on both GitLab.com and Self-Managed instances.

**What We Do:**

* Optimize GitLab.com registration and trial signup experiences
* Develop Self-Managed signup and lead capture capabilities
* Remove technical and user experience friction from registration flows
* Build architecture to enable faster future optimization velocity

**Key Focus Areas:**

* **GitLab.com Registration Optimization** - Streamlining signup flows across trial and free user journeys
* **Self-Managed Acquisition** - Introducing in-instance trial registration and other new acquisition channels
* **Technical Foundation** - Improving registration architecture to support experimentation and optimization velocity
* **User Research & Analytics** - Understanding user behavior patterns and conversion drivers

**Current Initiatives:**
The team is implementing unified lightweight registration flows, Self-Managed in-instance trial capabilities, and enhanced lead capture at download touchpoints. These initiatives build on proven frameworks that have delivered significant completion rate improvements.
...
The team maintains comprehensive user research, analytics dashboards, and experimentation frameworks to drive data-informed decisions about registration experience improvements and user acquisition strategies.
