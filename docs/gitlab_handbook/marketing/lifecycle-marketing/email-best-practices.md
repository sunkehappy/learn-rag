...
This handbook provides comprehensive email marketing best practices for GitLab team members. It covers everything from strategy and content creation to technical requirements and performance measurement. Use this as your primary reference for creating effective email campaigns that drive engagement and conversions.
...
### Quick refernece checklist
<!-- DO NOT CHANGE THIS ANCHOR -->

Before sending any email campaign, ensure you've:

* ❏ Defined your target segment and personalization strategy
* ❏ Crafted a compelling subject line (under 65 characters)
* ❏ Optimized preview text (up to 90 characters)
* ❏ Limited CTAs to 1-2 per email
* ❏ Litmus tested for mobile devices and accessibility
* ❏ Set up UTM tracking parameters
* ❏ Scheduled based on recipient timezones

### Legal Compliance
<!-- DO NOT CHANGE THIS ANCHOR -->

All emails must comply with global regulations:

* CAN-SPAM: Include physical address, clear unsubscribe option, accurate sender information
* GDPR: Ensure proper consent, provide data access/deletion options
* CASL: Maintain consent records, include company information
...
* Keep under 65 characters to prevent truncation
* Front-load key information (above the fold)
...
* Include a clear benefit or action
...
* Buttons should be no longer than 25 characters - 14 characters as a standard. Pre-approved buttons can be found in copy docs
...
The difference between success and failure often comes down to whether your content delivers genuine value to the recipient.
...
For a software and web application company like GitLab, the average open rate percentage may vary, but a good benchmark is between 20% and 30%. If our open rate is low, consider testing different subject lines or preheaders to see what style works best with our customers.

How to calculate open rate: Number of emails opened / number of emails delivered

Example: 200/1000 = 20% Open Rate

**Important context about open rates:** Open rates are increasingly unreliable due to privacy protection features from major email providers. Many providers now pre-download images or use proxy servers, which can trigger false "opens" and inflate your metrics by 20-40% or more.
