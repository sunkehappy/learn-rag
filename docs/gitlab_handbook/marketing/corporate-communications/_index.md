...
**Invited to Speak**
If you are asked to speak on behalf of GitLab at an event, on a webinar or at a Meetup, please contact the Corporate Communications and Developer Relations teams to ensure that the opportunity aligns with GitLab objectives and key narratives. *Inquiries should be initiated in the `#external-comms` Slack channel before you accept the speaking invitation.* Please allow 10 business days for evaluation. Opening an issue under Corporate Marketing to further collaborate on the opportunity may be requested.

**Submitting to Speak**
If you are planning to submit an event CFP or request to participate as a speaker for a webinar or Meetup, please ensure the opportunity aligns with GitLab objectives and key narratives. If you are unsure, please reach out to the Corporate Communications and Developer Relations teams. If accepted to speak, please notify the Corporate Communications and Developer Relations teams via the `#cfp` Slack channel w/link to the accompanying issue and ensure the teams have 10 business days to review your final presentations.

* **For security-related topics:** In addition to notifying the #cfp channel, please also notify the corporate communications team via the #external-comms channel with a brief abstract about your idea and what you plan to disclose before the development of your submission (include a working title, 2-3 sentences highlighting what will be discussed, and link to any vulnerabilities or technical issues you want to share). Please also confirm you have manager approval when engaging the communications team.
...
* GitLab account representatives: Any requests for public relations support requires approval from your executive sponsor. Please reach out via `#external-comms` in Slack if you have questions about this.
