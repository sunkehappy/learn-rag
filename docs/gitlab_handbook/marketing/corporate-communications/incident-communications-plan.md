...
- A communication escalation coordination channel with all DRIs and stakeholders. The traffic here will be low to medium volume and focused on coordination, mitigation and strategy. Invite one person designated as the representative from the core team listed above, as well as, a representative of each specific area of business that is central to the incident. [DACI](/handbook/people-group/directly-responsible-individuals/#dri-accountable-consulted-informed-daci) will inform our value of Collaboration.
...
Our values guide our actions: [our sense of urgency](/handbook/values/#sense-of-urgency) under Results and our value of not [waiting](/handbook/values/#dont-wait) under Iteration and [DACI](/handbook/people-group/directly-responsible-individuals/#dri-accountable-consulted-informed-daci) will under our value of Collaboration.
