...
- Important things to consider when applying:
   ...
   1. While you may apply to a role with a higher job level and title, there may be situations (moving from one job family to another for example) where the higher job level may not align with your current competencies and skillset that is required for the role. If the hiring team does choose to move forward with an offer, in these cases, it's likely a higher job level and title will not be given.
...
- Recruiter will post a job internally following the [req creation process](/handbook/hiring/), and the [transfer, promotion guidelines](/handbook/people-group/promotions-transfers/).
...
- Recruiter will then continue the process as described in the [Talent Acquisition Process Framework](/handbook/hiring/) for all candidates. Recruiter will use identified templates in Greenhouse to communicate with candidates, current managers and hiring managers throughout the internal hiring process.
- Once it is confirmed that the internal candidate is moving to the offer stage, the Recruiter will connect the team member's current manager and potential new manager via Slack to:
  ...
  - Some suggestions for transition timelines include:
    ...
    - A one month 50/50 split between teams to ease into a full time transition.
    - For any moves from Sales Development and SMB, please be aware the team requests a 45 day transition period from the date of a verbal offer.
- Please note the following about this process:
  - TA will only start an official backfill once the role has been approved via the [Backfill Approval process](/handbook/hiring/)
  - It is the [Team Member's responsibility](/handbook/hiring/) to meet with their current manager to discuss the internal opportunity they’d like to pursue prior to submitting their application. Offers at the end of an internal interview process should not come as a surprise to current managers.
...
- Once the transition date is agreed upon, the current manager is responsible for notifying their leadership and to follow the steps outlined in the [Backfill Approval process](/handbook/hiring/) handbook page
...
- Hiring Managers will be notified by Recruiter when an internal team member has applied and has completed the necessary eligibility checks as mentioned above, and they will follow the process outlined in the [Talent Acquisition Process Framework](/handbook/hiring/) for all candidates.
