...
- The Manager, Data provides leadership to the sub-teams as described in the [Senior Manager, Data Job Family](/job-description-library/marketing/enterprise-data/manager-data/#senior-manager-data)

- Lead Analytics Engineer (Stable Counterpart for the Business)
  
  - The Lead Analytics Engineer fulfills the below responsibilities from the [Senior Analytics Engineer](/job-description-library/marketing/enterprise-data/analytics-engineer/#senior-analytics-engineer-responsibilities) Job Responsibilities:
