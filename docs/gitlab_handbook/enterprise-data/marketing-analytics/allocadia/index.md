...
You can **ONLY** create a GitLab issue from within a **SUB-CATEGORY**. Please double check you have created a subcategory, and a line item as listed in the [instructions here.](/handbook/enterprise-data/marketing-analytics/allocadia/#how-to-create-a-fmm-issue-from-within-allocadia)
