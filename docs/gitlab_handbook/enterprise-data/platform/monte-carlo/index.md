...
| MonteCarlo status   | Context                                                                                                                                       | Actions done or to -do                                                                 | Impacts Uptime Calculation |
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|----------------------------|
| Fixed               | Incident is not active anymore.                                                                                                               | Actively worked on resolving the incident or the incident is normalized automatically. | Yes                        |
| Expected            | Incident was flagged by MonteCarlo **correctly**. We knew that this was coming, like a batch update or a schema change that was in the works. | None                                                                                   | Yes                        |
| Investigating       | Actively working on the incident                                                                                                              | Root cause investigation and resolve if needed                                         | Yes                        |
| No action needed    | Incident was flagged by MonteCarlo **correctly**, but its not a breaking change                                                               | None                                                                                   | No                         |
| False positive      | Incident was flagged by MonteCarlo **wrongly**                                                                                                | None                                                                                   | No                         |
| No Status           | Default status by MonteCarlo                                                                                                                  | Start investigating and update status                                                  | Yes                        |
| Acknowledged        | Incident was flagged by MonteCarlo correctly, it is impacting the data but no actions are needed as it will normalize or did normalize.       | None                                                                                   | Yes                        |
...
|           | TIER2                                                | -                    | #data-pipelines      | #analytics-pipelines (once per day) | #data-pipelines      |
|           | TIER3                                                | -                    | #data-pipelines      | #analytics-pipelines (once per day) | #data-pipelines      |
| PREP      | n/a                                                  | -                    | -                    | -                                   | -                    |
