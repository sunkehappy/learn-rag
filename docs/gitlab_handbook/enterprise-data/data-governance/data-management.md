...
* `IMPORTANT`: [Customer Private RED data](/handbook/security/policies_and_standards/data-classification-standard/#red) is prohibited from permanent storage in the Enterprise Data Platform.
