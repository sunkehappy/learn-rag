...
Data quality incidents are a subset of the broader [Data Team Incident Management](/handbook/enterprise-data/data-governance/incident-management/) process.

When data quality issues meet the [incident criteria](/handbook/enterprise-data/data-governance/incident-management#3-incident-creation), they should be escalated to incident status following the established incident management procedures.

#### Resulting in Permanently Lost Data

| Line | Issue | Impacted Data Source | Impact                                                                                                                            | Impact Window                                                                             |
|------| --- | --- |-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| 1.   | [Snowplow endpoint certificate expired for a day](https://gitlab.com/gitlab-org/gitlab/-/issues/416991) | Snowplow | No Snowplow events recorded for most of one day                                                                                   | `2023-07-04`                                                                              |
| 2.   | [Redis/RedisHLL events don't get triggered](https://gitlab.com/gitlab-org/gitlab/-/issues/442875) | Automated GitLab.com Service Ping | GitLab.com customers will underreport values for Redis metrics at the instance level                                              | `2024-02-15` to `2024-03-05` for 7d metrics; `2024-02-15` to `2024-03-26` for 28d metrics |
| 3.   | [Missing Service Pings for version <= 12.0](https://gitlab.com/gitlab-org/gitlab/-/issues/443639#note_1887042557) | SM Service Ping | All installations on v12.0 or earlier were not sending Service Pings                                                              | `2024-02-12` to `2024-04-28`                                                              |
...
| 2.   | [Customer questions (red data) leaking into product analytics data](https://gitlab.com/gitlab-org/gitlab/-/issues/503275) | Snowplow | Exposed red data for the `category` and `detailed_category` value in Snowflake.                                                   | `2023-10-23` - `2024-12-02`                                                               |
| 3.   | [Snowflake: Pseudonymize page_url_path in Snowflake and s3 bucket](https://gitlab.com/gitlab-data/analytics/-/issues/22197) | Snowplow | Exposed data for the `page_url_path` column in Snowflake.                                                                         | `2022-10-01` - `2025-01-01`                                                               |
| 4.   | [s3: Pseudonymize page_url_path in Snowflake and s3 bucket](https://gitlab.com/gitlab-data/analytics/-/issues/22351) | Snowplow | Exposed data for the `page_url_path` column in the `s3` bucket.                                                                   | `2022-10-01` - `2025-01-01`                                                               |
| 5.   | [AI Gateway SSOT data source missing namespaces in events related to 'request_duo_chat_response'](https://gitlab.com/gitlab-org/gitlab/-/issues/507389) | Snowplow | Wrong namespace assigned for `request_duo_chat_response`                                                                          | `2024-08-28` - `2024-12-04`                                                               |
| 6.   | [Submitting Service Ping causes validation error in Version app for v17.6 SM instances](https://gitlab.com/gitlab-org/gitlab/-/issues/508580) | Snowplow | Lower than usual amount of successful Service Ping and large number of submission fails                                           | `2024-10-04` - `2024-12-16`                                                               |
