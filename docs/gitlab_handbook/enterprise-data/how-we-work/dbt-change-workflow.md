...
Before requesting a review, Analytics Engineers should consider the following:
...
- [ ] Has [Atlan domain metadata](https://developer.atlan.com/snippets/common-examples/domain-assignment/#add-an-asset-to-a-domain) been added to EDM models in `schema.yml` files? (Must use one of: Marketing, Product, Sales, People, Finance)
...
- [ ] Complete user acceptance testing (if applicable)
...
- [ ] Checked for proper documentation
  - [ ] Checked that Atlan domain metadata has been added to EDM models
...
- [ ] Reviewed for security and compliance considerations
