...
In this situation, you can **exclude** the column that shouldn't be processed for various reasons ([RED data](/handbook/security/policies_and_standards/data-classification-standard/#red), PII data, no value for the data or other minimization principles).
