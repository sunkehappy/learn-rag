...
**Note**: We cannot extend the trial if the customer hasn't started one on the namespace. The customer will need to start a trial if they haven't. Or we need to use an expired one.
