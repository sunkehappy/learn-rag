...
| [GitLab API Helper](https://gitlab.com/gitlab-com/support/toolbox/gitlab-api-helper) | Chrome | Shows relevant API endpoints based on what you're viewing and allows quick API queries | [Chrome Web Store](https://chromewebstore.google.com/detail/gitlab-api-helper/eahadajgihknngdbmbnaodnaoghndknd) |
