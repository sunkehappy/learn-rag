...
When setting a ticket to `Pending` or `On-Hold`, consider using our [Due Date](/handbook/security/customer-support-operations/zendesk/apps/global#zendesk-super-app)
and [Reminders](/handbook/security/customer-support-operations/zendesk/apps/global#gitlab-reminders-app)
