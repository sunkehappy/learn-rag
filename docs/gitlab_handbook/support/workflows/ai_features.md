...
- For Self-Managed, follow the below steps until [Duo Pro seat count is displayed in Licenses page](https://gitlab.com/gitlab-org/customers-gitlab-com/-/issues/9411) is implemented:
  ...
  1. Alternatively, you can request the customer to verify by [checking GitLab Duo Pro page](https://docs.gitlab.com/subscriptions/subscription-add-ons/#for-gitlab-self-managed-1) in their instance.
...
When a customer follows [these steps to start a GitLab Duo Pro trial](https://docs.gitlab.com/subscriptions/gitlab_duo_trials/), they get a 60 day trial for a maximum of 50 seats by default.
