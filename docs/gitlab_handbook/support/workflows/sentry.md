...
- Admin account: Navigate to the admin link in the [GitLab User Lookup](/handbook/security/customer-support-operations/zendesk/apps/global#gitlab-super-app) Zendesk app
- [Users API](https://docs.gitlab.com/api/users/#as-a-regular-user): Search for user using their email or username
