...
|Dedicated| [GitLab-hosted runners (beta)](https://docs.gitlab.com/subscriptions/gitlab_dedicated/#hosted-runners) can be provisioned for Dedicated customers. Self-managed runners can also be registered to Dedicated environments. |
