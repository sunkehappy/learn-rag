...
[one of the other options listed in the branch name scheme](https://docs.gitlab.com/development/documentation/workflow/#pipelines-and-branch-naming)).
...
- Follow the [docs MR guidelines](https://docs.gitlab.com/development/documentation/) as you create the MR
...
- Read about [docs deploy](https://docs.gitlab.com/development/documentation/site_architecture/deployment_process/). The key thing is to note how often docs are deployed.
