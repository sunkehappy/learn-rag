...
From the Zendesk [GitLab User Lookup application](/handbook/security/customer-support-operations/zendesk/apps/global#gitlab-super-app) you have access to the requester details in SFDC and GitLab.com.
