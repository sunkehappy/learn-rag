...
[Support Leaders on the Hook (SLOTH)](/handbook/support/workflows/support-leader-on-the-hook) are responsible for initial triage of mid-ticket feedback received during their shift. Notifications are posted in the `#support_ticket-attention-requests` channel.
...
1. The [SLOTH](/handbook/support/workflows/support-leader-on-the-hook) is responsible for the follow up.
