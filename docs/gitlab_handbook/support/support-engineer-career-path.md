...
- Read about the [Support Engineer role criteria](/job-description-library/engineering/support-engineer/#support-engineer).
...
- Read about the [Senior Support Engineer role criteria](/job-description-library/engineering/support-engineer/#senior-support-engineer).
...
- Read about the [Staff Support Engineer role criteria](/job-description-library/engineering/support-engineer/#staff-support-engineer).
...
People managers need a combination of skills involving not only [technical credibility](/handbook/engineering/careers/management/#technical-credibility), but interpersonal and organizational skills in order to lead a team of diverse individuals. These skills include embodying the [GitLab Values](/handbook/values/), [coaching](/handbook/leadership/coaching/), [interviewing and hiring](/handbook/support/managers/hiring), and thinking holistically about the Support team, how we fit within the company, and interact with users. People managers also need to have *organizational awareness* within GitLab, so you know where to look for answers and how to guide team members toward solutions. Read more about [Leadership at GitLab](/handbook/leadership/).
...
- Read about [what you can expect in a Support Engineering Manager role](/job-description-library/engineering/support-management/#what-you-can-expect-in-a-manager-support-engineering-role-at-gitlab).
- Read about the [Support Engineering Manager Responsibilities](/handbook/support/managers/manager-responsibilities).
- Read about why [candidates should apply for a Support Manager role](/job-description-library/engineering/support-management/#you-should-apply-if) to understand general expectations of this role.
- Read [Transitioning from Individual Contributor to Manager](/handbook/engineering/careers/training/ic-to-manager/).
