...
- Create the promotion document using the company template linked in the [Promotions and Transfers](/handbook/people-group/promotions-transfers/#promotion-document) handbook page.
...
- Add a link to the doc to the [Completed Promotions](https://drive.google.com/drive/u/0/search?q=completed%20promotions) document for future promotees to refer to.
