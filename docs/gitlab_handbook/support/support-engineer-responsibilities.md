...
1. This page is an extension of the [Support Engineer job family](/job-description-library/engineering/support-engineer/) page.
...
Associate and Intermediate Support Engineer differs from that of a Senior or Staff Support Engineer:

- Associate and Intermediate: Focus is on managing and solving their assigned tickets
- Senior and Staff: Although managing and solving their own assigned tickets remains
...
Aim for 2-8 customer pairings/calls monthly
...
See the handbook for more details on [Expectations for on-call](/handbook/support/on-call/#expectations-for-support-on-call).
...
| Level        | How it might look | Metrics |
| ------------ | ----------------- | ----------------- |
| Associate    | Collaborate with other support engineers and create issues with description completed and appropriate labels | 1-2 per month |
| Intermediate | Create issues with description completed and appropriate labels | 1-4 per month |
| Senior       | Additionally drive fix/enhancement when appropriate based on expertise and customer interactions | 1-4 per month |
| Staff       | Review [Request for Help issues](/handbook/support/workflows/how-to-get-help/#how-to-formally-request-help-from-the-gitlab-development-team) and drive fix/enhancement when appropriate based on expertise and customer interactions | 1-4 per month |
...
| Level        |  Metric             |
|--------------|---------------------|
| Associate    | 1-3 per month       |
| Intermediate | 2-4 per month       |
| Senior       | 2-5 per month       |
| Staff        | 2 or more per month |
...
If you publish information in other public places (*e.g.* a blog post), make a note in your 1:1 notes doc.
...
Ticket reviews for **Senior and Staff** Support Engineers involve adding relevant and quality internal comments on tickets they don't own. This is different from full ticket reviews (which are a manager tool). The goal is to:

- Help other engineers by providing additional technical context
- Share relevant knowledge and experience
- Add value to ticket resolution without taking over ownership
- Foster collaboration and knowledge sharing across the team

Reviews should focus on being constructive and helpful rather than corrective. The metric is tracked under "internal comments on not owned tickets" in our dashboards.
...
Senior engineers are expected to participate in a rotation to ensure we have coverage for office hours/help sessions across all regions. The goal is to have at least one office hour session available per day per region. This can include:

- Standard office hours for technical discussion
- Help sessions where multiple senior engineers may be present
- Scheduled knowledge-sharing sessions

Staff engineers will focus on strategic subject-based office hours as agreed upon by leadership rather than regular rotational sessions.
