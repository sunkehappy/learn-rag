...
_While a Value Stream Workshop is an advanced discovery session, it's expected that initial [opportunity discovery](/handbook/sales/playbook/discovery/) and [technical discovery](/handbook/solutions-architects/processes/technical-discovery/) have both been conducted prior._
...
* Remote:
  ...
  * LucidChart for Value Stream Map visulization
    ...
    * If your Access Request is urgent, paste the link to your Access Request Issue into the Compass Slack app with a note on why it is urgent and Compass will automatically escalate it to the respective team as needed. 
* Onsite:
  * Stickies
  * Pens
  * Large whiteboard
...
* [GitLab Value Stream Workshop Accreditation on LevelUp](https://university.gitlab.com/access/saml/login/internal-team-members?returnTo=https://university.gitlab.com/learn/learning-path/value-stream-assessment-accreditation)
