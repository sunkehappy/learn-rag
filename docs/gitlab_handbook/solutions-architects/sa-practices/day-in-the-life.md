...
- Remote:
  ...
  - [FigJam](/handbook/solutions-architects/tools-and-resources/#diagramming-tools) or LucidChart for Current State and Future State visualization
    ...
    - If your Access Request is urgent, paste the link to your Access Request Issue into the Compass Slack app with a note on why it is urgent. It will automatically be escalated as needed and assigned to the respecitve team. 
- Onsite:
  - Stickies
  - Pens
  - Large whiteboard
