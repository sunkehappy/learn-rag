...
description: "Complete overview of relevant SA Managers processes: Managing the Business and Managing the Team."
---
...
1. **CSPs created and reviewed with customer on 100% of [qualifying opportunities](/handbook/solutions-architects/processes/customer-success-plan/#opportunity-thresholds-for-creating-and-reviewing-mutual-customer-success-plans)**
...
3. **90% technical win rate for [Proof of Values](/handbook/solutions-architects/playbooks/pov/)**
...
1. **SA Feasibility Ratings**:  [Review th feasibility ratings](https://gitlab.lightning.force.com/lightning/r/Dashboard/01ZPL0000025nOj2AI/view?queryScope=userFolders) for the opportunities your team works on.  Drive adherence to the practice where there are no feasibilty ratings set and the SA is engaged.  Inspect the quality of the ratings and coach your team on best practices where needed.  
...
4. **Marketing events, trade shows, conference schedule review**:  Review the non customer events your team is scheduled to attend over the next month.  Find replacements (e.g., cross-functionally) or let the events teams know if your team doesn't have capacity to support the events.  Ensure customer engagement and opportunity success is not impacted due to team members participating in there events.
...
4. **SA Discovery and Demo Skills Calibration**: Review multiple (3-5) sample Gong (or otherwise recorded) calls as a management team at the Geo level. SA Managers score independently and discuss results. Report results in SA Leadership QBR. The goal is to improve consistency in skills evaluation across SA leader peer groups and metrics for SA senior leadership review.
5. **SA Clearances**:  For PubSec, review the team's clearances and meeting with FSO contractors.
6. **Promotion Candidate Review**:  Review your promotion forecast and any promotion documents for your team.  Ensure you are following the [promotion process](/handbook/solutions-architects/sa-career-development/#promotion-process) for SA.
7. **Capture Quarterly Achiever Nominations**:  Add nominations for the quarterly achievers award in the [Google Doc](https://docs.google.com/document/d/1U4Ezp16RF15TKgVsDOW9xz1t3WzHPYzjOKm008m1s80/edit?tab=t.0)

#### Executive Business Reviews

Review with CSM Managers or RD all accounts that have not had an EBR in the last 6 months. Ensure that one is scheduled
...
2. **SA Team Meetings**:  Ensure we include SME corner in our weekly AMER, EMEA or APJ meetings where we solicit updates from SMEs and solicit contributions from SAs who has customer feedback for that week to surface back to PMs when SMEs meet with their respective PMs
...
It may be good practice as well to keep a running log of the accomplishments of your team members (e.g. screenshots from the #thanks channel, notes from AEs, RDs, etc...). An easy way to do this is in a dedicated section of the individual One-on-One documents you keep for each of them or the SA can collect them in their Individual Growth Plan document. Having this information in a consolidated place with assist you greatly come review time or when that team member is ready for promotion.
