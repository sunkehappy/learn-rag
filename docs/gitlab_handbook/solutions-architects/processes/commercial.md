...
The High Velocity Solutions Architecture team is a part of the global [SA Organization](/handbook/solutions-architects/) that focuses on primarily Mid-Market customers aiming to lead technical evaluation efforts in an efficient and effective manner. The team covers the AMER region, with a team of Solutions Architects (SAs) who are responsible for supporting customers in that area.

### Team Roles

1. [Solutions Architects (SAs)](/job-description-library/sales/solutions-architect/)
2. [Demo Architects](/job-description-library/sales/demo-architect/)
3. [Solutions Architecture Managers](/job-description-library/sales/solutions-architect/#manager-solutions-architects)
...
2. Initial Review:
   - SA Regional Team (AMER) members review new requests. The service level objective for these reviews is [one business day](#1-triage-within-one-business-day).
...
High Velocity SA team members are strongly encouraged to take time off as part of [GitLab's paid time off policy](/handbook/people-group/time-off-and-absence/time-off-types/). Taking off can be intimidating as we may support multiple customers at any given time.
...
- Dashboards - Open Requests and Key Metrics: [COMM AMER SA Dashboard](https://gitlab.lightning.force.com/lightning/r/Dashboard/01ZPL0000011ihZ2AQ/view)
