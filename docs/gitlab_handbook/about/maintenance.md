...
| ------ | ------ | ------ | ------ |
| Handbook DRI | Learning & Development | Tre Ely, Jamie Allen | Triage, strategy and planning, coordinate major changes |
| Handbook Technical DRI | Enterprise Applications | Marc Di Sabatino, Nitin Garg | Technical decisions, maintenance |
...
| Code Reviewers | Group of volunteers | DRI, plus [`@gitlab-com/content-sites/handbook-tools`](https://gitlab.com/groups/gitlab-com/content-sites/handbook-tools/-/group_members?with_inherited_permissions=exclude) | Code reviews, escalation point for "Keep pipeline green" group, and as time allows, development work |
