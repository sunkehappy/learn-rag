...
1. Look for the "View app" button in the pipeline widget on the "Overview" tab of the MR, which will provide you with the review app link. Add `company/team/` to the end of it.
