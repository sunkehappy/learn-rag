...
All SaaS and vendor software needs to go through the [vendor onboarding process](/handbook/business-technology/enterprise-applications/guides/zip-guide/#how-to-request-a-new-vendor) and added to the tech stack before we can go live in Okta.
...
- [Finance Procurement Process](/handbook/business-technology/enterprise-applications/guides/zip-guide/#how-to-request-a-new-vendor)
- Open a new [new corpsec issue](https://gitlab.com/gitlab-com/gl-security/corp/issue-tracker/-/issues/new?description_template=okta_app_change) and tag `@gitlab-com/gl-security/corp/identity`. Provide any documentation from the vendor regarding SSO.
...
All configuration updates are managed using an Okta app change.

[Okta app change Issue template](https://gitlab.com/gitlab-com/gl-security/corp/issue-tracker/-/issues/new?description_template=okta_app_change)
