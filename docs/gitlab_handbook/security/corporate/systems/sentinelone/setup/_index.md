...
1. Make sure you are using the approved Linux distribution (Ubuntu LTS). See the [Approved Operating Systems](https://internal.gitlab.com/handbook/security/corporate/operating-systems/) page for details.
