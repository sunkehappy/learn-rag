...
<i class="fa-brands fa-slack mr-2"></i><code>Please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.</code><br>
