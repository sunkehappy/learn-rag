...
1. Click on `AI Companion` icon near the top-right corner of the meeting window
   ![AI Companion icon near the top-right corner of the meeting window](/images/security/corporate/end-user-services/supported-apps/zoom/ai-companion.png)
1. Make sure that `Meeting summary` option is selected
1. Click `Start AI Companion`
1. Participants will see a notification that AI Companion is active and analyzing the meeting
