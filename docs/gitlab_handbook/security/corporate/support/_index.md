...
If you can't find what you're looking for, please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
...
- **👀 New Team Members:** [IT Onboarding 101 Guide](/handbook/security/corporate/end-user-services/onboarding101/)
  ...
  - Device Management
    ...
    - [Laptops](/handbook/security/corporate/end-user-services/laptop-management)
      - **New Laptops**
        ...
        - 👀 [Onboarding Laptop Setup Guide](/handbook/security/corporate/end-user-services/onboarding101/)
      ...
      - **Laptop Policies**
        ...
        - [Security Configuration Standards](/handbook/security/corporate/end-user-services/laptop-management/laptop-security)
          ...
          - [Personal Use](/handbook/security/corporate/end-user-services/laptop-management/laptop-security/personal/)
          - [Remote Management (MDM and EDR)](/handbook/security/corporate/end-user-services/laptop-management/laptop-security/management)
          - [Software Updates](/handbook/security/corporate/end-user-services/laptop-management/laptop-security/updates/)
          ...
          - [Web Browsers](/handbook/security/corporate/end-user-services/laptop-management/laptop-security/browsers/)
          - [Wireless Networks and VPN](/handbook/security/corporate/end-user-services/laptop-management/laptop-security/networks)
...
**Please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.**
...
For systems not managed by Corporate Security, you can locate the owner in the [tech stack](https://gitlab.com/gitlab-com/www-gitlab-com/-/blob/master/data/tech_stack.yml). If you're not sure where to ask, please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
...
For team member support requests, please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
...
**Courtesy Reminder:** We do **not** provide same day support in our engineering issues. We have a prioritized queue for our issues that is managed by our engineering managers and program managers. We have allocated buffer in each team to triage new day-to-day requests within a few business days. Please add the appropriate priority label to any issues that you create. **Please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.** and we will handle escalations and prioritization internally.
