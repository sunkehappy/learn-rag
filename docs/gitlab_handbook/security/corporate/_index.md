...
- [CorpSec Onboarding 101 Guide](/handbook/security/corporate/end-user-services/onboarding101/)
...
- 🛟 [Helpdesk Services](/handbook/security/corporate/services/helpdesk)
  ...
  - 💻 [Laptop and Logistics Services](/handbook/security/corporate/end-user-services/laptop-management)
...
- Engineers and System Owners - See [CorpSec Systems](/handbook/security/corporate/systems) for GitLab group handle and Slack group handle.
  - `#corpsec` Please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
- Helpdesk Team
  - Please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
