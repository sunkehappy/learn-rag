...
- [Database: Disaster Recovery Team](/handbook/engineering/infrastructure-platforms/database/disaster-recovery/) - responsible for disaster recovery strategy for the PostgreSQL database.
- [Infrastructure Team](/handbook/engineering/infrastructure-platforms/) - availability, reliability, performance, and scalability of GitLab SaaS software
