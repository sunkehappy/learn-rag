...
If you want to use 1Password for your private passwords not related to your work at GitLab, [there are a few options](/handbook/security/corporate/systems/1password/setup/).
...
[this](/handbook/security/corporate/systems/1password/setup/).
...
added an [individual account](/handbook/security/corporate/systems/1password/).
