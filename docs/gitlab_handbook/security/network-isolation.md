---
title: Isolating your work laptop from other devices in your home network
---
...
- Have internet access with your work laptop (of course :smile: )
...
1. From the main [Okta page](https://gitlab.okta.com/app/UserHome), select the Claude tile.
...
For more information on a personal VPN, check out the [Personal VPN](/handbook/tools-and-tips/personal-vpn.md) page.
