...
1. If the fix was found out to be insufficient shortly after it went out, consider opening an [AppSec review](/handbook/security/product-security/security-platforms-architecture/application-security/runbooks/review-process/) for that feature.
...
1. Ban the HackerOne researcher from the program following [the code of conduct violation](/handbook/security/product-security/psirt/runbooks/hackerone-process/#addressing-rules-of-engagement-or-code-of-conduct-violations) process.
