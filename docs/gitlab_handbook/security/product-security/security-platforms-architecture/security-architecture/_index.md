...
- **Contact Info**
  - Slack Channels
    - `#security-discuss`: main channel to engage with the team
  - Tag on GitLab: `@gitlab-com/gl-security/security-architecture`

## Overview

[Application Security Architects](/job-description-library/security/security-engineer#security-architect) are the
...
As of December 2025, we have decentralized Security Architecture across Product Security to reduce unnecessary cross-team dependencies.

- Application Security Architecture (previously "Security Architecture") sits within [Security Platforms and Architecture](../../security-platforms-architecture/_index.md) and focuses on application-layer concerns
- Infrastructure Security Architecture is a new function that sits within [Infrastructure Security](../../infrastructure-security/_index.md)
...
- [AppSec projects policies](../../security-platforms-architecture/application-security/inventory#policies)
...
- For additional guidance, reach out to [Infrastructure Security](../../infrastructure-security/_index.md)
...
- Reference our [GitLab Cryptography Standard](/handbook/security/policies_and_standards/cryptographic-standard/)
...
- GitLab team members don't have access to billing data, nor anything else [classified red data](/handbook/security/policies_and_standards/data-classification-standard/)
...
- [Threat model](../../security-platforms-architecture/application-security/threat-modeling) the system, repeat, iterate.
