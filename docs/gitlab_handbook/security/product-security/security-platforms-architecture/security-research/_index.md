...
In order to realize this vision, team projects generally align with the following categories in accordance with the [role description](/job-description-library/security/security-research/):
...
- Introduction and practice of [threat modeling](/handbook/security/product-security/security-platforms-architecture/application-security/threat-modeling/)
...
- Data access [(red/orange/green)](/handbook/security/policies_and_standards/data-classification-standard.md#data-classification-levels)
...
Depending on the actual risk and exposure it might be needed to further limit the information around the disclosure. In such cases it is recommended to involve the [SIRT](/handbook/security/product-security/psirt/runbooks/working-with-sirt/).
