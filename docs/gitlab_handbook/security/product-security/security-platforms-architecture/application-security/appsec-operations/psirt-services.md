...
[**Handling priority::1/severity::1 Issues**](/handbook/security/product-security/psirt/runbooks/handling-s1p1/)

[**Working With SIRT**](/handbook/security/product-security/psirt/runbooks/working-with-sirt/)

[**CVSS Calculation**](/handbook/security/product-security/psirt/runbooks/cvss-calculation/)

[**General process for the application security team in patch releases**](/handbook/security/product-security/psirt/runbooks/security-engineer/)
...
- Mention `@gitlab-com/gl-security/product-security/appsec/psirt-group` on GitLab
- Ask in `#security_help` and mention `@psirt-team` on Slack
