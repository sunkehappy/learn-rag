...
- Were **not** labeled with the label that AppSec team members need to apply after [conducting security reviews of JiHu contributions](/handbook/finance/jihu-support/jihu-security-review-process/)
...
1. If possible, work to get the merge request reverted before it is included in a release
    ...
    - If this was already included in a release and this is a S1 finding, follow the normal [S1 process](/handbook/security/product-security/psirt/runbooks/handling-s1p1/)
