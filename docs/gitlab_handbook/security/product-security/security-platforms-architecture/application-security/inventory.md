...
They are used are controls for our [GitLab Projects Baseline Requirements](/handbook/security/policies_and_standards/gitlab_projects_baseline_requirements/).
