...
Department tools and resources that collect, process, and store [RED](/handbook/security/policies_and_standards/data-classification-standard/#red) data.
...
implementation review like we have for [AppSec Reviews](/handbook/security/product-security/security-platforms-architecture/application-security/appsec-reviews/).
...
1. Data [retention policies](/handbook/security/policies_and_standards/records-retention-deletion/) MUST be followed.
...
1. Environment audit logs MUST be enabled and stored in accordance with [retention policies](/handbook/security/policies_and_standards/records-retention-deletion/).
1. Application audit logs, if supported and available, MUST be enabled and stored in accordance with [retention policies](/handbook/security/policies_and_standards/records-retention-deletion/).
