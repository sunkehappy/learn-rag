...
- Slack
  ...
  - The `#security-help` or `#security-discuss` slack channel is the best place for questions relating to our team (please add the above tag)
...
- Interested in joining our team? Check out more [here](/job-description-library/security/security-assurance-job-family)!
