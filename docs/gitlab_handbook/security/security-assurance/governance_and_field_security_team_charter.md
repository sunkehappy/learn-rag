...
Please refer to the following roles and responsibilities for Security Enablement team members. All three specialties (Governance, Field Security, Sec. Assurance Automation) can be found under each job level:

[Security Assurance team member roles and responsibilities](/job-description-library/security/security-assurance-job-family/)
{.h4}
