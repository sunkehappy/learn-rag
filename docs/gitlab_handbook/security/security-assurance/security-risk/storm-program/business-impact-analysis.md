...
**Note:** In adjacent to the BIA, questions may be asked to satisfy global privacy regulation requirements pertaining to a system's [Personal Data](/handbook/security/policies_and_standards/data-classification-standard/#data-classification-definitions) processing.
...
The output of the BIA is now reported when submitting an Add a New System request through the [Tech Stack Update Form](https://helplab.gitlab.systems/esc?id=sc_cat_item&sys_id=7eee5c19ff25e6503691fe34fc4fd9ab) in HelpLab. The field used for reporting this information is: `critical_system_tier`.
