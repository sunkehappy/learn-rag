...
1. The team is encouraged to make use of [Glean](/handbook/eta/ai/tools/glean/) and [GitLab Duo](https://docs.gitlab.com/user/duo_agent_platform/) to answer questions. Ensure you review and validate the responses before distirbuting them externally.
