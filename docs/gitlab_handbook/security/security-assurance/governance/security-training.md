...
- Review the [GitLab Data Classification Standard](/handbook/security/policies_and_standards/data-classification-standard/) so you are aware of what is considered public vs non-public data. [GREEN](/handbook/security/policies_and_standards/data-classification-standard/#green) data can be publicly shareable, any training content that is not GREEN data should not be included in publicly-accessible training material.
