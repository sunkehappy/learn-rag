...
This is a next generation iteration of a GitLab Identity v2 [job family](/job-description-library/) and [role-based baseline entitlements](https://internal.gitlab.com/handbook/security/corporate/end-user-services/access-request/baseline-entitlements/).
