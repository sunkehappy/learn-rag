...
## Searching using Glean

All GitLab team members have access to [Glean](/handbook/eta/ai/tools/glean/), GitLab’s AI Knowledge Platform, used to find people, documents, issues, tickets, and conversations across our internal tools in one place.

**When to use Glean:**

* You need to search across multiple systems (Public and Internal Handbook + Slack + Google Drive + Salesforce + GitLab.com)
* You want to ask a question in natural language: "How do I submit expenses?" or "Who handles customer escalations?"
* You're looking for customer information, meeting notes, or documents scattered across multiple systems

Go to [app.glean.com](https://app.glean.com) or access via Okta, and search. Glean respects your existing permissions: you only see information you're authorized to access. Use filters to narrow results by source (Handbook only, Slack only, etc.) or search across everything at once.

For detailed instructions on using Glean at GitLab, see the [Glean guide](/handbook/eta/ai/tools/glean/) in the handbook.
