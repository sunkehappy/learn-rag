...
If you are concerned about potentially losing your hardware token, be sure to add [Touch ID](/handbook/security/corporate/end-user-services/onboarding101/#macbook-step-5-okta-account-verification) and potentially a [mobile device](/handbook/security/corporate/end-user-services/onboarding101/onboarding-mobile-devices) as an accepted authentication token. Sites following the FIDO2/WebAuthn standard should support multiple tokens. That way if one is lost or stolen, you can still login use another method. Currently YubiKey's are limited to one per user, in the case of lost or damaged, please reach out in the #it_security_help Slack channel and we'll assist you with a replacement.
...
Read through the [Google Analytics Handbook](/handbook/enterprise-data/marketing-analytics/google-analytics-4/) for more information on GA.
...
We have created [tools and tips for managing your time off](/handbook/people-group/time-off-and-absence/time-off-types/).
...
Please reach out to the People Operations Team via [HelpLab](https://helplab.gitlab.systems/esc?id=emp_taxonomy_topic&topic_id=57e1ad3997804e50a326158de053af3d) with any questions, requests or changes to the GitLab Team Meetings calendar.
...
Use the general-purpose [GitLab Slide Template](https://docs.google.com/presentation/u/0/?tgif=d&ftv=1) when creating slide decks for internal and external use.
