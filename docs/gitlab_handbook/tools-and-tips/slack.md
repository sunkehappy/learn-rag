...
To request that an existing private channel be made public, submit an [access request](/handbook/security/corporate/end-user-services/access-requests).
...
If you're off work for a holiday or vacation you can update your status by using [Time Off by Deel](/handbook/people-group/time-off-and-absence/time-off-types/).
