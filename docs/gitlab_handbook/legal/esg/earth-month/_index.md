...
Team members who volunteer are eligible to expense local travel (mileage, train, taxi/rideshare), parking for the event, and meals during the event (up to $25 limit). All expenses must comply with [GitLab's Travel & Expense Policy](https://internal.gitlab.com/handbook/finance/expenses/#1-policy).
...
- Time off for volunteering must align with GitLab's [PTO policy](/handbook/people-group/time-off-and-absence/time-off-types/)

- International travel is not permitted for this program

- To request volunteer time off, follow the [Paid Time Off procedures](/handbook/people-group/time-off-and-absence/time-off-types/) in our handbook
