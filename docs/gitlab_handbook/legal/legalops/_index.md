...
This process is designed to enable LACA team members to submit requests related to attending events/conferences, furthering development, or purchasing tools/software funded by LACA. This process does not apply to [equipment](https://internal.gitlab.com/handbook/finance/expenses/#equipment), [Individual Use Software](/handbook/finance/procurement/individual-use-software/) or other personal reimbursement requests.

- All expenses / reimbursements must be in accordance with [GitLab's Travel & Expense Policy](https://internal.gitlab.com/handbook/finance/expenses/).
...
- Requests are considered fully approved only when all stakeholder checkboxes have been completed. Please note, all expenses tied to the request must be submitted in accordance with [GitLab's Travel & Expense Policy](https://internal.gitlab.com/handbook/finance/expenses/).
