...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3.9. Not to use the GitLab APIs for the bulk collection or scraping of information, including for repeated or systematic bulk exporting GitLab API Data, except where permitted by applicable law. "**GitLab API Data**" means any data obtained from GitLab APIs, including code, and epic, issue, and merge request content; and

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3.10. To provide a separate end user license agreement ("**EULA**") for your Integration that will govern your end users' use of the Integration. You acknowledge and agree that your Integration's EULA is solely between you and your end users, and we will not be responsible nor have any liability under any EULA.
