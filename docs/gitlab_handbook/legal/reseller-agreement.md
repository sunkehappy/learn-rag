---
title: "Reseller/Referral Agreement"
---
<!-- vale off -->
...
**2.1.** In accordance with the Agreement, this Reseller Exhibit and the Partner Program, GitLab appoints Partner as a non-exclusive partner to Resell the Products and Services for the applicable Territory. Subject to the requirements set forth in the Partner Program, Partner may Resell the Products and Services on select Authorized Marketplaces, provided that Partner remains in full compliance with such requirements at all times. For the avoidance of doubt, such Authorized Marketplaces will be identified in the Partner Program and determined by GitLab in its sole discretion.
...
**2.6.5.** Supply to GitLab such reports, returns and other information relating to orders and projected orders for the Products and Services as GitLab may reasonably request from time to time;
