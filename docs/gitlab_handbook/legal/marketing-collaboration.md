...
- **Type of event you are planning.** If it's a type of game not included in the list, please provide a detailed description of how the game will work. The following explanations will help you determine the type of event:
  ...
  - Game of Chance/Prize Draw/Sweepstakes: A promotional game where there is an element of chance in the determination of a winner. These may include objective qualifying requirements but the winner(s) are selected at random from a pool of qualified entries.
    - For sweepstakes to be conducted at a GitLab booth at a non-GitLab sponsored conference, see [Conference Sweepstakes](#conference-sweepstakes) section below.
...
- **Prizes**: A few notes regarding prizes:
  ...
  - **Prize Values.** Local law often hinges on the value of the prizes, so it is necessary to know what prizes and how many prizes will be awarded prior to creating rules. Legal may request a change in prizes if the value amount is over a certain threshold and adds significant Legal requirements to the event. This varies from country to country and sometimes from state to state.  As a rule, prize values should not exceed US$1,999.00, and any questions regarding the tax implications of prizes should be directed to the [Finance team](/handbook/finance/). The total value of all prizes in a promotion should not exceed US$4,999.00, to avoid registration and bonding requirements in certain U.S. states.
...
If you are planning to run a sweepstakes (w/wo a survey) at a GitLab booth at a non-GitLab sponsored conference, refer to the [Process for a Conference Sweepstakes](/handbook/legal/process-for-a-conference-sweepstakes/). This process uses an automated workflow to generate abbreviated rules, based on pre-determined requirements. The details that apply to a specific sweepstakes are outlined in the abbreviated rules, generated through the automoted workflow from a Google form. A set of official rules applies to every sweepstakes under this process.  If your request does not satifsy the requirements, you must use the [Promotional Games Legal Template](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/issues/new?issuable_template=promotional_games_legal_template) as described above.
