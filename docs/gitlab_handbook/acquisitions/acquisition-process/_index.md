...
1. The Corporate Development Deal Process Manager will document who is read-in on the project and work with GitLab Legal to circulate a Read-in Acknowledgement form to sign and return.
    1. [Project Read-In Acknowledgement Template (Google Forms)](https://drive.google.com/drive/folders/1UGS3PdaHx9V25dsEre7Wn0pTSi7x5pY-)
    1. The list of read-in individuals will be maintained by the Corporate Development Deal Process Manager and made available as an Issue to the deal team for reference.
