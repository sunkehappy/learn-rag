...
1. We work [asynchronously](/handbook/company/culture/all-remote/). Lead by example and make sure people understand that [things need to be written down in issues as they happen](/handbook/company/culture/all-remote/). Hold your team accountable with documentation.
...
1. We give [feedback](/handbook/company/culture/all-remote/), lots of it. Don't hold back on suggestions for improvements, this helps us grow. Take pride in helping others through feedback.
...
1. When asked to attend a synchronous brainstorming call, a team member instead opens an issue and [requests for their team's ideas asynchronously](/handbook/company/culture/all-remote/asynchronous/#gitlab-experts-advise-on-when-to-use-sync-vs-async).
...
As a leader, the way you respond to negative [feedback](/handbook/company/culture/all-remote/) makes a significant impact
...
We want to promote organic cross-functional collaboration by giving people stable counterparts for other functions they need to work with. For example, each Strategic Account Executive (SAE) works with one Sales Development Representative (SDR). With our [categories](/handbook/product/categories/) every backend team of developers maps to a [Product Manager (PM)](/job-description-library/product/product-manager/) and a [frontend team](/handbook/engineering/).
