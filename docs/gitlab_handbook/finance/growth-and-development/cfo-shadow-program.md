...
1. As a reminder, you should have your title updated within your last name on Zoom. During the Shadow rotation update your title to "CFO Shadow". [Here](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-additional-config/#customize-your-zoom-profile) is the how to update your title as part of your last name to ensure it shows up on zoom.
