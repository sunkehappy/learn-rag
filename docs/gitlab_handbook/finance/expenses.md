...
Inline with GitLab's regulatory obligations, changes to [controlled documents](/handbook/security/controlled-document-procedure/) must be approved or merged by a code owner. All contributions are welcome and encouraged.{{% /alert %}}
...
- Managers are expected to review their team's expenses in their entirety every month, and must flag any concerns immediately to the Accounts Payable team. Potential violations of GitLab's [Gifts & Entertainment Policy](/handbook/legal/policies/gifts-contributions/#gifts-and-entertainment-policy) should also be flagged to the Legal department, as necessary.  
...
- Expenses for gifts and entertainment must be incurred and reimbursed in accordance with GitLab's [Gifts & Entertainment Policy](/handbook/legal/policies/gifts-contributions/#gifts-and-entertainment-policy) and [Antibribery Policy](/handbook/legal/anti-corruption-policy/).
...
- Personal credits and gift cards: GitLab will reimburse only the actual out-of-pocket amount paid by the employee. If personal credits, gift cards, rewards points, or other discounts are applied to a business purchase, reimbursement will be limited to the net amount charged to the employee's personal payment method.
Example: An employee purchases a $100 monitor and applies a $50 gift card. GitLab will reimburse $50 (the amount actually paid), not the pre-discount price of $100.
...
- Out of Policy Transactions for all E-Group Members needs to be approved by the Senior Director, Assistant Controller or higher in the Accounting Organization.
...
- Rental Cars are reimbursable and should be booked through Navan, up to the intermediate car class, with a 7 day booking lead time.
...
- When you book Hotels through Navan Travel, hotel room charges and the applicable taxes will be paid directly by GitLab through a central virtual card - the same way the company handles flights and train travel. The virtual card details will appear in Navan, our travel and expense platform, 24 hours before check-in and the hotel will automatically charge your room and taxes to this card.
- If you do not incur any additional hotel charges, there will be no need to submit an expense report for your stay.
- You will still be required to provide a personal credit card at check-in for any potential charges, such as room service, parking, minibar, or other extras.
- Incidental expenses that are business-related and within policy still are required to be submitted through an expense report.
- Further information can be found on [Navan Help Centre](https://app.navan.com/app/helpcenter/articles/travel/myself/booking-hotels/virtual-cards-for-pay-at-hotel-bookings)
- When hotel rooms are booked outside Navan - approval required by Manager and AP Admin.
...
- Meals while traveling on Company business  are reimbursable, up to $120 USD (or local equivalent currency) per day.
...
If you are traveling to attend an internal GitLab conference or meeting (e.g., R&D Summit, SKO, President's Club, Team Off-site), please follow the travel guidelines provided for that specific event rather than this general Travel Policy. Event-specific guidelines may differ from standard business travel policy in areas such as airfare, hotel, and class of service.
...
![Approved WFH Equipment List - Visual guide showing categories of approved work from home equipment including computer equipment, furniture, lighting, and other office supplies](/images/finance/expenses/approved-wfh-equipment-list.png)
...
- Policy is set at $100 - claims above this amount will not be reimbursed. The limit has been reviewed and set to cover standard costs across all markets; individual exceptions are no longer assessed at the claim stage.
...
- If co-working space is used together with a combination of working from home, we will allow the reimbursement of the internet cost for where you spend most of your time. i.e. if you expense a co-working space for a full month then internet for home cannot be expensed. If you expense co-work for a few days in a month then home internet can be expensed in full.
- Team members for GitLab GmbH (Germany) should refer to this [page](/handbook/finance/payroll/) for their country's specific guidelines of this expense.
...
![Approved Office Supplies List - Visual guide showing approved office supplies including printer supplies, stationery, and document processing items](/images/finance/expenses/approved-office-supplies-list.png)
...
- Only the employee's portion of a family plan is reimbursable.
- Actual cell phone, phone accessories, and monthly hardware costs are not reimbursable.
...
- The list of locations under a PEO can be found [on the payroll page](/handbook/finance/payroll/).
- Team Members must submit their expenses through Navan.
...
Team members hired in Italy under the Dirigente classification submit expenses via GitLab's expense system, Navan, but Papaya also requires their own template to process business expenses through payroll. Navan does not automatically pay out expenses for PEO workers, so manual submission to Papaya is required in addition to Navan.

**Expense Submission Process for Business Travel**

1. Team member downloads & completes [Papaya's expense template](https://docs.google.com/spreadsheets/d/1r57rC76gu_0buvpmB1kLgGBz1dbIFWv_/edit?usp=sharing&ouid=105940045311062226254&rtpof=true&sd=true) for each trip or expense. **Note**: Each trip must be submitted on a separate template; multiple trips cannot be combined into one.
2. Team member saves the completed template as a PDF.
3. Team member uploads the PDF to Navan alongside their receipts, as normal.
4. Payroll adds the approved expenses to that month's payroll changes and submits them to Papaya for processing by the agreed cut-off for the relevant month.

**Business Travel vs. Day-to-Day Expenses**
Business travel expenses (flights, accommodation, etc., typically for trips of more than 1 day) must be submitted separately from day-to-day expenses.
For business trips, each entry in the template must include: location, duration, purpose, and supporting screenshots/receipts.
...
Please see Navan Physical Card policy [here](/handbook/finance/accounts-payable/corp-credit-cards/).
...
Domain names are key assets in GitLab's intellectual property portfolio. Centralizing the registration and maintenance of domain names under the Infrastructure Shared Services group using GitLab's approved domain name registrar helps us track and protect these valuable assets. Please refer to the [Domain Names and DNS Records Handbook Page](/handbook/company/infrastructure-standards/realms/sandbox/#domain-names).
