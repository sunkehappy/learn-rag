...
[Shiyuan Chen](https://gitlab.com/shreychen) is the JiHu engineering contact
...
Please refer to [JiHu contribution process](/handbook/finance/jihu-support/jihu-contribution-process/) for details.
...
Check [What to do when the validation pipeline failed](/handbook/finance/jihu-support/jihu-validation-pipelines/#what-to-do-when-the-validation-pipeline-failed) for more details.
