...
1. If your request involved new software, submit the system details through the [Tech Stack Update Form](https://helplab.gitlab.systems/esc?id=sc_cat_item&sys_id=7eee5c19ff25e6503691fe34fc4fd9ab) in HelpLab once the Zip Request is fully approved and the contract is signed.
