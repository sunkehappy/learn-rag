...
Team member safety and security are a top priority for GitLab. If a team member feels uncomfortable or unsafe traveling to a location on GitLab's behalf due to concerns about the location, region, personal health, or other safety or security risks, please contact the People Safety & Security (PSS) team via [HelpLab](https://helplab.gitlab.systems/esc?id=emp_taxonomy_topic&topic_id=26bcca9c3b603a10de2c5b7e53e45afe) or email. The People Safety & Security team will assist by helping to connect the team member with the right resources.
...
### Additional Resources for Inclusive Travel and Event Security

For comprehensive guidance on planning inclusive and accessible off-site events and business travel, please refer to:

- [Inclusive Travel & Off-Site Planning Guide](https://docs.google.com/document/d/19gEA7sYmDZt7I6hIy2VTPvqrCC4IVJH2xvPJfraebEM/edit?usp=sharing) - Detailed considerations for ensuring safety, inclusion, and belonging for all participants
- [PSS - Event Security Advisory Presentation](https://docs.google.com/presentation/d/1kuTqZ5YjF1fFMYvRArDQC-ub-SFjeE8SF1lOJm9KzGk/edit?usp=sharing) - Visual guide to Event Security
...
1. Follow this [claims guide](https://drive.google.com/file/d/1hFqrGJ4VxPgrnYMxO7O-9h5LTG9Mw0L8/view?usp=sharing) to submit your claim.

International SOS can also help provide instructions for submitting claims to the insurer
...
- Prior to the trip, remove any sensitive data from your local machine that is not absolutely required. Refer to the [Data Classification Standards](/handbook/security/policies_and_standards/data-classification-standard/#data-classification-standards) for more information.
- If you are aware of any circumstances with your travel that may present a unique security risk (such as traveling to specialty conferences like Defcon), you may request advice in the [#security-division](https://gitlab.slack.com/archives/CM74JMLTU) Slack channel.
